...
def conversation_feedback(memory: Memory):
    prompt = f'''
      ...
      Also act human-like, friendly and adress the user directly .That includes giving opinion, not writing in perfect writing (lower case, not always using complex words), asking questions, cracking a joke, sounding exited, not act generic. 
