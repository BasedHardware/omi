...
async def select_channel(request: Request, _: str = Depends(require_shipbob_tools_auth)):
...
async def tool_get_inventory(request: Request, _: str = Depends(require_shipbob_tools_auth)):
    """
...
async def tool_get_products(request: Request, _: str = Depends(require_shipbob_tools_auth)):
    """
...
async def tool_create_wro(request: Request, _: str = Depends(require_shipbob_tools_auth)):
    """
...
async def tool_get_wros(request: Request, _: str = Depends(require_shipbob_tools_auth)):
    """
...
async def tool_cancel_wro(request: Request, _: str = Depends(require_shipbob_tools_auth)):
    """
...
async def tool_get_orders(request: Request, _: str = Depends(require_shipbob_tools_auth)):
    """
    Get recent orders.
    """
    try:
...
async def tool_get_fulfillment_centers(request: Request, _: str = Depends(require_shipbob_tools_auth)):
    """
    Get available fulfillment centers.
    """
    try:
