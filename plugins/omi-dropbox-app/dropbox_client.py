        ...
        try:
            ...
            while has_more and cursor and (limit is None or len(results) < limit):
                ...
                if continue_resp.status_code == 200:
                    ...
                    page_entries = continue_data.get("entries", [])
                    results.extend(self._parse_folder_entries(page_entries))
