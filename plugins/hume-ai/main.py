...
async def handle_audio_stream(
    ...
    try:
        ...
        # uid arrives as a query parameter and is interpolated into a file
        # name; strip path separators and dot-segments so it cannot escape
        # audio_dir (e.g. uid="../../x" wrote outside the sandbox before).
