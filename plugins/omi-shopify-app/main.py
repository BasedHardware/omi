...
async def tool_get_analytics(request: Request, _auth: None = Depends(require_shopify_tools_auth)):
    """
    Get store analytics.
...
async def tool_get_orders(request: Request, _auth: None = Depends(require_shopify_tools_auth)):
    """
    Get recent orders.
...
async def tool_get_order_details(request: Request, _auth: None = Depends(require_shopify_tools_auth)):
    """
...
async def tool_create_order(request: Request, _auth: None = Depends(require_shopify_tools_auth)):
    """
    Create a new order.
...
async def tool_get_customers(request: Request, _auth: None = Depends(require_shopify_tools_auth)):
    """
    Get customers.
...
async def tool_create_customer(request: Request, _auth: None = Depends(require_shopify_tools_auth)):
    """
