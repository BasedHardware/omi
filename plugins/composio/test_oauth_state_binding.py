...
Framework-only stubs (fastapi, pydantic, requests, src.db, src.omi_api);
...
class TestCallbackGuardsState(unittest.TestCase):
    ...
    def test_signed_callback_reaches_token_exchange_for_that_uid(self):
        ...
        notion.store_notion_credentials.assert_called_once_with(
            "uid-abc", "token", "ws-id", "Test Workspace"
        )
