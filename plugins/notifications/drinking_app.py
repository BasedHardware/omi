    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are an AI that analyzes conversations to detect if someone is planning to drink alcohol. Respond with 'YES' if you detect intent to drink alcohol, and 'NO' if you don't.",
                },
    ...
    if request.method == 'POST':
        ...
        if time_since_last >= AGGREGATION_INTERVAL and message_buffer[session_id]:
            ...
            if analyze_drinking_intent(combined_text):
                ...
                return jsonify({"message": "Hey, you shouldn't drink alcohol!"}), 200
