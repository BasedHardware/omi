...
async def get_front_page(payload: Annotated[Any, Body()] = None):
    ...
    try:
        ...
        return ChatToolResponse(error=f"Hacker News request failed with status {exc.response.status_code}.")
    except Exception:
...
async def search_stories(payload: Annotated[Any, Body()] = None):
    ...
    try:
        ...
        return ChatToolResponse(error=f"Hacker News search failed with status {exc.response.status_code}.")
    except Exception:
...
async def get_discussion(payload: Annotated[Any, Body()] = None):
    ...
    try:
        ...
        return ChatToolResponse(error=f"Hacker News discussion request failed with status {exc.response.status_code}.")
    except Exception:
