...
|---|---|---|---|---|
| React Native | Best TypeScript ecosystem and native-module path | Bun install, ESLint, Jest, Android `assembleDebug`, and relay contract pass | iOS build blocker; no real BLE adapter yet | Best TS-first baseline |
