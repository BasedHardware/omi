                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 16.0, 0.0, 0.0),
                                    child: Text(
                                      'We store all your highlights in one place. Comind listens in, writes down what’s said, and then gives you the highlights to check out later.',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                  ...
                  children: [
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('ONBOARDING1_PAGE_NEXT_BTN_ON_TAP');
