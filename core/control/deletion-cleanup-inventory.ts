...
export const DELETION_INVENTORY_CONTRACT_VERSION = "deletion-cleanup-inventory-v5" as const;
export const DELETION_INVENTORY_SOURCE_RECEIPT_VERSION = "deletion-inventory-source-receipt-v5" as const;
