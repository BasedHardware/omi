...
const baseInput = () => projectTreeInputSnapshot(snapshot(), { account_timezone: "UTC", valid_time_by_claim_revision: { a: "2026-01-02T01:00:00Z", private: "2026-01-02T01:00:00Z" } });
