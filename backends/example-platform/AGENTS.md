...
That launches the loopback-only backend service on port 4851 with deterministic QA seed data. See `apps/service/README.md` for configuration and boot acceptance.
