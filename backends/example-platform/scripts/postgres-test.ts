...
const testPostgres = async (preserve: boolean): Promise<void> => {
  ...
  try {
    const result = command(["bun", "test", "drivers/postgres/postgresjs.real.test.ts", "drivers/postgres/derived-group-dream-work-input.real.test.ts", "drivers/postgres/derived-group-dream-success.real.test.ts", "drivers/postgres/derived-group-dream-one-shot-runtime.real.test.ts", "drivers/postgres/firebase-binding.real.test.ts", "drivers/postgres/tasks.real.test.ts", "drivers/postgres/conversations.real.test.ts", "drivers/postgres/chat-messages.real.test.ts", "drivers/postgres/chat-write-repository.real.test.ts", "migration/postgres/deletion-receipts.real.test.ts"], {
