...
DECLARE v_seg jsonb; v_duration double precision; v_i integer; v_n integer; v_start double precision; v_end double precision; v_text text;
BEGIN
  ...
  FOR v_i IN 0..v_n-1 LOOP
    ...
    IF v_text IS NULL OR btrim(v_text)='' OR length(v_text)>1500 OR position(chr(0) IN v_text)>0
