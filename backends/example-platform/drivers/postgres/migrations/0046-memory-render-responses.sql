CREATE TABLE omi_memory.memory_render_responses (
  ...
  response_json text NOT NULL CHECK (octet_length(response_json) <= 262144),
  PRIMARY KEY (account_id, account_epoch, request_digest)
);
ALTER TABLE omi_memory.memory_render_responses ENABLE ROW LEVEL SECURITY;
CREATE POLICY memory_render_responses_owner ON omi_memory.memory_render_responses
...
GRANT SELECT, INSERT ON omi_memory.memory_render_responses TO omi_platform_application;
