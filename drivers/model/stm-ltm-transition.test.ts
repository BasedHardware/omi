...
test("I1 commits event and evidence with a session transition so later claims are live", async () => {
  ...
  await commitSessionStmToLtmTransition({ ledger, model, session_id: "session", owner_account_id: "owner", graph_frontier: 0, provisionals: [claim], entities: [{ entity_id: "entity:owner", owner_account_id: "owner", entity_revision_id: "entity:owner:r1", handle: "owner", labels: ["Owner"] }], evidence, events: [event], valid_times: { p: { typed_expression: { kind: "absolute", granularity: "instant", value: "2026-01-01T00:00:00Z" }, resolved_interval: { kind: "instant", start: "2026-01-01T00:00:00Z", end: "2026-01-01T00:00:00Z", timezone: "UTC", granularity: "instant" }, derivation: { resolver_version: "test", timezone: "UTC" } } }, parent_commit: null, versions: { strategy_version: "test", model_version: "fake", prompt_version: "test", policy_version: "test", code_version: "test", schema_version: "test", tokenizer_version: "test", tool_version: "test" }, identity_authorizations: [authorization], identity_authority_context: { owner_confirmations: [{ confirmation_ref: "confirm", owner_account_id: "owner", endpoints: authorization.endpoints, relation: "same" }], producer_assertions: [], standing_policies: [] } });
...
test("D44 an anaphor binds through its antecedent, which a per-evidence handle key made unreachable", async () => {
  ...
  const ledger = new SqliteLedger(new Database(":memory:"));
  await commitSessionStmToLtmTransition({ ledger, model, session_id: "session", owner_account_id: "owner", graph_frontier: 0, provisionals: [named, anaphor], entities: [{ entity_id: "entity:alice", owner_account_id: "owner", entity_revision_id: "entity:alice:r1", handle: "alice", labels: ["Alice"] }], evidence, events, valid_times: { p1: validTime, p2: validTime }, parent_commit: null, versions: { strategy_version: "test", model_version: "fake", prompt_version: "test", policy_version: "test", code_version: "test", schema_version: "test", tokenizer_version: "test", tool_version: "test" }, identity_authorizations: [authorization], identity_authority_context: { owner_confirmations: [{ confirmation_ref: "confirm", owner_account_id: "owner", endpoints: authorization.endpoints, relation: "same" }], producer_assertions: [], standing_policies: [] } });
