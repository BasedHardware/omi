...
import type { Entity, ProvisionalClaim } from "../../core/schema";

/** Imperative D-c edge; core request construction and planning have no model effect. */
export const invokeScopeStrategy = async (port: ModelPort, claim: ProvisionalClaim, entities: readonly Entity[]) => {
