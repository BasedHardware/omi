...
TICKET-004 defines the long-term cloud directory and relay for the Omi agent control plane. It extends the local runtime kernel described in [agent-control-plane](./agent-control-plane.mdx), especially sections 19, 24, and 25.
