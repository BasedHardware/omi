...
const testPostgres = async (preserve: boolean): Promise<void> => {
  ...
  try {
    const result = command(["bun", "test", "drivers/postgres/postgresjs.real.test.ts", "drivers/postgres/derived-group-dream-work-input.real.test.ts", "drivers/postgres/derived-group-dream-success.real.test.ts"], {
