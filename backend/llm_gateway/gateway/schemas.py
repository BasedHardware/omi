...
class Surface(str, Enum):
    ...
    # OpenRouter's decision-model endpoint (POST /api/v1/systemone): typed
    # answers with probabilities, no generated text (TypeSafe Jev, #14835).
    OPENROUTER_SYSTEMONE = 'openrouter.systemone'
