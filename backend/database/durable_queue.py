"""Shared durable-queue primitives for every backend queue.

Callers keep their existing Firestore document shapes and add fields only.
This module is the single implementation of the six poison-safe properties:
