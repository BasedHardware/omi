...
from database.durable_queue import ProcessOutcome, QueuePolicy, adopt_on_identity, decide_attempt, redrive_patch
    ...
    *,
    ...
    def apply(write_transaction):
        ...
        if payload.get('status') != 'dead_letter':
            adopt_on_identity(existing_id=candidate_id, item_id=candidate_id)
            return False
