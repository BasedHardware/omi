...
# ***********************************
#
# Mirrors the photos subcollection above exactly (contract §8): same
# transactional-write-checks-parent-exists shape, same
# batch-delete-before-parent-delete requirement (Firestore does not cascade
# subcollection deletes), same @prepare_for_read / @prepare_for_write /
