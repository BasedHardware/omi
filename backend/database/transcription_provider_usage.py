...
def create_provider_run(
    ...
    payload = {
        ...
        'unknown_speaker_duration_seconds': 0.0,
        'split_count': 0,
...
def finalize_provider_run(
    ...
    unknown_speaker_duration_seconds: float = 0.0,
    split_count: int = 0,
...
def increment_daily_rollup(
    ...
    update = {
        ...
        'chunk_duration_seconds': firestore.Increment(chunk_duration_seconds),
        ...
        'identity_match_count': firestore.Increment(identity_match_count),
        ...
        'unknown_speaker_count': firestore.Increment(unknown_speaker_count),
        'unknown_speaker_duration_seconds': firestore.Increment(unknown_speaker_duration_seconds),
        'split_count': firestore.Increment(split_count),
