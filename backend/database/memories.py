...
def get_memories(
    ...
    print('get_memories db', uid, limit, offset, categories, 'start_date:', start_date, 'end_date:', end_date)
    ...
    # Apply date range filters if provided (same pattern as conversations)
    if start_date:
