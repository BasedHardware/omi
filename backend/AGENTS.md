...
- Calendar capture (SCA-381): overlap keeps an otherwise-discarded scrap; gaps surface via `GET /v1/calendar/capture-gaps`. Rules: `.github/agent-docs/calendar-capture.md`.
