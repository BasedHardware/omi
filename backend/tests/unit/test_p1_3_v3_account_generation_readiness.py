...
_ARTIFACT = "p1_3_v3_account_generation_readiness"
_SCRIPT = "p1_3_v3_account_generation_readiness.py"


def _report(execute=False):
    return build_readiness_report(_SCRIPT, execute=execute)
...
def test_account_generation_readiness_json_summary_and_docs_registration_are_stable():
    ...
    assert "test_p1_3_v3_account_generation_readiness.py" in test_sh
    assert "p1_3_v3_account_generation_readiness.py" in ticket_doc
    assert "trusted account-generation source/readiness" in ticket_doc
    assert "p1_3_v3_account_generation_readiness.py" in oracle_doc
