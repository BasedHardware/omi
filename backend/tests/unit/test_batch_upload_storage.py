...
class TestBatchUpload:
    ...
    # TestBatchUploadFlagDisabled removed: PRIVATE_CLOUD_BATCH_ENABLED flag was removed,
    # batch upload is always active. 5 flag-disabled tests no longer applicable.
