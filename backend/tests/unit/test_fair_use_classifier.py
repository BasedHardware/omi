...
class TestClassifyUserPurpose:
    ...
    async def test_parses_llm_response_correctly(self):
        ...
        classifier_mod._classifier_llm.ainvoke = AsyncMock(return_value=llm_response)
    ...
    async def test_returns_default_on_llm_error(self):
        ...
        classifier_mod._classifier_llm = MagicMock()
        classifier_mod._classifier_llm.ainvoke = AsyncMock(side_effect=Exception('LLM timeout'))
