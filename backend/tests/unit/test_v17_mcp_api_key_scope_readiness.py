...
def load_module():
    ...
    script_path = root / "scripts" / "v17_mcp_api_key_scope_readiness.py"
...
def test_docs_reference_non_claims_and_server_owned_scope_assignment():
    ...
    assert "python3 backend/scripts/v17_mcp_api_key_scope_readiness.py" in readiness
    ...
    assert "v17_mcp_api_key_scope_readiness.py" in oracle
