...
def test_the_prompt_carries_the_evidence_and_the_builders_exemplars():
...
def test_a_copied_exemplar_does_not_survive_the_gate():
    """Observed on the first real run: the model selected one subject and shipped a
    builder exemplar's imperative beside it, marked grounded, with evidence cited. An
    exemplar is by construction about someone else's situation."""
    copied = EXEMPLARS[6]
