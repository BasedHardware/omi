...
from scripts.archive_visibility_readiness import (
...
def test_readiness_module_and_script_do_not_import_memories_router():
    ...
    importlib.import_module('scripts.archive_visibility_readiness')
    ...
    utility_source = (ROOT / 'scripts' / 'archive_visibility_readiness.py').read_text()
