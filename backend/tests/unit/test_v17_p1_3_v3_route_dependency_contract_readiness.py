...
def _report(execute=False):
    ...
    module = _load_module(root / "scripts" / "v17_p1_3_v3_route_dependency_contract_readiness.py")
...
def test_route_dependency_contract_is_static_readiness_only_and_registered():
    root = Path(__file__).resolve().parents[2]
    script_path = root / "scripts" / "v17_p1_3_v3_route_dependency_contract_readiness.py"
