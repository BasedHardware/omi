...
_mc.get_model_config = MagicMock(return_value=("gpt-6-luna", "openai"))
_mc.model_uses_gpt56_request_contract = lambda model: bool(model) and (
    str(model).startswith("gpt-5.6") or model == "gpt-6-luna"
)
