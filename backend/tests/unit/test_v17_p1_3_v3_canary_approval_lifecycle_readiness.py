...
SCRIPT_NAME = "v17_p1_3_v3_canary_approval_lifecycle_readiness.py"
...
def test_lifecycle_contract_defines_required_metadata_only_evidence_bundle():
    ...
    assert required["iam_emulator_proof_reference_present"]["reference"] == (
        "backend/scripts/v17_p1_3_v3_canary_approval_source_readiness.py"
    )
    assert required["telemetry_runbook_reference_present"]["reference"] == (
        "backend/scripts/v17_p1_3_v3_observability_approval_readiness.py"
    )
...
def test_lifecycle_readiness_links_into_ci_docs_and_parent_readiness():
    ...
    source_readiness = (root / "scripts" / "v17_p1_3_v3_canary_approval_source_readiness.py").read_text(
        encoding="utf-8"
    )
    production_readiness = (root / "scripts" / "v17_p1_3_v3_canary_approval_production_readiness.py").read_text(
        encoding="utf-8"
    )
    ...
    assert "test_v17_p1_3_v3_canary_approval_lifecycle_readiness.py" in test_sh
