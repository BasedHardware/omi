...
def _report(execute=True):
    ...
    module = _load_module(root / "scripts" / "v17_p1_3_v3_real_router_fail_closed_matrix.py")
...
def test_fail_closed_matrix_is_linked_from_readiness_test_runner_and_docs():
    ...
    assert external["real_router_fail_closed_matrix_proof"]["service"] == (
        "backend/scripts/v17_p1_3_v3_real_router_fail_closed_matrix.py"
    )
    ...
    assert "test_v17_p1_3_v3_real_router_fail_closed_matrix.py" in test_sh
    assert "v17_p1_3_v3_real_router_fail_closed_matrix.py" in ticket_doc
    assert "v17_p1_3_v3_real_router_fail_closed_matrix.py" in oracle_doc
