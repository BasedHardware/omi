...
SCRIPT = REPO_ROOT / 'backend' / 'scripts' / 'v17_p1_3_v3_fastapi_route_contract.py'
...
def test_v3_fastapi_route_contract_registered_documented_and_linked_from_readiness():
    ...
    assert 'test_v17_p1_3_v3_fastapi_route_contract.py' in test_sh
    assert 'v17_p1_3_v3_fastapi_route_contract.py' in ticket_doc
    assert 'v17_p1_3_v3_fastapi_route_contract.py' in oracle_doc

    readiness_script = REPO_ROOT / 'backend' / 'scripts' / 'v17_p1_3_v3_external_compatibility_readiness.py'
    readiness_text = readiness_script.read_text()
    assert 'fastapi_route_contract_proof' in readiness_text
    assert 'backend/scripts/v17_p1_3_v3_fastapi_route_contract.py' in readiness_text
