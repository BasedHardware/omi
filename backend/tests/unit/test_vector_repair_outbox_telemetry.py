...
try:
    from tests.unit.test_vector_repair_outbox_worker import _FakeFirestore, _record, _live_item
except ModuleNotFoundError:
    from test_vector_repair_outbox_worker import _FakeFirestore, _record, _live_item
...
def test_telemetry_emits_low_cardinality_metrics_and_events_without_identifiers():
    ...
    assert {"vector_repair_outbox_worker_ack_failure", "vector_repair_outbox_worker_dead_letter"}.issubset(event_names)
