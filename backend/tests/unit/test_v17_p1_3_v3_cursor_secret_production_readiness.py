...
SCRIPT_NAME = "v17_p1_3_v3_cursor_secret_production_readiness.py"
...
def test_static_no_mutation_no_payload_access_no_route_import_no_secret_or_token_logging_and_docs_links():
    ...
    cursor_readiness = (root / "scripts" / "v17_p1_3_v3_cursor_secret_readiness.py").read_text(encoding="utf-8")
    ...
    assert "test_v17_p1_3_v3_cursor_secret_production_readiness.py" in test_sh
