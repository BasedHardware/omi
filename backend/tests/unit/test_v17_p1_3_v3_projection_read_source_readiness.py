...
def _module():
    ...
    return _load_module(root / "scripts" / "v17_p1_3_v3_projection_read_source_readiness.py")
...
def test_projection_read_source_static_script_has_no_mutating_paths_route_imports_or_sensitive_logging():
    root = Path(__file__).resolve().parents[2]
    script_path = root / "scripts" / "v17_p1_3_v3_projection_read_source_readiness.py"
...
def test_projection_read_source_readiness_is_registered_in_test_runner_docs_and_parent_readiness():
    ...
    assert "test_v17_p1_3_v3_projection_read_source_readiness.py" in test_sh
    assert "v17_p1_3_v3_projection_read_source_readiness.py" in ticket_doc
    assert "projection read source contract/readiness" in ticket_doc
    assert "v17_p1_3_v3_projection_read_source_readiness.py" in oracle_doc
