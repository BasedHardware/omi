...
def _make_chat_client():
    ...
    gateway_client.GatewayDirectModelSurfaceBlocked = type('GatewayDirectModelSurfaceBlocked', (RuntimeError,), {})
...
def test_supported_file_still_uploads(chat_client, monkeypatch):
    ...
    response = client.post('/v2/files', files={'files': ('note.pdf', b'%PDF-1.1\n%%EOF\n', 'application/pdf')})
