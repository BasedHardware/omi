...
from testing.persona_prompt_rewrite_stubs import (
    _AutoMockModule,
)  # noqa: F401 -- sanctioned session-level stubs (backend/testing/ is exempt from the module-isolation gate); importing runs them
