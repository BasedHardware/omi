...
_SCRIPT = Path(__file__).resolve().parents[3] / '.github' / 'scripts' / 'check_oss_object_store_boundary.py'
...
_SPEC = importlib.util.spec_from_file_location('check_oss_object_store_boundary', _SCRIPT)
