...
def _module():
    ...
    return _load_module(root / "scripts" / "v17_p1_3_v3_cursor_secret_readiness.py")
...
def test_cursor_secret_readiness_json_summary_and_docs_registration_are_stable():
    ...
    assert "test_v17_p1_3_v3_cursor_secret_readiness.py" in test_sh
    assert "v17_p1_3_v3_cursor_secret_readiness.py" in ticket_doc
    assert "cursor secret/source integration readiness" in ticket_doc
    assert "v17_p1_3_v3_cursor_secret_readiness.py" in oracle_doc
