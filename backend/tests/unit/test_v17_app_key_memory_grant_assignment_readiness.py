...
def load_module():
    ...
    script_path = root / "scripts" / "v17_app_key_memory_grant_assignment_readiness.py"
...
def test_docs_reference_runner_non_claims_and_no_archive_default():
    ...
    assert "v17_app_key_memory_grant_assignment_readiness.py" in readiness
    ...
    assert "v17_app_key_memory_grant_assignment_readiness.py" in oracle
