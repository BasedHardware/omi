...
def test_oauth_executor_is_isolated_from_shared_gate_pools():
    from utils.executors import critical_executor, db_executor, llm_executor, oauth_executor

    assert oauth_executor.name == 'oauth'
    assert oauth_executor is not critical_executor
    assert oauth_executor is not db_executor
    assert oauth_executor is not llm_executor
