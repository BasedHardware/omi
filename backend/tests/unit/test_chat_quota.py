...
class TestEnforceChatQuota:
    ...
    def test_enforcement_paid_plan_exceeded_allows_overage(self, monkeypatch):
        """When a paid plan exceeds quota, no exception is raised."""
        sub_mod = _reload_subscription_module()
        ...
        with patch.object(
            ...
            sub_mod.enforce_chat_quota("uid123")  # paid plans enter overage mode

    def test_enforcement_free_plan_exceeded_raises_402(self, monkeypatch):
    ...
    def test_enforcement_operator_plan_allows_overage(self, monkeypatch):
        """Operator plan allows overage after included quota."""
        sub_mod = _reload_subscription_module()
    ...
    def test_enforcement_architect_cost_based_allows_overage(self, monkeypatch):
        """Architect plan allows cost-based overage after included quota."""
        sub_mod = _reload_subscription_module()
