...
- auth_idp_executor: outbound identity-provider exchanges (Firebase signInWithIdp REST). External
  network round-trips with unpredictable latency; bulkheaded off critical_executor so a slow IdP
  hop during sign-in cannot starve token verification / rate-limit gates.
