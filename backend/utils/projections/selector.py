...
builder-authored exemplars carry no action verb, so an actionability test would reject a third
...
def _admit(candidate: SubjectCandidate) -> tuple[Optional[SelectedSubject], str]:
    ...
    # the model believes it to be. The first real run shipped one beside an unrelated subject.
