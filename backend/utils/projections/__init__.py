"""Projections — a generated image carrying one future-tense imperative.
...
from utils.projections.generation import generate_projection, local_projection_image_path
