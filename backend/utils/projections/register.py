...
AUTHORSHIP BOUNDARY. Everything in this module is the builder's, transcribed rather than
composed. `REGISTER` is his description of the voice in his own words; `EXEMPLARS` are ten
projection/imperative pairs he wrote and scored. Nothing here may be rewritten, "improved",
extended or paraphrased by an agent — a register described in someone else's words is
someone else's register, and a menu of options is authorship with an extra step.
...
The shape those ten actually have, measured rather than asserted: seven of the ten are two
...
# The builder's own description of the voice. Verbatim; not to be edited.
REGISTER = (
...
# Ten builder-authored pairs. Transcribed from the prototype run that cleared its declared
# 7-of-10 gate at 9-of-10.
