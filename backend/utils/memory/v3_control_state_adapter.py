...
Neutral ``v3_control_state_adapter`` is the source of truth. Legacy ``v17_v3_control_state_adapter`` remains an importable alias.
"""
...
V3_DEFAULT_CONSUMER = V17_V3_DEFAULT_CONSUMER
