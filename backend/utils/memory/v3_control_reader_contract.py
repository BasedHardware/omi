...
Neutral ``v3_control_reader_contract`` is the source of truth. Legacy ``v17_v3_control_reader_contract`` remains an importable alias.
"""
...
V3ControlRouteFamily = V17V3ControlRouteFamily
V3ControlDecisionReason = V17V3ControlDecisionReason
V3ControlReaderRequest = V17V3ControlReaderRequest
V3ControlState = V17V3ControlState
V3ControlReadResult = V17V3ControlReadResult
V3ControlRouteDecision = V17V3ControlRouteDecision
V3ControlReader = V17V3ControlReader
