...
Neutral ``default_read_rollout`` is the source of truth. Legacy ``v17_default_read_rollout`` remains an importable alias.
"""
...
ReadDecision = V17ReadDecision
DefaultReadRolloutDecision = V17DefaultReadRolloutDecision
GlobalReadGateDecision = V17GlobalReadGateDecision
LegacyMemoryWriteGuardDecision = V17LegacyMemoryWriteGuardDecision
WriteConvergencePolicy = V17WriteConvergencePolicy
GLOBAL_READ_GATE_PATH = V17_GLOBAL_READ_GATE_PATH
WRITE_CONVERGENCE_GATE_PATH = V17_WRITE_CONVERGENCE_GATE_PATH
