"""Pure V17-V3-F5 read-only evidence preparation tooling.

This module is intentionally cloud-free and production-app-free. It models the
real-service evidence contract using injected clients/fakes only; default CLI use
returns NOT_RUN and constructs no service client.
"""
