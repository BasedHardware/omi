...
Neutral ``v3_write_convergence`` is the source of truth. Legacy ``v17_v3_write_convergence`` remains an importable alias.
"""
...
V3ExternalWriteOperation = V17V3ExternalWriteOperation
V3WriteConvergenceStatus = V17V3WriteConvergenceStatus
V3WriteConvergenceContext = V17V3WriteConvergenceContext
V3WriteConvergenceDecision = V17V3WriteConvergenceDecision
