"""Code-owned V17 `/v3` limited-rollout Firestore config templates.

The helpers build metadata-only documents for a named whitelisted uid. They do not
write to Firestore; admin/deployment tooling must apply the emitted documents
