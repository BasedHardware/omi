"""Framework-independent composed GET application service for future V17 `/v3` reads.

Pure local composition only: this module has no web framework, router, database,
network, provider, or metric-sink imports. All side-effecting work is represented
by fake-injectable typed adapters supplied by tests or a future router slice.
"""
...
from utils.memory.v17_v3_archive_visibility_readiness import decide_default_visibility
