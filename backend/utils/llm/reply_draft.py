...
def build_reply_prompt(
    *,
    ...
    return (
        ...
        f"conversation itself. If {name} asks something you don't actually know the answer to, do NOT invent "
        f"specifics (facts, plans, places, times, numbers) — respond the way this user naturally would when "
        f"they don't know or haven't decided, in their own words. Absence of an answer above means you don't "
        f"know it; don't fabricate one to sound responsive.\n\n"
