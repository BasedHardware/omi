"""Filesystem-backed fake GCS client for local harness / offline PROVIDER_MODE (#11703).

Also used by hermetic e2e tests via ``testing.e2e.fakes.storage`` re-exports.
"""
...
def setup_fake_storage() -> str:
    ...
    global _storage_dir
    _storage_dir = tempfile.mkdtemp(prefix="omi_fake_gcs_")
