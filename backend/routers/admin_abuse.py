...
def get_user_fair_use_detail(uid: str, secret_key: str = Query(...)):
...
def reset_user_fair_use(uid: str, secret_key: str = Query(...)):
...
def set_user_stage(uid: str, stage: str = Query(...), secret_key: str = Query(...)):
