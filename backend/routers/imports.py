...
async def delete_limitless_conversations(
    ...
    """
    # Only delete conversations with source='limitless' (imported via Limitless import)
    # This will NOT affect Omi pendant conversations (source='omi') or other sources
