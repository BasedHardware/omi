...
from utils.subscription import should_paywall_synced_conversation
...
async def sync_local_files(
    ...
    should_lock = await run_blocking(critical_executor, should_paywall_synced_conversation, uid)
