...
*/}}
{{- define "parakeet.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "parakeet.fullname" .) .Values.serviceAccount.name }}
{{- else }}
