...
pytest tests/unit/test_t20_repair_projection_consistency_readiness.py -v
pytest tests/unit/test_t21_v3_compatibility_cursor_readiness.py -v
pytest tests/unit/test_t22_t23_external_writes_caller_coverage_readiness.py -v
pytest tests/unit/test_p1_3_caller_api_compatibility_readiness.py -v
pytest tests/unit/test_p1_3_v3_external_compatibility_readiness.py -v
...
pytest tests/unit/test_p1_3_v3_route_signature_integration.py -v
pytest tests/unit/test_p1_3_v3_fastapi_route_contract.py -v
pytest tests/unit/test_p1_3_v3_real_router_dependency_map.py -v
pytest tests/unit/test_p1_3_v3_real_router_get_testclient.py -v
pytest tests/unit/test_p1_3_v3_real_router_fail_closed_matrix.py -v
pytest tests/unit/test_p1_3_v3_write_convergence_tombstone_matrix.py -v
pytest tests/unit/test_p1_3_v3_cursor_secret_readiness.py -v
pytest tests/unit/test_p1_3_v3_cursor_secret_production_readiness.py -v
pytest tests/unit/test_p1_3_v3_runtime_config_source_readiness.py -v
pytest tests/unit/test_p1_3_v3_projection_read_source_readiness.py -v
pytest tests/unit/test_p1_3_v3_projection_write_convergence_readiness.py -v
pytest tests/unit/test_p1_3_v3_canary_approval_source_readiness.py -v
pytest tests/unit/test_p1_3_v3_canary_approval_production_readiness.py -v
pytest tests/unit/test_p1_3_v3_canary_approval_lifecycle_readiness.py -v
pytest tests/unit/test_p1_3_v3_canary_approval_aggregate_readiness.py -v
pytest tests/unit/test_p1_3_v3_observability_approval_readiness.py -v
pytest tests/unit/test_p1_3_v3_get_dependency_auth_readiness.py -v
pytest tests/unit/test_p1_3_v3_route_dependency_contract_readiness.py -v
pytest tests/unit/test_p1_3_v3_get_dependency_seam_readiness.py -v
pytest tests/unit/test_p1_3_v3_projection_store_readiness.py -v
pytest tests/unit/test_p1_3_v3_control_reader_readiness.py -v
pytest tests/unit/test_p1_3_v3_control_reader_emulator_readiness.py -v
pytest tests/unit/test_p1_3_v3_account_generation_readiness.py -v
pytest tests/unit/test_p1_3_v3_get_runtime_wiring_readiness.py -v
