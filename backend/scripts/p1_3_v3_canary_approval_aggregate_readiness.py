...
_SOURCE = _load_script_module("p1_3_v3_canary_approval_source_readiness.py")
_PRODUCTION = _load_script_module("p1_3_v3_canary_approval_production_readiness.py")
_LIFECYCLE = _load_script_module("p1_3_v3_canary_approval_lifecycle_readiness.py")
_OBSERVABILITY = _load_script_module("p1_3_v3_observability_approval_readiness.py")
_RUNTIME = _load_script_module("p1_3_v3_get_runtime_wiring_readiness.py")
