#!/usr/bin/env python3
"""Readiness gate t20_repair_projection_consistency_readiness (data-backed; see scripts/readiness/gates/)."""
...
GATE_ID = "t20_repair_projection_consistency_readiness"
...
def build_readiness_artifact(config: T20RepairProjectionConsistencyReadinessConfig):
