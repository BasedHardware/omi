...
ROUTE_SURFACES: List[Dict[str, Any]] = [
    {
        ...
        'existing_local_proof': [
            'backend/tests/unit/test_v17_tools_agent_route_response_shape.py',
            'backend/tests/unit/test_v17_tools_rest_memory_runtime_adapter.py',
        ],
    ...
    },
    {
        ...
        'existing_local_proof': ['backend/tests/unit/test_v17_tools_agent_route_response_shape.py'],
