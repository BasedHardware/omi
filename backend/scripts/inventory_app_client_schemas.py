...
WIRE_DECODE_RE = re.compile(
    r'wire\.Generated[A-Za-z0-9_]+\.fromJson|\.fromGenerated\s*\(|Memory\.fromGeneratedWireJson|ServerConversation\.fromJson|ServerMessage\.fromGeneratedWireJson|ServerMessage\.fromResponseJson'
)
