#!/usr/bin/env python3
"""Readiness gate p1_3_caller_api_compatibility_readiness (data-backed; see scripts/readiness/gates/)."""
...
GATE_ID = "p1_3_caller_api_compatibility_readiness"
...
def build_readiness_artifact(config: P13CallerApiCompatibilityReadinessConfig):
    return _build_gate_report(GATE_ID, execute=config.execute)
