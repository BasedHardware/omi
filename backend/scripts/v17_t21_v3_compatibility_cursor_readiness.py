...
LOCAL_ROUTE_ADAPTER_AND_TEST_REFERENCES = {
    ...
    "existing_v17_read_tests": "backend/tests/unit/test_v17_product_memory_read_service.py; backend/tests/unit/test_v17_product_memory_router.py; backend/tests/unit/test_v17_developer_memory_adapter.py; backend/tests/unit/test_v17_mcp_memory_adapter.py; backend/tests/unit/test_v17_chat_memory_adapter.py",
...
def build_readiness_artifact(config: T21V3CompatibilityCursorReadinessConfig) -> Dict[str, Any]:
    return {
        ...
        "planned_safe_commands": [
            ...
            "python3 backend/scripts/v17_t21_v3_compatibility_cursor_readiness.py --execute",
            "pytest tests/unit/test_v17_t21_v3_compatibility_cursor_readiness.py -q",
