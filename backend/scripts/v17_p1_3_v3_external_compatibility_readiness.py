...
OBSERVABILITY_APPROVAL_READINESS_PROOF = {
    ...
    "approval_claimed": False,
    "blocker": "No V17 /v3 GET telemetry sink, runtime canary/rollback gate, or production approval artifact reader is runtime-wired; local canary approval schema validation exists only as a readiness seam.",
    "covered_defaults": [
