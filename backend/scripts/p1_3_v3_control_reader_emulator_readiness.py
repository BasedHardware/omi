...
EMULATOR_API_PROOF_PREREQUISITES = [
    ...
    },
    {
        ...
        "status": "READY_LOCAL_HARNESS_FIXTURE_PROVEN",
        "required_before_emulator_or_api_proof": True,
...
SECURITY_IAM_EVIDENCE_REQUIREMENTS = [
    ...
    },
    {
        ...
        "status": "READY_LOCAL_EMULATOR_HARNESS_PRESENT",
        "required_evidence": "Local Firestore emulator rules-unit test denies signed-in client get/set/update/delete on the chosen control document path.",
        "required_emulator_cases": [
...
def local_emulator_harness_inventory(env: Mapping[str, str]) -> dict[str, Any]:
    ...
    rules_harness = root / "backend" / "scripts" / "firestore_rules_emulator_test.mjs"
    control_harness = root / "backend" / "scripts" / "p1_3_v3_control_reader_emulator_test.py"
