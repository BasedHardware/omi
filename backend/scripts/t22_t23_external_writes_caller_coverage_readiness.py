...
LOCAL_ROUTE_ADAPTER_AND_TEST_REFERENCES = {
    ...
    "existing_guard_and_caller_tests": "backend/tests/unit/test_developer_memory_adapter.py; backend/tests/unit/test_v17_mcp_memory_adapter.py; backend/tests/unit/test_chat_memory_adapter.py; backend/tests/unit/test_product_authorization.py; backend/tests/unit/test_app_key_memory_grant_assignment_readiness.py",
}
