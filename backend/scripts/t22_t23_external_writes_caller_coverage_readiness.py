#!/usr/bin/env python3
"""Readiness gate t22_t23_external_writes_caller_coverage_readiness (data-backed; see scripts/readiness/gates/)."""
...
GATE_ID = "t22_t23_external_writes_caller_coverage_readiness"
...
def build_readiness_artifact(config: T22T23ExternalWritesCallerCoverageReadinessConfig):
