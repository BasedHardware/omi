...
def _load_dependency_map_constants() -> list[dict[str, Any]]:
    spec = importlib.util.spec_from_file_location(
        ...
        Path(__file__).with_name("v17_p1_3_v3_real_router_dependency_map.py"),
    )
    if spec is None or spec.loader is None:
        raise RuntimeError("cannot load v17_p1_3_v3_real_router_dependency_map.py")
    module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(module)
    return module.REQUIRED_IMPORT_STUBS


REQUIRED_IMPORT_STUBS = _load_dependency_map_constants()
...
def _probe_code() -> str:
    return textwrap.dedent(r'''
        ...
        v17_adapter_modules = [
            "utils.memory.v17_v3_compatibility",
            "utils.memory.v17_v3_request_adapter",
            "utils.memory.v17_v3_route_planner",
            "utils.memory.v17_v3_memory_read_service",
