...
_AGG_BACKEND = _Path(__file__).resolve().parents[3]
if str(_AGG_BACKEND) not in sys.path:
    sys.path.insert(0, str(_AGG_BACKEND))

from scripts.readiness.loader import build_report as _load_gate_report


def _component_report(gate_id: str, *, execute: bool):
    return _load_gate_report(gate_id, execute=execute)


_SOURCE_GATE = "p1_3_v3_canary_approval_source_readiness"
_PRODUCTION_GATE = "p1_3_v3_canary_approval_production_readiness"
_LIFECYCLE_GATE = "p1_3_v3_canary_approval_lifecycle_readiness"
_OBSERVABILITY_GATE = "p1_3_v3_observability_approval_readiness"
_RUNTIME_GATE = "p1_3_v3_get_runtime_wiring_readiness"
_EXTERNAL_GATE = "p1_3_v3_external_compatibility_readiness"
...
def _production_report(*, execute: bool) -> dict[str, Any]:
    return _component_report(_PRODUCTION_GATE, execute=execute)
...
def _gate_rows(reports: dict[str, dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "status": "READY_LOCAL_CONTRACT",
            "route_scope": ROUTE_SCOPE,
            "source_artifact": "backend/scripts/p1_3_v3_canary_approval_source_readiness.py",
        ...
        },
        {
            ...
            "status": "BLOCKED",
            "route_scope": ROUTE_SCOPE,
            "source_artifact": "backend/scripts/p1_3_v3_canary_approval_production_readiness.py",
        ...
        },
        {
            ...
            "status": "BLOCKED",
            "route_scope": ROUTE_SCOPE,
            "source_artifact": "backend/scripts/p1_3_v3_canary_approval_lifecycle_readiness.py",
        ...
        },
        {
            ...
            "status": "BLOCKED",
            "route_scope": ROUTE_SCOPE,
            "source_artifact": "backend/scripts/p1_3_v3_observability_approval_readiness.py",
        ...
        },
        {
            ...
            "status": "BLOCKED",
            "route_scope": ROUTE_SCOPE,
            "source_artifact": "backend/scripts/p1_3_v3_get_runtime_wiring_readiness.py",
        ...
        },
        {
            ...
            "status": "BLOCKED",
            "route_scope": ROUTE_SCOPE,
            "source_artifact": "backend/scripts/p1_3_v3_external_compatibility_readiness.py",
...
def build_report(*, execute: bool = False) -> dict[str, Any]:
    ...
    reports = {
        "source": _component_report(_SOURCE_GATE, execute=local_execute),
        "production": _production_report(execute=local_execute),
        "lifecycle": _component_report(_LIFECYCLE_GATE, execute=local_execute),
        "observability": _component_report(_OBSERVABILITY_GATE, execute=local_execute),
        "runtime": _component_report(_RUNTIME_GATE, execute=local_execute),
        "external": _component_report(_EXTERNAL_GATE, execute=local_execute),
    }
