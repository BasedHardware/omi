#!/usr/bin/env python3
"""Read-only source-selection and ownership/IAM readiness contract for the future server-owned GET /v3/memories canary approval artifact."""
...
GATE_ID = "p1_3_v3_canary_approval_source_readiness"
