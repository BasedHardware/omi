...
PROOF_CONSTANTS = {
    ...
    "route_dependency_contract_readiness_proof": _EXTERNAL.ROUTE_DEPENDENCY_CONTRACT_READINESS_PROOF,
    "get_dependency_seam_readiness_proof": _EXTERNAL.GET_DEPENDENCY_SEAM_READINESS_PROOF,
    ...
    "archive_short_term_visibility_readiness_proof": _EXTERNAL.ARCHIVE_SHORT_TERM_VISIBILITY_READINESS_PROOF,
    ...
    "runtime_config_source_readiness_proof": _EXTERNAL.RUNTIME_CONFIG_SOURCE_READINESS_PROOF,
