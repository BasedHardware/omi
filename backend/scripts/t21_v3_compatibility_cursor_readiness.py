#!/usr/bin/env python3
"""Readiness gate t21_v3_compatibility_cursor_readiness (data-backed; see scripts/readiness/gates/)."""
...
GATE_ID = "t21_v3_compatibility_cursor_readiness"
...
def build_readiness_artifact(config: T21V3CompatibilityCursorReadinessConfig):
