...
from database.redis_db import r, save_migrated_retrieval_conversation_id


def has_migrated_retrieval_conversation_id(conversation_id: str) -> bool:
    return bool(r.sismember('migrated_retrieval_memory_ids', conversation_id))


if __name__ == '__main__':

    def single(uid: str, memory: Conversation, update: bool) -> None:
