...
LOCAL_SEAMS_AND_RUNNERS = {
    "provider_readiness": "backend/scripts/v17_vector_search_provider_readiness.py",
    "shared_ns2_isolation_readiness": "backend/scripts/v17_shared_ns2_legacy_isolation_readiness.py",
    "pinecone_repair_validation_readiness": "backend/scripts/v17_pinecone_repair_validation_readiness.py",
...
PROOF_MATRIX: Dict[str, Dict[str, Any]] = {
    ...
    "stale_physical_vector_detection": {
        ...
        "required_artifacts": [
            ...
            "v17_pinecone_repair_validation_readiness.py execution artifact in an approved throwaway namespace, plus read-only shared ns2 stale-candidate inventory.",
        ],
    ...
    "shared_ns2_legacy_v17_isolation_under_stale_candidates": {
        ...
        "required_artifacts": [
            "v17_shared_ns2_legacy_isolation_readiness.py read-only provider evidence showing legacy filters exclude v17_schema_version records before top-k.",
            "v17_vector_search_provider_readiness.py evidence for V17 overfetch/refill when stale V17 candidates appear in shared ns2.",
...
def build_readiness_artifact(config: T20RepairProjectionConsistencyReadinessConfig) -> Dict[str, Any]:
    return {
        ...
        "planned_safe_commands": [
            ...
            "python3 backend/scripts/v17_t20_repair_projection_consistency_readiness.py --execute",
            "python3 backend/scripts/v17_vector_search_provider_readiness.py --execute with approved read-only provider credentials",
            "python3 backend/scripts/v17_shared_ns2_legacy_isolation_readiness.py --execute with approved read-only Pinecone credentials",
            "python3 backend/scripts/v17_pinecone_repair_validation_readiness.py --execute --allow-throwaway-mutation only in a confirmed throwaway namespace, never shared ns2",
        ],
