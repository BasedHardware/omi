...
LOCAL_ROUTE_ADAPTER_AND_TEST_REFERENCES = {
    ...
    "existing_tests": "backend/tests/unit/test_v17_product_memory_router.py; backend/tests/unit/test_v17_developer_memory_adapter.py; backend/tests/unit/test_v17_mcp_memory_adapter.py; backend/tests/unit/test_v17_chat_memory_adapter.py; backend/tests/unit/test_mcp_search_memories.py; backend/tests/unit/test_mcp_memory_filters.py; backend/tests/unit/test_dev_api_memories_pagination.py; backend/tests/unit/test_tools_router.py",
}
...
def build_readiness_artifact(config: P13CallerApiCompatibilityReadinessConfig) -> Dict[str, Any]:
    return {
        ...
        "planned_safe_commands": [
            "python3 backend/scripts/v17_p1_3_caller_api_compatibility_readiness.py",
            "python3 backend/scripts/v17_p1_3_caller_api_compatibility_readiness.py --execute",
            "pytest tests/unit/test_v17_p1_3_caller_api_compatibility_readiness.py -q",
