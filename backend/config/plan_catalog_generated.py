...
CATALOG_SHA256: Final = 'a209a8a090855a9f10bd5b1a25a582e063b49e2ecc89458c5ca8602af9767e02'
...
OPEN_PLAN_DECISIONS: Final = {'B1': {'question': 'What is the Free monthly transcription allowance?',
        'required_owner': 'David',
        'observations': [{'source': 'backend/utils/subscription.py default',
                          'value': 0,
                          'unit': 'minute',
                          'meaning': 'unlimited'},
                         {'source': 'production GKE listen and pusher',
                          'value': 300,
                          'unit': 'minute',
                          'meaning': 'finite'},
                         {'source': 'development GKE listen and pusher',
                          'value': 1000000,
                          'unit': 'minute',
                          'meaning': 'finite'},
                         {'source': 'production Cloud Run backend',
                          'value': 600,
                          'unit': 'minute',
                          'meaning': 'finite'},
                         {'source': 'web settings UI', 'value': 72000, 'unit': 'second', 'meaning': 'finite'}]},
 'B3': {'question': 'Do Plus and Unlimited enter chat overage or hard-cap when their included allowance is exhausted?',
        'required_owner': 'David',
        'runtime_until_decided': 'hard_cap',
        'observations': [{'source': 'backend/utils/subscription.py enforcement', 'value': 'hard_cap'},
                         {'source': 'backend/utils/overage.py reporting', 'value': 'hard_cap'},
                         {'source': 'backend paid-plan overage prose', 'value': 'overage'}]}}
...
PLAN_CATALOG_DATA: Final[dict[str, dict[str, Any]]] = {'basic': {'id': 'basic',
           ...
           'allocations': {'transcription': {'period': 'month',
                                             'unit': 'second',
                                             'limit': {'kind': 'decision_required',
                                                       'decision_id': 'B1',
                                                       'legacy_runtime_value': 0}},
 ...
 'unlimited': {'id': 'unlimited',
               ...
               'billing': {'publication_state': 'legacy_external',
                           'prices': [{'interval': 'month',
                                       'currency': 'usd',
                                       'amount': {'kind': 'external_import_required'},
 ...
 'plus': {'id': 'plus',
          ...
          'allocations': {'transcription': {'period': 'month',
                          ...
                          'chat': {'period': 'month',
                                   'unit': 'question',
                                   'limit': {'kind': 'finite', 'value': 200},
                                   'exhaustion': {'kind': 'decision_required',
                                                  'decision_id': 'B3',
                                                  'runtime_until_decided': 'hard_cap'}}},
          'billing': {'publication_state': 'legacy_external',
                      'prices': [{'interval': 'month',
