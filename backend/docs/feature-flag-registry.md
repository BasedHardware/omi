...
| `FREE_TIER_EMERGENCY_STOP` | Free-tier environment stop | runtime_env | n/a (stop only) | nobody | no | unset | `utils/free_tier_cohort.emergency_stop_engaged` — revokes every free-tier cohort incl. listed uids; needs a redeploy |
