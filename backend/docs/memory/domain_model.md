...
> [backend/docs/canonical_memory_architecture.md](../canonical_memory_architecture.md)
> (visual: [HTML companion](../canonical_memory_architecture.html)).
...
Normative reference (locked 2026-06-18): [`backend/docs/epics/memory_normative_architecture.md`](../epics/memory_normative_architecture.md)
...
[`backend/docs/epics/universal_memory_task_convergence.md`](../epics/universal_memory_task_convergence.md).
