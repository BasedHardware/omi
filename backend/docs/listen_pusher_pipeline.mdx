...
Live v3 embedding recovery remains available. Offline matching still uses the
longest clip with a 1s gate; this PR does not change that policy divergence.
