...
static void testCaptureQueryRoutes(void) {
  ...
  assert(OmiExamplePlatformRequestSupported(@"GET", @"/v1/settings"));
  assert(OmiExamplePlatformRequestSupported(@"GET", @"/v1/conversations?limit=50"));
  assert(OmiExamplePlatformRequestSupported(@"GET", @"/v1/memories?limit=50&cursor=next"));
  assert(OmiExamplePlatformRequestSupported(@"GET", @"/v1/tasks?limit=2"));
  assert(OmiExamplePlatformRequestSupported(@"POST", @"/v1/tasks/ops"));
  assert(OmiExamplePlatformRequestSupported(@"GET", @"/v1/chat-messages?limit=50"));
  assert(OmiExamplePlatformRequestSupported(@"GET", @"/v1/chat-messages?limit=50&olderCursor=older-1"));
  assert(OmiExamplePlatformRequestSupported(@"GET", @"/v1/device-sessions/ad99598c-36a8-4e12-a428-63d0a3e06170/transcript"));
  assert(!OmiExamplePlatformRequestSupported(@"POST", @"/v1/tasks"));
  assert(!OmiExamplePlatformRequestSupported(@"POST", @"/v1/chat-messages"));
  assert(!OmiExamplePlatformRequestSupported(@"POST", @"/v1/settings"));
  assert(!OmiExamplePlatformRequestSupported(@"POST", @"/v1/chat-attachments"));
  assert(!OmiExamplePlatformRequestSupported(@"GET", @"/v1/chat-generations/one/events"));
  assert(!OmiExamplePlatformRequestSupported(@"DELETE", @"/v1/chat-generations/one"));
  assert(!OmiExamplePlatformRequestSupported(@"POST", @"/v1/conversations"));
  assert(!OmiExamplePlatformRequestSupported(@"GET", @"/v1/conversations/one"));
  assert(!OmiExamplePlatformRequestSupported(@"GET", @"/v1/device-sessions/ownership"));
  assert(!OmiExamplePlatformRequestSupported(@"GET", @"/v1/device-sessions/ad99598c-36a8-4e12-a428-63d0a3e06170"));
  assert(!OmiExamplePlatformRequestSupported(@"GET", @"/v1/device-sessions/ad99598c-36a8-1e12-a428-63d0a3e06170/transcript"));
  assert(!OmiExamplePlatformRequestSupported(@"POST", @"/v1/device-sessions/ad99598c-36a8-4e12-a428-63d0a3e06170/transcribe"));
