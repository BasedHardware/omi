...
test('old conversation details name Flutter Conversation.fromGenerated type-wrong GET transcript_segments id instead of remapping to a recap chip', async () => {
  mockRequest.mockResolvedValue(
    response({
      ...fixture,
      transcript_segments: [
...
test('old conversation details name Flutter Conversation.fromGenerated type-wrong GET source_segment_ids item instead of remapping to a recap chip', async () => {
  mockRequest.mockResolvedValue(
    response({
      ...fixture,
      structured: {
  ...
  mockRequest.mockResolvedValue(
    response({
      ...
      structured: {
        ...fixture.structured,
        action_items: [
          {description: 1, completed: false, source_segment_ids: ['seg-1']},
        ],
      },
    }),
  );
...
test('old conversation details name Flutter GeneratedProjectedSection fromJson type-wrong GET heading instead of remapping to a recap chip', async () => {
  const processing = {
    transcript_sha256: 'abc',
    schema_version: 1,
    provenance: {
