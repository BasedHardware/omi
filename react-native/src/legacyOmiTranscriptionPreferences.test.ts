...
test('old transcription preferences name Flutter TranscriptionPreferences fromJson type-wrong GET custom_stt_since instead of remapping to a language chip', () => {
  expect(
    parseOmiTranscriptionPreferences(
      JSON.stringify({
        vocabulary: ['Omi'],
