...
export function SettingsPage({
  ...
  const reload = useCallback(async () => {
    ...
    const dailySummaryScheduleTask = loadOmiDailySummarySchedule(backend).then(
    ...
    setAppChangelogs(appChangelogsResult.rows);
    setAppChangelogsError(appChangelogsResult.error);
    ...
    setDailySummarySchedule(
      dailySummaryScheduleCopy(dailySummaryScheduleResult.settings),
    );
    ...
    snapshot === null ? null : (
      <>
        ...
        {appChangelogsError !== null ? (
          <SettingRow
            copy={appChangelogsError}
            title={appChangelogHeading('')}
          />
        ) : (
