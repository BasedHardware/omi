...
const mobileDark: SemanticTheme = {
  ...
  typography: {
    ...
    heading: { family: "system", size: 17, weight: 600, lineHeight: 1.25, tracking: -0.2 },
    body: { family: "system", size: 15, weight: 400, lineHeight: 1.4, tracking: 0 },
    row: { family: "system", size: 15, weight: 500, lineHeight: 1.35, tracking: 0 },
    label: { family: "system", size: 12, weight: 500, lineHeight: 1.2, tracking: 0.08 },
...
const desktopLightGlass: SemanticTheme = {
  ...
  typography: {
    display: { family: "rounded", size: 28, weight: 600, lineHeight: 1.12, tracking: -0.64 },
    title: { family: "rounded", size: 22, weight: 600, lineHeight: 1.18, tracking: -0.44 },
    heading: { family: "system", size: 15, weight: 600, lineHeight: 1.25, tracking: -0.16 },
    body: { family: "system", size: 13, weight: 400, lineHeight: 1.45, tracking: -0.08 },
    row: { family: "system", size: 13, weight: 500, lineHeight: 1.35, tracking: -0.08 },
    label: { family: "system", size: 11, weight: 500, lineHeight: 1.2, tracking: 0.12 },
