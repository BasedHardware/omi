---
title: App Setup
description: 'How to set up your own Friend app.'
---
...
### Setup Instructions
<Steps>
  <Step title="Upgrade Flutter">
   Before proceeding, make sure your Flutter SDK is up to date:
    ```
    flutter upgrade
    ```
  </Step>
  <Step title="Get Flutter Dependencies">
  ...
  <Step title="Setup Firebase">
    ...
    - Similarly for dev environment
       ...
       ```
    - For android, you will also need to generate **SHA1** and **SHA256** Keys for your Keystore and add them to Firebase. Follow the steps mentioned in this [StackOverflow answer](https://stackoverflow.com/a/56091158) or
