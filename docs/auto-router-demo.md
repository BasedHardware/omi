...
| 4. Live endpoint + metrics (v2) | Hit `GET /v1/auto-router/pick?task=...` 3 times, then `GET /v1/auto-router/metrics` | n/a (wiring demo) | Proves the v2 wiring works end-to-end: auth-protected endpoint, pick history recorded, metrics endpoint surfaces the picks |
