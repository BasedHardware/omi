...
That is it! You have successfully installed the firmware on your device. [Here](https://github.com/BasedHardware/omi/blob/main/Friend/hardware/triangle%20v2%20w%20memory/omi-dk2-schematics.pdf) you can find the schematics of our latest mass-produced device version
