...
# Developing Prompt-Based Apps for FRIEND

Prompt-based apps allow you to customize FRIEND's behavior and enhance its ability to process information. This guide
...
Create a app that makes FRIEND communicate like a specific expert or professional in a given field, such as a
