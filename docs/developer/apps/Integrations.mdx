---
title: Developing Integration Apps for FRIEND
description: ''
---

Integration apps allow FRIEND to interact with external services and process data in real-time. This guide will walk
...
These apps are activated when FRIEND creates a new memory, allowing you to process or store the memory data
externally.
...
> and it's respective JSON format [here](https://github.com/BasedHardware/Omi/blob/bab12a678f3cfe43ab1a7aba62645222de4378fb/community-apps.json#L359).
...
> Check the Realtime News checker [Python Example](https://github.com/BasedHardware/Omi/blob/bab12a678f3cfe43ab1a7aba62645222de4378fb/apps/example/main.py#L100)
...
For **Real-Time Processors**, simply start a conversation with FRIEND to see your app in action.
