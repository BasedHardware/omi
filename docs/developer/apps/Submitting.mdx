...
To submit your app to the FRIEND community:
...
approved, your app will become available to the FRIEND community.
...
Remember, these are broad guidelines to allow for creativity. The FRIEND community will shape the app ecosystem
