---
title: Introduction
description: 'FRIEND App Development: Expanding AI Capabilities'
---

As a developer, you can create app for Friend app, letting other people to use your apps and earn in the future.

## What Are FRIEND Apps?

FRIEND apps are modular extensions that augment the core functionality of the app. They can modify app's
...
[//]: # (With apps, FRIEND can be transformed into specialized tools such as:)
...
Apps allow developers to tap into FRIEND's conversational abilities and combine them with external data and services,
...
These apps modify how FRIEND processes and responds to information:

| Type                  | Description                                                                          | Example                                                                                                | Example Video                                                                                            |
|-----------------------|--------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
| **💬 Chat Prompts**   | Alter FRIEND's conversational style and knowledge base.                              | Create a app that makes FRIEND communicate like a specific expert or professional in a given field. | [![Chat app](https://img.youtube.com/vi/k1XhccNDT94/0.jpg)](https://youtube.com/shorts/k1XhccNDT94)   |
...
### 2. Integration Apps: Connecting FRIEND to External Systems

These apps allow FRIEND to interact with external services and process data in real-time:
...
The FRIEND app system opens up a wide range of possibilities:
...
To contribute your app to the FRIEND community, follow these steps based on the type of app you want to create:

1. Read our [Prompt-Based App Guide](https://docs.omi.me/developer/apps/PromptBased/) or check
   our [Integration App Guide](https://docs.omi.me/developer/apps/Integrations/) to
   understand the process.
2. Develop and test your app following the guidelines provided.
3. Submit a pull request to
   our [community-apps.json](https://github.com/BasedHardware/Omi/blob/main/community-apps.json) file on
