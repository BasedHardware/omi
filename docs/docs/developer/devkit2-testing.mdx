...
Note: If you don't receive 100 or 200, the file request wasn't carried out.
...
**WARNING: NEVER remove the SD card while the device is on\! It's not hot-swappable.**
