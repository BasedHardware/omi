...
|**🔔 App Lifecycle Events**|Receive notifications about app lifecycle|When a user uninstalls your app, Omi automatically sends a webhook notification to your service with an `app_uninstalled` event containing the user ID and app ID, allowing you to clean up user data or perform other necessary actions|[Learn more](https://docs.omi.me/docs/developer/apps/TestingAppLifecycle)|
