...
> **Windows Users:** Run the following command instead:
> ```powershell
...
Ensure Flutter is installed via [FVM](https://fvm.app/docs/getting_started/installation) as shown in step 1. Do not use global Flutter or upgrade it.
