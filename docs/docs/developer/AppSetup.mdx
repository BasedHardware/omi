...
Before running next command, make sure you have a team-developer account in apple with notifications/sign-in enabled. Otherwise, you'll need to set up the app manually
(see below)
```
bash setup.sh ios
```
