...
- This step is optional for running the app. If you used the setup.sh or setup.ps1 script from Step 1 to set up Flutter, the script will automatically use Omi’s default Firebase configurations. Therefore, you don’t need to add your own Firebase settings or use a FlutterFire configuration unless required.
