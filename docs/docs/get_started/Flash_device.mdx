...
<div style={{ textAlign: "center" }}>
  <video width="100%" height="auto" controls>
    <source
      src="https://github.com/BasedHardware/omi/blob/main/docs/static/images/updating_your_omi.mov"
      type="video/mp4"
    />
    Your browser does not support the video tag. <a href="https://github.com/BasedHardware/omi/blob/main/docs/static/images/updating_your_omi.mov">
