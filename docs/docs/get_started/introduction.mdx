...
<div style={{ display: 'flex', justifyContent: 'center', gap: '20px', margin: '20px 0' }}>
  <a href="https://play.google.com/store/apps/details?id=com.omi.ios" target="_blank" style={{ display: 'block', width: '200px' }}>
  ...
  <a href="https://apps.apple.com/us/app/omi-ai-wearable/id6502156163" target="_blank" style={{ display: 'block', width: '200px' }}>
