...
## Step 2: Download the Omi AI App

Download the latest version of the Omi AI app from your device's app store:

### iOS Users:
- Download from the [App Store](https://apps.apple.com/fi/app/omi-ai-smart-meeting-notes/id6502156163)

### Android Users:
- Download from [Google Play Store](https://play.google.com/store/apps/details?id=com.friend.ios&hl=en_US&pli=1)
...
The Omi AI app provides:

1. **Latest Features**: Access to the most recent features and improvements
2. **Regular Updates**: Updates come through the App Store/Play Store
3. **Development Kit**: As this is a development kit, some features may be experimental and not stable
...
<AccordionGroup>
  ...
  <Accordion title="App won't connect">
    - Ensure you have the latest version of the Omi AI app
...
1. **App Store Reviews**: Leave feedback through your device's app store
...
- **Provide Feedback**: Leave reviews and feedback through the app stores
- **Explore Features**: Try all the smart glasses capabilities
- **Stay Updated**: Keep the app updated through your device's app store
