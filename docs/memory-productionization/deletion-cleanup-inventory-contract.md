...
Status: pre-registered production-neutral P7 contract. No scanner, persistence,
...
`cleanup_inventory_unverified` blocker; it never becomes ten zeroes.
...
fixed ten-source set and deterministic canonical ordering. Core reads no clock,
