...
If you didn't get the original [Omi DevKit](https://basedhardware.com/products/friend-dev) from the Kickstarter campaign, you can purchase it from the Based Hardware website.
...
|Case | [3D-print design of the case](https://github.com/BasedHardware/Omi/tree/main/Omi/hardware/triangle%20v1) |
