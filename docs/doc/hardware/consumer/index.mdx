...
<Steps>
  ...
  <Step title="Assemble PCBs (Week 2-3)">
    ...
    <Warning>
    **Critical:** The nRF5340 and nRF7002 are fine-pitch QFN packages (0.4mm). You MUST use solder paste + stencil + reflow (hot air or oven). Do not attempt hand soldering these ICs.
    </Warning>
  </Step>
