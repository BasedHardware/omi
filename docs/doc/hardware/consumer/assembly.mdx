  ...
  <Tab title="Core Assembly" icon="screwdriver-wrench">
    <Steps>
      ...
      <Step title="Close enclosure">
        <Frame caption="Materials and finish reference for final assembly">
          <img src="https://raw.githubusercontent.com/BasedHardware/omi/main/omi/hardware/consumer/assembly/photos/materials-labelled.jpg" />
        </Frame>
