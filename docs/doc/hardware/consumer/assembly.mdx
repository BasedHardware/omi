  ...
  <Tab title="Core Assembly" icon="screwdriver-wrench">
    <Steps>
      ...
      <Step title="Close enclosure">
        ...
        <!-- WIP: Need a photo showing the actual enclosure-closing process (covers being mated, screws being inserted). The materials-labelled.jpg shows manufacturing process labels, not the closing step itself. -->
      </Step>
    </Steps>
  </Tab>
