...
description: "Complete open-source design files for the Omi Consumer CV1 — PCB schematics, Gerbers, mechanical STEP files, BOM, and assembly guides."
---

## Omi CV1 Open Source Hardware

The Omi Consumer Version 1 (CV1) is fully open source. All design files needed to study, modify, manufacture, and sell the hardware are available under the MIT license.

<CardGroup cols={2}>
  <Card title="Electronics" icon="microchip" href="/doc/hardware/consumer-cv1/electronics">
    PCB schematics, Altium source, Gerber files for mainboard, charger, and FPC
  </Card>
  <Card title="Mechanical & Packaging" icon="cube" href="/doc/hardware/consumer-cv1/mechanical">
    STEP files for enclosure, charger, foam inserts, and packaging
  </Card>
  <Card title="Assembly & BOM" icon="screwdriver-wrench" href="/doc/hardware/consumer-cv1/assembly">
    88-component BOM with manufacturer part numbers and assembly photos
  </Card>
  <Card title="License" icon="scale-balanced" href="/doc/hardware/consumer-cv1/license">
...
```
omi/hardware/consumer-cv1/
├── electrical/          # PCB design files
│   ├── mainboard/       # nRF5340 + nRF7002 main board (v1.1, v1.2)
