...
In the app, single/double/triple tap each run the action configured under Settings → Device (Ask a Question, Mute/Unmute,
End Conversation, Star Conversation, or Do Nothing). The long-press power toggle is fixed in firmware.
