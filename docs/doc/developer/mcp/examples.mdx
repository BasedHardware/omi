...
async def main():
    # Current langchain-mcp-adapters API: the client is not a context manager —
    # construct it and await get_tools().
    ...
    response = await agent.ainvoke({
        "messages": "Search my memories for anything about my morning routine"
    })
