...
<Steps>
  ...
  <Step title="Make API Requests" icon="code">
...
<AccordionGroup>
  <Accordion title="Import Data from Other Services" icon="file-import">
  ...
  <Accordion title="Create Memories from Notes" icon="note-sticky">
  ...
  <Accordion title="Process Meeting Transcripts" icon="users">
  ...
  <Accordion title="Action Item Tracker" icon="list-check">
  ...
  <Accordion title="Data Export" icon="file-export">
...
<CardGroup cols={2}>
  <Card title="MCP Integration" icon="robot" href="/doc/developer/MCP">
    Connect AI assistants to your Omi data
  </Card>
  <Card title="Integration Apps" icon="plug" href="/doc/developer/apps/Integrations">
    Build webhook-based apps for Omi
  </Card>
