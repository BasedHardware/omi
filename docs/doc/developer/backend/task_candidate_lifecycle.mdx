...
Human Smart Tasks activation is currently paused with no approved dogfood UID.
Do not run the activation tool until a reviewed cohort change explicitly names
a replacement canary and restores the associated runtime gates.
