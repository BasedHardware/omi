...
terminal transitions. Task/workstream goal links and workstream Candidate acceptance fail closed until the
workstream owner registers the Ticket 04 resolver.
