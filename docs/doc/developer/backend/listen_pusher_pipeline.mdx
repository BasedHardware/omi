...
> Last updated: 2026-08-20 (end-of-conversation wake-word command marking)
>
...
creates a task by itself. Extracted items whose source segment IDs intersect
the matched invocation deterministically carry the direct-mention signal into
the shared capture policy. This path has no realtime wake-word state or
