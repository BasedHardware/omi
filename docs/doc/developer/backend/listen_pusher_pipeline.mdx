...
mono PCM chunks to `POST /v2/desktop/background-transcribe`, and still finalizes
with `POST /v1/conversations`. Mobile listen, BLE listen, and PTT continue to use
their existing Deepgram paths.
