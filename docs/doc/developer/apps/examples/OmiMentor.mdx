...
<CardGroup cols={2}>
  ...
  <Card title="View Code" icon="code" href="https://github.com/BasedHardware/omi/blob/main/plugins/basic/mentor.py">
...
<CardGroup cols={3}>
  ...
  <Card title="Source Code" icon="code" href="https://github.com/BasedHardware/omi/blob/main/plugins/basic/mentor.py">
