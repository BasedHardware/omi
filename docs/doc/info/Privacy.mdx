...
description: "At Omi, your privacy and the security of your data are our top priorities. This Privacy Policy is designed to be transparent about how we collect, use, and protect your information."
---

## 1. Information We Collect[​](#1-information-we-collect "Direct link to 1. Information We Collect")
...
### Conversational Data[​](#conversational-data "Direct link to Conversational Data")
...
## 2. Purpose of Information Use[​](#2-purpose-of-information-use "Direct link to 2. Purpose of Information Use")
...
## 3. Data Storage and Security[​](#3-data-storage-and-security "Direct link to 3. Data Storage and Security")

### Robust Storage Solutions[​](#robust-storage-solutions "Direct link to Robust Storage Solutions")

Your data is stored on highly secure servers, safeguarded with advanced technology.

### Uncompromised Security[​](#uncompromised-security "Direct link to Uncompromised Security")
...
## 4. Information Sharing[​](#4-information-sharing "Direct link to 4. Information Sharing")

### Selective Sharing with Service Providers[​](#selective-sharing-with-service-providers "Direct link to Selective Sharing with Service Providers")
...
### Compliance with Legal Obligations[​](#compliance-with-legal-obligations "Direct link to Compliance with Legal Obligations")

We may disclose your information if required by law, always respecting your privacy rights.

## 5. Your Privacy Rights[​](#5-your-privacy-rights "Direct link to 5. Your Privacy Rights")
...
## 6. Wearable App Version[​](#6-wearable-app-version "Direct link to 6. Wearable App Version")

We offer an alternative version of our app that integrates with wearable devices. In this version, no data is collected by Omi. You bring your own API keys, and all data is stored locally on your device. This ensures that you have complete control over your data and privacy.

## 7. Policy Updates[​](#7-policy-updates "Direct link to 7. Policy Updates")
...
## 8. Open Door Policy[​](#8-open-door-policy "Direct link to 8. Open Door Policy")
