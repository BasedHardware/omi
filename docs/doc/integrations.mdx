...
|-----------|----------|---------|
| `DeviceConnection` | `.../connectors/device_connection.dart` | Abstract class defining the standard interface for all devices |
| `DeviceTransport` | `.../transports/device_transport.dart` | Abstract transport interface (`NativeBleTransport` in `.../transports/native_ble_transport.dart` is the low-level BLE handler) |
| `DeviceConnectionFactory` | `.../connectors/device_connection.dart` | Constructs the correct connection object based on DeviceType |
...
<Steps>
  ...
  <Step title="Create Your Device Connection Class" icon="code">
    Create `app/lib/services/devices/connectors/xyz_connection.dart`:
  ...
  <Step title="Register Your Device in the Factory" icon="gear">
    Open `app/lib/services/devices/connectors/device_connection.dart` and add a new case:
...
<Info>
Refer to `app/lib/services/devices/connectors/omi_connection.dart` for a complete example of a complex device implementation.
</Info>
