...
<CardGroup cols={4}>
  <Card title="4-Day Battery" icon="battery-full">
    Long-lasting power for all-day use
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="3D Printing" icon="cube" href="/doc/assembly/3d_printing_guide">
...
<CardGroup cols={3}>
  ...
  <Card title="4-Day Battery Life" icon="battery-full">
    Long-lasting power keeps you recording all day
  </Card>
  <Card title="Live Transcription" icon="microphone">
...
<AccordionGroup>
  ...
  <Accordion title="Build Apps & Integrations" icon="puzzle-piece">
    ...
    - [External Triggers](/doc/developer/apps/external_triggers)
  </Accordion>
</AccordionGroup>
