...
[`backend/docs/epics/universal_memory_task_convergence.md`](../../backend/docs/epics/universal_memory_task_convergence.md) is the canonical scope ledger, phased deletion checklist, and verification plan.
