...
- `backend/docs/epics/memory_normative_architecture.md`
- `backend/docs/memory/**`
- `backend/docs/canonical_memory_architecture.*`
...
- [`backend/docs/epics/memory_normative_architecture.md`](../../backend/docs/epics/memory_normative_architecture.md)
- [`backend/docs/memory/domain_model.md`](../../backend/docs/memory/domain_model.md)
