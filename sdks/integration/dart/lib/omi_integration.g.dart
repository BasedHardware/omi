...
class MemoryItem {
  ...
  const MemoryItem({this.appId, this.arguments, this.captureConfidence, this.captureDeviceIds, this.category, required this.content, this.conversationId, required this.createdAt, this.dataProtectionLevel, this.durability, this.edited, this.evidence, this.headline, required this.id, this.invalidAt, this.isLocked, this.kgExtracted, this.layer, this.manuallyAdded, this.memoryId, this.memoryTier, this.objectEntityIds, this.predicate, this.primaryCaptureDevice, this.qualifiers, this.reviewed, this.scoring, this.subjectAttribution, this.subjectEntityId, this.supersededBy, this.tags, required this.uid, this.uncertaintyReasons, required this.updatedAt, this.userReview, this.validAt, this.veracity, this.visibility});
