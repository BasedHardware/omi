...
var _exportNames = {
  ...
  isConnected: true,
  getAudioCodec: true,
  getBleAudioBytesListener: true,
  OmiModule: true
};
exports.OmiModule = exports.DeviceConnectionState = exports.BleAudioCodec = exports.BLE_CONSTANTS = void 0;
exports.connect = connect;
exports.disconnect = disconnect;
exports.echo = echo;
exports.getAudioCodec = getAudioCodec;
exports.getBleAudioBytesListener = getBleAudioBytesListener;
exports.isConnected = isConnected;
var _reactNative = require("react-native");
var _omi = require("./omi");
Object.keys(_omi).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _omi[key]) return;
...
const BLE_CONSTANTS = exports.BLE_CONSTANTS = {
...
const OmiModule = exports.OmiModule = _reactNative.NativeModules.OmiModule ? _reactNative.NativeModules.OmiModule : new Proxy({}, {
  get() {
...
const eventEmitter = new _reactNative.NativeEventEmitter(OmiModule);
 ...
 */
function connect(deviceId, onConnectionStateChanged) {
 ...
 */
function getAudioCodec(deviceId) {
 ...
 */
function getBleAudioBytesListener(deviceId, onAudioBytesReceived) {
