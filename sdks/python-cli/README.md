...
> Looking for localized guides? See the [🇨🇩 Kusokela na omi-cli (Luba-Katanga Quickstart)](examples/quickstart.lu.md), the [🇩🇿 Imeqriyen imezwura n omi-cli (Kabyle Quickstart)](examples/quickstart.kab.md), the [omi-cli хӀалтӀизе байбихьи (Avar Quickstart)](examples/quickstart.av.md), the [🇧🇪 Prumîs pas avou omi-cli (Walloon Quickstart)](examples/quickstart.wa.md), the [omi-cli баййафын (Ossetian Quickstart)](examples/quickstart.os.md), or the [🇲🇻 omi-cli ބޭނުންކުރަން ފަށާށެވެ (Dhivehi Quickstart)](examples/quickstart.dv.md).
