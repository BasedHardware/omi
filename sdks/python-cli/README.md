...
> Looking for localized guides? See the [🇫🇷 Guide de démarrage rapide en français (French Quickstart)](examples/quickstart.fr.md), the [🇩🇪 Deutsche Schnellstartanleitung (German Quickstart)](examples/quickstart.de.md), the [🇵🇹 Guia de início rápido em português (Portuguese Quickstart)](examples/quickstart.pt.md), the [🇮🇹 Guida rapida in italiano (Italian Quickstart)](examples/quickstart.it.md), the [🇧🇹 omi-cli དང་འགོ་བཙུགས་ནི། (Dzongkha Quickstart)](examples/quickstart.dz.md), or the [Kaszëbsczi (Kashubian Quickstart)](examples/quickstart.csb.md).
