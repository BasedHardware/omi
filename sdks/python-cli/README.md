...
> Looking for localized guides? See the [🇯🇵 日本語クイックスタート (Japanese Quickstart)](examples/quickstart.ja.md) or [🇮🇹 Guida Rapida in Italiano (Italian Quickstart)](examples/quickstart.it.md).
