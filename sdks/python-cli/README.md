...
> Looking for localized guides? See the [🇯🇵 日本語クイックスタート (Japanese Quickstart)](examples/quickstart.ja.md) or [🇸🇪 Snabbstartsguide på Svenska (Swedish Quickstart)](examples/quickstart.sv.md).
