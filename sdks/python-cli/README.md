...
> Looking for localized guides? See the [Sängö (Sango Quickstart)](examples/quickstart.sg.md), the [Qafar af (Afar Quickstart)](examples/quickstart.aa.md), the [Te Ggana Tuuvalu (Tuvaluan Quickstart)](examples/quickstart.tvl.md), the [Vagahau Niue (Niuean Quickstart)](examples/quickstart.niu.md), the [Gagana Tokelau (Tokelauan Quickstart)](examples/quickstart.tkl.md), the [Reo Tahiti (Tahitian Quickstart)](examples/quickstart.ty.md), or the [Fes stef wetem omi-cli (Bislama Quickstart)](examples/quickstart.bi.md).
