...
> Looking for localized guides? See the [Nahuatl Quickstart](examples/quickstart.nah.md), [Aymara Quickstart](examples/quickstart.ay.md), [Tetum Quickstart](examples/quickstart.tet.md), [Marshallese Quickstart](examples/quickstart.mh.md), [Kongo Quickstart](examples/quickstart.kg.md), [Venetian Quickstart](examples/quickstart.vec.md), [Asturian Quickstart](examples/quickstart.ast.md), or [Yiddish Quickstart](examples/quickstart.yi.md).
