...
> Looking for localized guides? See the [🇯🇵 日本語クイックスタート (Japanese Quickstart)](examples/quickstart.ja.md) and [🇨🇳 简体中文快速入门 (Simplified Chinese Quickstart)](examples/quickstart.zh-CN.md).
