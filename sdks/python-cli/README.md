...
> Looking for localized guides? See the [🇯🇵 日本語クイックスタート (Japanese Quickstart)](examples/quickstart.ja.md), the [🇪🇸 Primeros pasos con omi-cli (Spanish Quickstart)](examples/quickstart.es.md), or [🇨🇳 简体中文快速入门 (Simplified Chinese Quickstart)](examples/quickstart.zh-CN.md).
