...
> Looking for localized guides? See the [Bislama (Bislama Quickstart)](examples/quickstart.bi.md), the [Sranan Tongo (Sranan Tongo Quickstart)](examples/quickstart.srn.md), the [Karelian (Karelian Quickstart)](examples/quickstart.krl.md), the [Võro (Võro Quickstart)](examples/quickstart.vro.md), the [Kashubian (Kashubian Quickstart)](examples/quickstart.csb.md), the [Silesian (Silesian Quickstart)](examples/quickstart.szl.md), the [Rusyn (Rusyn Quickstart)](examples/quickstart.rue.md), the [Lower Sorbian (Lower Sorbian Quickstart)](examples/quickstart.dsb.md), the [Aragonese (Aragonese Quickstart)](examples/quickstart.an.md), the [Kirundi (Kirundi Quickstart)](examples/quickstart.rn.md), the [Crimean Tatar (Crimean Tatar Quickstart)](examples/quickstart.crh.md), the [Navajo (Navajo Quickstart)](examples/quickstart.nv.md), the [Inuktitut (Inuktitut Quickstart)](examples/quickstart.iu.md), the [Cherokee (Cherokee Quickstart)](examples/quickstart.chr.md), or the [Dzongkha (Dzongkha Quickstart)](examples/quickstart.dz.md).
