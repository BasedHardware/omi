...
> Looking for localized guides? See the [🇵🇭 Umuna a Gabay iti omi-cli (Ilocano Quickstart)](examples/quickstart.ilo.md), or the [🇪🇸 Primeiros pasos con omi-cli (Asturian Quickstart)](examples/quickstart.ast.md).
