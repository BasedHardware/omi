...
### Preserve existing config directory permissions

Existing config parent directories retain their permissions. Newly created config directories use owner-only access; credential files remain owner-only.
