...
def convert(source: str, destination: str, title: str = "Omi Second Brain Knowledge Vault", categories=None, overwrite: bool = True):
...
if __name__ == "__main__":
    ...
    try:
        count = convert(args.source, args.destination, title=args.title, categories=cats, overwrite=not args.no_overwrite)
