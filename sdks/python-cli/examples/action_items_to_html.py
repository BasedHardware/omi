...
def convert(source: str, destination: str, title: str = "Omi Action Items Dashboard", status_filter: str = "all", overwrite: bool = True):
...
if __name__ == "__main__":
    ...
    try:
        count = convert(args.source, args.destination, title=args.title, status_filter=args.status, overwrite=not args.no_overwrite)
