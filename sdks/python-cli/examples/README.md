...
* [`agent_quickstart.es.md`](agent_quickstart.es.md) — guía de omi-cli para
...
* [`conversations_csv.es.md`](conversations_csv.es.md) — convierte una lista de
  conversaciones a CSV para hojas de cálculo (Spanish).
