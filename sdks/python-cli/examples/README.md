...
* [`quickstart.fo.md`](quickstart.fo.md) — Fyrstu fetini við omi-cli (Faroese Quickstart).
* [`quickstart.fy.md`](quickstart.fy.md) — Earste stappen mei omi-cli (Frisian Quickstart).
