...
* [`agent_quickstart.ca.md`](agent_quickstart.ca.md) — guia d'omi-cli per a
  agents (Catalan agent guide).
* [`agent_quickstart.ms.md`](agent_quickstart.ms.md) — panduan omi-cli untuk
  ejen (Malay agent guide).
