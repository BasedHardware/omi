...
* [`conversations_to_parquet.md`](conversations_to_parquet.md) — export conversations to Apache Parquet columnar datasets for LLM fine-tuning, analytics, DuckDB, and Polars.
