...
* [`agent_quickstart.hi.md`](agent_quickstart.hi.md) — एजेंट्स के लिए omi-cli
  (Hindi agent guide).
* [`agent_quickstart.ru.md`](agent_quickstart.ru.md) — omi-cli для агентов
  (Russian agent guide).
* [`agent_quickstart.vi.md`](agent_quickstart.vi.md) — omi-cli cho các agent
  (Vietnamese agent guide).
* [`agent_quickstart.de.md`](agent_quickstart.de.md) — omi-cli für Agenten
  (German agent guide).
* [`agent_quickstart.fr.md`](agent_quickstart.fr.md) — omi-cli pour les agents
  (French agent guide).
* [`agent_quickstart.ca.md`](agent_quickstart.ca.md) — omi-cli per a agents
  (Catalan agent guide).
* [`agent_quickstart.ms.md`](agent_quickstart.ms.md) — omi-cli untuk agen
  (Malay agent guide).
