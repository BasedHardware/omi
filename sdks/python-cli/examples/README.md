...
* [`conversations_to_parquet.md`](conversations_to_parquet.md) — export conversations and transcripts to Apache Parquet for DuckDB/Polars analytics and LLM fine-tuning.
