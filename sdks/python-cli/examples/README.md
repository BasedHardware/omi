...
* [`agent_quickstart.it.md`](agent_quickstart.it.md) — guida omi-cli per 
  agenti (Italian agent guide).
* [`agent_quickstart.be.md`](agent_quickstart.be.md) — omi-cli для агентаў
  (Belarusian agent guide).
