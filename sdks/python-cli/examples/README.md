...
* [`solana_pay.md`](solana_pay.md) — extract and validate Solana Pay payment QR codes and URIs from optical scan logs.
...
* [`memories_obsidian.md`](memories_obsidian.md) — export memories to daily Obsidian Markdown notes.
