...
* [`action_items_html.md`](action_items_html.md) ([`action_items_to_html.py`](action_items_to_html.py)) — build a self-contained, printable HTML report of action items with status cards and task tables.
