...
* [`action_items_markdown.md`](action_items_markdown.md) — export action items to an Obsidian Tasks checklist.
* [`conversations_digest.md`](conversations_digest.md) — build a compact per-day, per-category conversation digest.
