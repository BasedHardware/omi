...
* [memories_lancedb.md](memories_lancedb.md) — export memories and knowledge to a LanceDB serverless vector database for low-latency local semantic search and LLM retrieval.
