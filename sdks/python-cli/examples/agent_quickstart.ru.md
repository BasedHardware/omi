...
* **Стабильные коды выхода.** `0` — ОК / `1` — ошибка использования / `2` — ошибка аутентификации / `3` — ошибка сервера / `4` — превышен лимит запросов / `5` — не найдено. Агенты могут ветвиться по этим кодам без разбора естественного языка сообщений об ошибках.
