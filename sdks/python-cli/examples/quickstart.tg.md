...
| `1` | Хатогии истифода | Парчами нодуруст ё камбуди аргумент |
| `2` | Хатогии воридшавӣ | Калид нодуруст аст ё `omi auth login` лозим аст |
| `3` | Хатогии сервер | Хатогии 5xx, таваққуфи вақт ё қатъи пайваст |
| `4` | Маҳдудияти дархостҳо | 429 Too Many Requests (дархостҳои аз ҳад зиёд) |
| `5` | Ёфт нашуд | 404 Not Found (захира ё саҳифа ёфт нашуд) |
