"""Test suite verifying structural and semantic parity of localized agent quickstart guides (Batch 5)."""
...
LANGUAGES = ["sk", "bg", "no", "fi", "hu", "th", "da"]
...
class AgentQuickstartBatch5ParityTest(unittest.TestCase):
