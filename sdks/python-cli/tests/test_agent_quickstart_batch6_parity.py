"""Test suite verifying structural and semantic parity of localized agent quickstart guides (Batch 6)."""
...
class AgentQuickstartBatch6ParityTest(unittest.TestCase):
