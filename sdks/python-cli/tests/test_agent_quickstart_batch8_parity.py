"""Test suite verifying structural and semantic parity of localized agent quickstart guides (Batch 8)."""
...
LANGUAGES = ["pt", "hi", "ru", "vi", "de", "fr", "ca", "ms"]
...
class AgentQuickstartBatch8ParityTest(unittest.TestCase):
