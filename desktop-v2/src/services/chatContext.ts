...
const TOOL_GUIDANCE = [
  ...
  "- search_screen_history(query, limit?) — semantic search over screen captures (use for 'when was I…' / 'what was I reading about…').",
  "- get_recent_screen_activity(limit?) — most recent screenshots, for 'what was I just doing'.",
  "",
