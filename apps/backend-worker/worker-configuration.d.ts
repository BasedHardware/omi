/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: babec3fc42cbf3701fca84bbff3aec5d)
...
interface __BaseEnv_Env {
	...
	STAGING_ACCOUNT_ID: "staging-primary";
	STAGING_DISPLAY_NAME: "Omi Staging";
	STAGING_EMAIL: "staging@omi.invalid";
	STAGING_PLAN_LABEL: "Staging";
	STAGING_CHAT_LIMIT: 1000;
	OPENROUTER_GATEWAY_ENABLED: "false";
	OPENROUTER_MODEL: "openai/gpt-5.6-luna";
	ACCOUNTS: DurableObjectNamespace<import("./src/index").AccountBackend>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AccountBackend";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "AI_MODEL" | "STAGING_ACCOUNT_ID" | "STAGING_DISPLAY_NAME" | "STAGING_EMAIL" | "STAGING_PLAN_LABEL" | "STAGING_CHAT_LIMIT" | "OPENROUTER_GATEWAY_ENABLED" | "OPENROUTER_MODEL">> {}
}
