      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => ChatWidget(
            daily: params.getParam('daily', ParamType.bool),
        ...
        FFRoute(
          name: 'testNew',
          path: '/testNew',
          builder: (context, params) => TestNewWidget(
            test: params.getParam('test', ParamType.String),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'micnotice',
          path: '/micnotice',
          builder: (context, params) => const MicnoticeWidget(),
        ),
        FFRoute(
          name: 'Onboarding3',
          path: '/onboarding3',
        ...
        FFRoute(
          name: 'explainer',
          path: '/explainer',
          builder: (context, params) => const ExplainerWidget(),
        ),
        FFRoute(
          name: 'test',
          path: '/test',
        ...
        FFRoute(
          name: 'settingsPageCopy',
          path: '/import',
          builder: (context, params) => const SettingsPageCopyWidget(),
        )
