...
Future<Structured> generateTitleAndSummaryForMemory(String transcript, List<MemoryRecord> previousMemories) async {
  ...
  var prompt =
      '''Your Name is $pluginName , you are $pluginDescription do a role play as $pluginPrompt\n You will mention your name and follow the style mentioned abouve in your final output. Based on the following recording transcript of a conversation, provide structure and clarity to the memory.
    ...
    The purpose for structuring this memory is to remember important conversations, decisions, and action items according to $pluginPrompt If there's nothing like that in the transcript, output an empty title.
     
    For the title, Generated title and appended with $pluginName's style
    For the overview, Brief overview of the conversation with an opinion following the advice of this: $pluginPrompt
    For the action items, List of actionable steps drawn from the conversation
    ...
    ```
    {"properties": {"title": {"title": "use a short title generated by you and at the end add in $pluginName's style", "description": "Your name $pluginName", "default": "", "type": "string"}, "overview": {"title": "Overview", "description": "Brief overview of the conversation with an opinion following the advice of this: $pluginPrompt", "default": "", "type": "string"}, "action_items": {"title": "Action Items", "description": "List of actionable steps drawn from the conversation", "default": [], "type": "array", "items": {"type": "string"}}}}
    ```'''
          .replaceAll('     ', '')
          .replaceAll('    ', '')
          .trim();
