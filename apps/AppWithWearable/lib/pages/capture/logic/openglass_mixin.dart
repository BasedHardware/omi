...
mixin OpenGlassMixin {
  ...
  Future<void> openGlassProcessing(BTDeviceStruct device, Function(List<Tuple2<String, String>>) onPhotosUpdated,
      Function(bool) setHasTranscripts) async {
    _bleBytesStream = await getBleImageBytesListener(device.id, onImageBytesReceived: (List<int> value) async {
