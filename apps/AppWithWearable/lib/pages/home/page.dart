  ...
  Future<void> _refreshPlugins() async {
    ...
    setState(() {
      ...
      if (enabledPlugins.isNotEmpty) {
        selectedPluginId = enabledPlugins.contains(selectedPluginId) ? selectedPluginId : enabledPlugins.first.id;
      } else {
        selectedPluginId = 'default';
      }
    });
  }
                          ...
                          child: DropdownButton<String>(
                            ...
                            items: enabledPlugins.isEmpty
                                ...
                                : [
                                    ...
                                    DropdownMenuItem<String>(
                                      value: 'enable_plugins',
                                      child: Text('Manage plugins', style: TextStyle(color: Colors.grey.shade200)),
                                    ),
                                  ],
                          ),
                        )),
