...
Pass parentRunId to link the new run to a parent.`,
    ...
    properties: {
      ...
      provider: { type: "string", enum: ["openclaw", "hermes", "codex"], description: "Optional local provider override only when the current user explicitly names it; omit for a regular Omi agent." },
