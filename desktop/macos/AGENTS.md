...
- Run GitHub Actions workflow `desktop_promote_prod.yml` with the nominated `release_tag=v*-macos` stable candidate, `confirm=promote-stable`, and `python_backend_sha=<compatible attested python-backend SHA>`.
