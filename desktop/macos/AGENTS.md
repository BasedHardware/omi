...
- Run GitHub Actions workflow `desktop_promote_prod.yml` with `release_tag=v*-macos`, `confirm=promote-stable`, and `python_backend_sha=<blessed compatible backend SHA>`.
