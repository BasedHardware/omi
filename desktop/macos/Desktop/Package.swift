  ...
  targets: [
    ...
    .executableTarget(
      ...
      resources: [
        ...
        // Resources/changelog.json, the trimmed release notes the Updates
        // settings section renders offline — generated by
        // .github/scripts/desktop-changelog.py alongside CHANGELOG.json).
