...
extension AppState {
  ...
  func startTranscription(
    ...
    // transcription itself is exempt (BYOK). Explicit "transcription" reason
    // (not the default "trial_expired") so the central choke point applies
    // this gate's own exemption.
