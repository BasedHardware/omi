...
struct ChatAttachment: Identifiable, Equatable {
  ...
  /// When the attachment's file was generated by the app itself (a staged
  /// screen frame), the app owns the file's lifetime: it is deleted when the
  /// attachment is dropped without being sent, and once the turn that sent
  /// it has settled. `nil` for user-picked files, which the app must never
  /// delete.
  var appOwnedFileURL: URL?
  ...
  init(
    ...
    self.appOwnedFileURL = appOwnedFileURL
