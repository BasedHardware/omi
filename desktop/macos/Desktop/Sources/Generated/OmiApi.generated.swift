...
public enum OmiAPI {
  ...
  public static func uploadAudioToConversationV1ConversationsUploadAudioPost(client: OmiApiClient, authorization: String? = nil, xAppPlatform: String? = nil, xDeviceIdHash: String? = nil, xAppVersion: String? = nil) async throws -> OmiAnyCodable {
    let _path = "/v1/conversations/upload-audio"
    guard let components = URLComponents(string: client.baseURL + _path) else {
      throw OmiApiError.invalidURL
    }
    guard let url = components.url else { throw OmiApiError.invalidURL }
