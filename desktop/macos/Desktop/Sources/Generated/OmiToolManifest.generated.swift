...
enum OmiToolManifest {
  static let localAgentAPITools: [LocalAgentTool] = [
    ...
    LocalAgentTool(
      ...
      properties: [
        "query": [
          "type": "string", "description": "SQL query to execute against the local Omi database",
        ]
      ],
      required: ["query"],
      annotations: ["readOnlyHint": true, "destructiveHint": false, "openWorldHint": false]
    ...
    LocalAgentTool(
      ...
      properties: [
        "screenshot_id": [
          "type": "number",
          "description": "Screenshot ID from search_screen_history or the screenshots table",
        ]
      ],
    ...
    LocalAgentTool(
      name: "complete_task",
      description:
        "Mark a task complete. This is idempotent; already-completed tasks stay completed. Find the task id first with execute_sql or search_tasks.",
    ...
    LocalAgentTool(
      ...
      properties: [
        ...
        "token_url": [
          "type": "string", "description": "OAuth token URL when the form asks for it.",
        ],
        "submit": [
          "type": "boolean",
          "description":
