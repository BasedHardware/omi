...
struct ConnectSheet: View {
  ...
  private var formBody: some View {
    VStack(alignment: .leading, spacing: 14) {
      Text(
        "Enter the credentials for your \(plugin.displayName) integration. They are sent to the plugin service URL you configured (HTTPS recommended for production; the URL must be http or https)."
      )
      .scaledFont(size: 13)
  ...
  private func handleClipboardChange(_ content: String) {
    ...
    guard
      let target = plugin.credentialFields.first(where: { field in
  ...
  private var userAccountSection: some View {
    ...
    VStack(alignment: .leading, spacing: 8) {
      ...
      Text(
        "Talk to your contacts as yourself, not as a bot. Requires a Telethon session generated by signing into your Telegram account."
      )
      .scaledFont(size: 12)
      .foregroundColor(OmiColors.textSecondary)
      .fixedSize(horizontal: false, vertical: true)
      ...
      VStack(alignment: .leading, spacing: 6) {
        HStack(alignment: .top, spacing: 6) {
          Image(systemName: "exclamationmark.triangle.fill")
            ...
            .foregroundColor(OmiColors.warning)
          Text(
            "This will sign in to your personal Telegram account. Replies will appear to come from you, not from a bot. Telegram's Terms of Service restrict automated use of personal accounts -- use sparingly and at your own risk."
          )
          .scaledFont(size: 11)
          .foregroundColor(OmiColors.textPrimary)
          .fixedSize(horizontal: false, vertical: true)
  ...
  private func signOutUserAccount() {
    do {
      ...
      let msg =
        "Could not remove session from Keychain: " + String(describing: error) + ". "
  ...
  private func runSessionGenerator(
    ...
    let shellCmd =
      "\(executable)\(argsStr) \(scriptPath) --output-file \(sessionFile); echo $? > \(markerFile); echo ''; echo 'Done. You can close this window.'; sleep 3"
  ...
  nonisolated static func isSafeDeepLink(_ s: String, plugin: AIPlugin) -> Bool {
