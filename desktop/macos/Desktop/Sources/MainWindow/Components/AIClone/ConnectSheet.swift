...
struct ConnectSheet: View {
    ...
    /// - Not connected: "Generate session" button
    ...
    private var userAccountSection: some View {
        ...
        VStack(alignment: .leading, spacing: 8) {
            ...
            if config.telegramAccountEnabled {
                ...
                .buttonStyle(.bordered)
                .help("Launches session_string_generator.py, which prompts for your Telegram credentials and writes the resulting session string to Keychain.")
            }
        }
        .padding(.top, 4)
    }
