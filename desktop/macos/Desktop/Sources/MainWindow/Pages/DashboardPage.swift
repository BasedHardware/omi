...
extension AnyTransition {
  ...
  /// During initial history restoration, the useful hub leaves upward while
  /// the completed conversation rises from below into the same stage.
  fileprivate static var homeHubStage: AnyTransition {
    .asymmetric(
      insertion: .modifier(
        active: HomeStageDropModifier(offsetY: 14, scale: 1, opacity: 0),
        identity: HomeStageDropModifier(offsetY: 0, scale: 1, opacity: 1)
  ...
  fileprivate static var homeChatRise: AnyTransition {
    .asymmetric(
      insertion: .modifier(
        active: HomeStageDropModifier(offsetY: 54, scale: 0.98, opacity: 0),
        identity: HomeStageDropModifier(offsetY: 0, scale: 1, opacity: 1)
