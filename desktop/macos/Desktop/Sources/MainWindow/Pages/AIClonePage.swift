...
struct AIClonePage: View {
  ...
  private var infoFooter: some View {
    VStack(alignment: .leading, spacing: 8) {
      ...
      Text(
        "Credentials are stored in the macOS Keychain. The plugin URL and bearer token are auto-filled when the plugin is running locally; your developer API key is still entered manually unless the plugin runs in dev mode."
      )
      .scaledFont(size: 11)
      .foregroundColor(OmiColors.textTertiary)
      .fixedSize(horizontal: false, vertical: true)
