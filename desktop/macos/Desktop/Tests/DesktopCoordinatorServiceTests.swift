...
final class DesktopCoordinatorServiceTests: XCTestCase {
  ...
  func testMainChatSendsRawUserTextToKernel() throws {
    ...
    XCTAssertTrue(source.contains("kernelTurnProjection.recordTurn("))
  ...
  func testPTTBuildsFreshRealtimeSessionsFromTypedKernelContextSnapshot() throws {
    ...
    XCTAssertTrue(hubSource.contains("voiceSessionContext()"))
    ...
    XCTAssertTrue(bridgeSource.contains("func getContextSnapshot(sessionId:"))
