...
struct MemoryGraphPage: View {
    ...
    var body: some View {
        ZStack {
            ...
            NootoColors.backgroundSecondary.ignoresSafeArea()
...
struct MemoryGraphSceneView: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> SCNView {
        ...
        scnView.backgroundColor = NSColor(red: 0x1A/255.0, green: 0x1A/255.0, blue: 0x1A/255.0, alpha: 1.0) // Match NootoColors.backgroundSecondary
