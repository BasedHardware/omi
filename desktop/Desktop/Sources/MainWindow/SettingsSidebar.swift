...
struct SettingsSearchItem: Identifiable {
    ...
    static let allSearchableItems: [SettingsSearchItem] = [
        ...
        SettingsSearchItem(name: "Update Channel", subtitle: "Choose between stable and beta update channels", keywords: ["channel", "beta", "stable", "release channel"], section: .about, advancedSubsection: nil, icon: "info.circle", settingId: "about.channel"),
