...
struct SettingsSearchItem: Identifiable {
    ...
    static let allSearchableItems: [SettingsSearchItem] = [
        ...
        SettingsSearchItem(name: "Task Extraction Prompt", subtitle: "Customize AI instructions for task extraction", keywords: ["prompt", "custom prompt", "task prompt"], section: .advanced, advancedSubsection: .taskAssistant, icon: "checklist", settingId: "advanced.taskassistant.prompt"),
