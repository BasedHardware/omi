...
struct SettingsSearchItem: Identifiable {
    ...
    static let allSearchableItems: [SettingsSearchItem] = [
        ...
        SettingsSearchItem(name: "Insight Notifications", subtitle: "Show notification when an insight is generated", keywords: ["insight", "insights", "notify insight"], section: .notifications, icon: "bell", settingId: "notifications.insight"),
        ...
        SettingsSearchItem(name: "Insight Assistant", subtitle: "Get proactive insights and suggestions", keywords: ["tips", "suggestions", "insight"], section: .advanced, icon: "lightbulb.fill", settingId: "advanced.insightassistant"),
        SettingsSearchItem(name: "Insight Frequency", subtitle: "How often to check for insight opportunities", keywords: ["interval", "how often", "insight frequency"], section: .advanced, icon: "lightbulb.fill", settingId: "advanced.insightassistant.frequency"),
        SettingsSearchItem(name: "Insight Minimum Confidence", subtitle: "Only show insights above this confidence level", keywords: ["confidence", "threshold", "accuracy"], section: .advanced, icon: "lightbulb.fill", settingId: "advanced.insightassistant.confidence"),
        SettingsSearchItem(name: "Insight Prompt", subtitle: "Customize AI instructions for insights", keywords: ["prompt", "custom prompt", "insight prompt", "edit"], section: .advanced, icon: "lightbulb.fill", settingId: "advanced.insightassistant.prompt"),
        SettingsSearchItem(name: "Insight Excluded Apps", subtitle: "Insights won't be generated from these apps", keywords: ["exclude", "ignore", "insight apps"], section: .advanced, icon: "lightbulb.fill", settingId: "advanced.insightassistant.excludedapps"),
