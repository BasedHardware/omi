...
class AssistantSettings {
  ...
  private let transcriptionProviderModeKey = "transcriptionProviderMode"
  private let transcriptionQualityPresetKey = "transcriptionQualityPreset"
  ...
  private let defaultTranscriptionProviderMode = TranscriptionProviderKind.cloud.rawValue
  private let defaultTranscriptionQualityPreset = TranscriptionQualityPreset.auto.rawValue
  ...
  private init() {
    ...
    UserDefaults.standard.register(defaults: [
      ...
      transcriptionProviderModeKey: defaultTranscriptionProviderMode,
      transcriptionQualityPresetKey: defaultTranscriptionQualityPreset,
  ...
  /// Provider selection policy for transcription. Defaults to cloud so existing
  /// desktop behavior remains unchanged until local-first onboarding is wired.
  var transcriptionProviderSelection: TranscriptionProviderSelection {
    get {
      let modeValue = UserDefaults.standard.string(forKey: transcriptionProviderModeKey)
      let qualityValue = UserDefaults.standard.string(forKey: transcriptionQualityPresetKey)
      return TranscriptionProviderSelection(
        mode: TranscriptionProviderKind(rawValue: modeValue ?? defaultTranscriptionProviderMode)
          ?? .cloud,
        quality: TranscriptionQualityPreset(
          rawValue: qualityValue ?? defaultTranscriptionQualityPreset) ?? .auto
      )
    }
    set {
      UserDefaults.standard.set(newValue.mode.rawValue, forKey: transcriptionProviderModeKey)
      UserDefaults.standard.set(newValue.quality.rawValue, forKey: transcriptionQualityPresetKey)
      NotificationCenter.default.post(name: .transcriptionSettingsDidChange, object: nil)
    }
  }
  ...
  func resetToDefaults() {
    ...
    transcriptionProviderSelection = TranscriptionProviderSelection(
      mode: TranscriptionProviderKind(rawValue: defaultTranscriptionProviderMode) ?? .cloud,
      quality: TranscriptionQualityPreset(rawValue: defaultTranscriptionQualityPreset) ?? .auto
    )
...
extension Notification.Name {
  ...
  static let assistantMonitoringStateDidChange = Notification.Name(
    "assistantMonitoringStateDidChange")
  static let assistantMonitoringToggleRequested = Notification.Name(
    "assistantMonitoringToggleRequested")
