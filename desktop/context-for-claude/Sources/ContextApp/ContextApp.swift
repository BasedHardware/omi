...
final class ContextAppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        MainActor.assumeIsolated {
            ...
            // TEMPORARY LOCAL HARNESS — NOT FOR COMMIT. Lets this agent walk the tutorial in the
            // real signed bundle without starting a second capture writer beside the installed app.
