...
enum EarshotLog {
    ...
    private static let subsystem = "com.omi.earshot"
    ...
    private static let mirrorPath = "/tmp/earshot.log"
    private static let isMirroring = ProcessInfo.processInfo.environment["EARSHOT_DEBUG"] == "1"
    ...
    private static let mirrorQueue = DispatchQueue(label: "com.omi.earshot.log", qos: .utility)
