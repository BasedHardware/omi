...
final class LoopbackCallbackServer: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.omi.earshot.auth.loopback")
    ...
    enum CallbackPage {
        ...
        var title: String {
            switch self {
            case .success: return "Signed in — Earshot"
            case .failure, .invalid: return "Sign-in failed — Earshot"
            }
        }
        ...
        var message: String {
            switch self {
            case .success: return "Head back to Earshot — it's in your menu bar. You can close this tab."
            case .failure: return "Something went wrong on the way back. Close this tab and try again from Earshot."
            case .invalid: return "This page only handles Earshot sign-in. You can close this tab."
            }
        }
