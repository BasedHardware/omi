// Settings subpages as they were before the UI program, reached from the old Settings sheet and
// Profile page: developer, plan and usage, account deletion, transcription, language,
// notifications, integrations, phone calls, people, payments and the guided voice introduction.
...
final settingsPagesScenarios = <AuditScenario>[
  ...
  AuditScenario(
    ...
    run: (a) async {
      ...
      await a.tap(find.text('Privacy concerns'));
      await a.tap(find.widgetWithText(ElevatedButton, 'Continue'));
      await a.tap(find.widgetWithText(ElevatedButton, 'Continue'));
  ...
  AuditScenario(
    ...
    title: 'Voice introduction ("Let Omi get to know you"), first prompt',
  ...
  AuditScenario(
    ...
    title: 'Voice introduction ("Let Omi get to know you"), review step',
    page: 'lib/pages/onboarding/speech_profile_widget.dart (SpeechProfileWidget)',
  ...
  AuditScenario(
    id: 'settings-voice-profile-legacy',
    title: 'Speech Profile page (removed later; only the guided introduction remains)',
    page: 'lib/pages/speech_profile/page.dart (SpeechProfilePage)',
    state: 'No speech profile recorded yet, primary language set, no device; nothing is recording',
