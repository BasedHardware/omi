// Tasks before the UI program: the task form sheet (create, due dates, failed and successful save,
// edit) and the Tasks tab, where a long press selected rows instead of opening a menu.
...
final tasksScenarios = <AuditScenario>[
  ...
  AuditScenario(
    id: 'tasks-indented',
    title: 'Tasks tab with an indented subtask, and long-press selection',
