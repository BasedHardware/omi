// The Memories page before the UI program: create, quick edit, search and filter empty states,
// and swipe-to-delete, which asked for confirmation before its Undo toast at this revision.
...
final memoriesScenarios = <AuditScenario>[
  ...
  AuditScenario(
    ...
    title: 'Memories list, swipe to delete, confirm, then Undo',
    page: 'lib/pages/memories/page.dart (MemoriesPage)',
    ...
    run: (a) async {
      ...
      await a.settle();
      // This revision confirms before deleting; the current page goes straight to Undo.
      expect(find.text('Delete Memory'), findsOneWidget);
      await a.shot('Swipe the memory row: the delete confirmation dialog', step: 'delete-confirm');
      await a.tap(find.widgetWithText(TextButton, 'Delete'));
      expect(find.text('Undo'), findsOneWidget);
      await a.shot('Confirm the delete; the Undo toast shows', step: 'undo');
