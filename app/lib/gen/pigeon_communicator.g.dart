    ...
    }
    {
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          final bool? arg_willAutoReconnect = (args[2] as bool?);
          assert(arg_willAutoReconnect != null,
              'Argument for dev.flutter.pigeon.omi_pigeon.BleFlutterApi.onPeripheralDisconnected was null, expected non-null bool.');
          try {
            api.onPeripheralDisconnected(arg_peripheralUuid!, arg_error, arg_willAutoReconnect!);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          }          catch (e) {
