      ...
      builder: (context, captureProvider, child) {
        ...
        if (imageId != null) {
          ...
          if (updatedImage != null) {
            ...
            debugPrint('📱 ImageDialog: Found updated image with description: ${updatedImage['description'] != null}');
          } else {
            debugPrint('📱 ImageDialog: No updated version found for image $imageId');
          }
        }
        ...
        debugPrint('📱 ImageDialog: Displaying image $imageId, hasDescription: ${description != null}, description: ${description?.substring(0, math.min(50, description?.length ?? 0)) ?? 'null'}...');
