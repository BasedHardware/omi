    ...
    switch (_step) {
      ...
      case _SetupStep.audioOnly:
        return [
          ...
          Text(
            context.l10n.raybanMetaAudioOnlyExplanation,
      ...
      case _SetupStep.register:
        return [
          ...
          const SizedBox(height: 16),
          Text(
            context.l10n.raybanMetaSetupDescription,
            style: OmiType.body.copyWith(color: OmiColors.textSecondary),
            textAlign: TextAlign.center,
          ),
          const SizedBox(height: 32),
      ...
      case _SetupStep.waitingForMetaAi:
        return [
          ...
          const SizedBox(height: 16),
          Text(
            context.l10n.raybanMetaWaitingForMetaAI,
            style: OmiType.body.copyWith(color: OmiColors.textSecondary),
            textAlign: TextAlign.center,
          ),
          const SizedBox(height: 24),
      ...
      case _SetupStep.cameraPermission:
        return [
          ...
          const SizedBox(height: 16),
          Text(
            context.l10n.raybanMetaCameraExplanation,
            style: OmiType.body.copyWith(color: OmiColors.textSecondary),
            textAlign: TextAlign.center,
          ),
          const SizedBox(height: 32),
