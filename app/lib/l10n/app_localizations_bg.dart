...
class AppLocalizationsBg extends AppLocalizations {
  ...
  String get transcriptionUnavailableSavingOnDevice =>
      'Транскрипцията е недостъпна · записва се на устройството';
  ...
  String get deviceNameCannotBeEmpty =>
      'Името на устройството не може да е празно';
  ...
  String get deviceRenameFailed =>
      'Името не можа да бъде записано в Omi. Проверете дали е свързано и опитайте отново.';
