...
class AppLocalizationsVi extends AppLocalizations {
  ...
  @override
  String get disconnectTwitterConfirmation => 'Bạn có chắc chắn muốn ngắt kết nối tài khoản Twitter? Nhân cách của bạn sẽ không còn được huấn luyện từ hoạt động Twitter của bạn nữa.';
  ...
  @override
  String get xHandleDescription => 'Chúng tôi sẽ huấn luyện trước bản sao Omi của bạn\ndựa trên hoạt động tài khoản của bạn';
