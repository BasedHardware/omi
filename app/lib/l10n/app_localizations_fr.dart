...
class AppLocalizationsFR extends AppLocalizations {
  ...
  @override
  String get aboutMinutesRemaining => 'Environ {minutes} minutes restantes';
  ...
  @override
  String get accessesAndTriggeredBy => '{accessDescription} et est {triggerDescription}.';

  @override
  String get accessesDataTypes => 'Accède à {dataTypes}';
  ...
  @override
  String get actionItemDeletedResult => 'Action « {description} » supprimée';
  ...
  String get actionItemsSyncedTo =>
      'Vos actions à faire seront synchronisées avec votre compte {appName}';
  ...
  @override
  String get addAppErrorOpeningFilePicker =>
      'Erreur lors de l\'ouverture du sélecteur de fichiers: {message}';

  @override
  String get addAppErrorSelectingImage => 'Erreur lors de la sélection de l\'image: {error}';

  @override
  String get addAppErrorSelectingImageRetry => 'Erreur lors de la sélection de l\'image. Veuillez réessayer.';

  @override
  String get addAppErrorSelectingThumbnail => 'Erreur lors de la sélection de la miniature: {error}';
  ...
  @override
  String get addedToService => 'Ajouté à {serviceName}';

  @override
  String get addingToService => 'Ajout à {serviceName}...';

  @override
  String get additionalSampleIndex => 'Échantillon supplémentaire {index}';
  ...
  @override
  String get aiGenErrorOccurredWithDetails => 'Une erreur s\'est produite : {message}';
  ...
  @override
  String get alreadyExportedTo => 'Déjà exporté vers {platform}';
  ...
  @override
  String get appIntegration => 'Intégration {appName}';
  ...
  @override
  String get appSettings => 'Paramètres de {appName}';
  ...
  @override
  String get appsCount => 'Applications ({count})';
  ...
  @override
  String get audioInputSetTo => 'Entrée audio définie sur {deviceName}';
  ...
  String get authAccessMessage =>
      'Vous devrez autoriser Omi à accéder à vos données {appName}. Cela ouvrira votre navigateur pour l\'authentification.';
  ...
  String get authorizeOmiForTasks =>
      'Vous devrez autoriser Omi à créer des tâches dans votre compte {appName}. Cela ouvrira votre navigateur pour l\'authentification.';
  ...
  @override
  String get autoClosingInSeconds => 'Fermeture automatique dans {seconds} secondes';
  ...
  @override
  String get availableSpace => 'Espace disponible : {space}';

  @override
  String get availableSpaceWithValue => 'Espace disponible: {space}';
  ...
  String get backgroundActivityDesc =>
      'Laissez Omi fonctionner en arrière-plan pour une meilleure stabilité';
  ...
  String get basicPlanDesc =>
      'Votre forfait comprend {limit} minutes gratuites par mois. Passez à l\'illimité.';
  ...
  @override
  String get cancelAtPeriodEnd => 'Votre forfait sera annulé le {date}.';
  ...
  @override
  String get captureRecordingError =>
      'Une erreur s\'est produite pendant l\'enregistrement : {error}';

  @override
  String get captureRecordingStoppedDisplayIssue =>
      'Enregistrement arrêté : {reason}. Vous devrez peut-être reconnecter les écrans externes ou redémarrer l\'enregistrement.';
  ...
  @override
  String get charactersCount => '{count} caractères';
  ...
  @override
  String get chatWithAppName => 'Chat avec {appName}';
  ...
  String get clearMemoryConfirmation =>
      'Êtes-vous sûr de vouloir effacer la mémoire d\'Omi? Cette action ne peut pas être annulée et supprimera définitivement tous les {count} souvenirs.';
  ...
  @override
  String get connectTo => 'Se connecter à {appName}';

  @override
  String get connectToAppTitle => 'Se connecter à {appName}';

  @override
  String get connectToDeviceName => 'Se connecter à {deviceName}';

  @override
  String get connected => 'Connecté';

  @override
  String get connectedAsUser => 'Connecté en tant qu\'utilisateur : {userId}';
  ...
  @override
  String get connectedToApp => 'Connecté à {appName}';

  @override
  String get connectingToDeviceName => 'Connexion à {deviceName}';
  ...
  @override
  String get contactsSelectedCount => '{count} sélectionnés';
  ...
  String get conversationEndAfterMinutes =>
      'Les conversations se termineront maintenant après {minutes} minute(s) de silence';
  ...
  String get conversationSummarizedAfterMinutes =>
      'La conversation est résumée après {minutes} minute{suffix} sans parole.';
  ...
  @override
  String get conversationsCreated => '{count} conversations créées';
  ...
  @override
  String get copiedToClipboard => '{title} copié dans le presse-papiers';
  ...
  @override
  String get countRemaining => '{count} restants';
  ...
  String get dataProtectedWithSettings =>
      'Vos données sont maintenant protégées avec les nouveaux paramètres {level}.';
  ...
  @override
  String get daysAgo => 'il y a {count} jours';
  ...
  @override
  String get deleteGraphFailed => 'Échec de la suppression du graphe : {error}';
  ...
  String get deleteItemConfirmation =>
      'Êtes-vous sûr de vouloir supprimer ce {item} ? Cette action est irréversible.';

  @override
  String get deleteItemQuestion => 'Supprimer {item} ?';
  ...
  String get deletePersonConfirmation =>
      'Êtes-vous sûr de vouloir supprimer {name}? Cela supprimera également tous les échantillons vocaux associés.';
  ...
  @override
  String get deleteQuoted => 'Supprimer « {name} »';
  ...
  @override
  String get deleteSampleConfirmation => 'Êtes-vous sûr de vouloir supprimer l\'échantillon de {name}?';
  ...
  String get deleteSelectedItemsMessage =>
      'Êtes-vous sûr de vouloir supprimer {count} action(s) sélectionnée(s) ?';
  ...
  @override
  String get deletedLimitlessConversations => '{count} conversations Limitless supprimées';
  ...
  String get deviceDisconnectedBody =>
      'Veuillez vous reconnecter pour continuer à utiliser votre {deviceName}.';
  ...
  @override
  String get deviceDisconnectedTitle => '{deviceName} déconnecté';
  ...
  @override
  String get deviceUsesCodec => '{device} utilise {reason}. Omi sera utilisé.';

  @override
  String get devicesFoundNearby =>
      '{count} {count, plural, =1{APPAREIL} other{APPAREILS}} TROUVÉ(S) À PROXIMITÉ';
  ...
  String get disconnectAppMessage =>
      'Êtes-vous sûr de vouloir vous déconnecter de {appName} ? Vous pouvez vous reconnecter à tout moment.';

  @override
  String get disconnectAppTitle => 'Déconnecter {appName} ?';

  @override
  String get disconnectDevice => 'Déconnecter l\'appareil';

  @override
  String get disconnectFromApp => 'Déconnecter de {appName} ?';

  @override
  String get disconnectFromAppDesc =>
      'Cela supprimera votre authentification {appName}. Vous devrez vous reconnecter pour l\'utiliser à nouveau.';
  ...
  @override
  String get disconnectedFrom => 'Déconnecté de {appName}';
  ...
  @override
  String get downloadError => 'Erreur de téléchargement : {error}';

  @override
  String get downloadErrorWithMessage => 'Erreur de téléchargement: {error}';

  @override
  String get downloadModel => 'Télécharger le modèle';

  @override
  String get downloadModelWithName => 'Télécharger le modèle ({model})';
  ...
  @override
  String get downloadingModelProgress => 'Téléchargement de {model}: {received} / {total} Mo';
  ...
  @override
  String get durationSeconds => 'Durée : {seconds} secondes';
  ...
  @override
  String get enableDeviceWifi => 'Activer le WiFi de {deviceName}';
  ...
  @override
  String get endsOnDate => 'Se termine le {date}';
  ...
  @override
  String get errorCheckingConnection => 'Erreur lors de la vérification de la connexion : {error}';

  @override
  String get errorConnectingAppleWatch => 'Erreur de connexion à l\'Apple Watch : {error}';
  ...
  @override
  String get errorInstallingApp => 'Erreur lors de l\'installation de {appName} : {error}';

  @override
  String get errorLabel => 'Erreur : {error}';
  ...
  @override
  String get errorRequestingPermission => 'Erreur lors de la demande de permission : {error}';

  @override
  String get errorSaving => 'Erreur d\'enregistrement : {error}';

  @override
  String get errorStartingRecording => 'Erreur lors du démarrage de l\'enregistrement : {error}';

  @override
  String get errorSwitchingAudioDevice => 'Erreur lors du changement de périphérique audio : {error}';
  ...
  @override
  String get errorWithMessage => 'Erreur : {error}';

  @override
  String get estimatedHours => '~{count} heure(s)';

  @override
  String get estimatedMinutes => '~{count} minute(s)';

  @override
  String get estimatedSize => 'Taille estimée : ~{size} Mo';

  @override
  String get estimatedSizeLabel => 'Estimated Size';

  @override
  String get estimatedSizeWithValue => 'Taille estimée: ~{size} Mo';

  @override
  String get estimatedTimeRemaining => 'Estimation : {time} restant';
  ...
  @override
  String get failedToAddToService => 'Échec de l\'ajout à {serviceName}';
  ...
  @override
  String get failedToCheckMicrophonePermission =>
      'Échec de la vérification de l\'autorisation du microphone : {error}';
  ...
  @override
  String get failedToConnectServiceWithError => 'Échec de la connexion à {serviceName} : {error}';
  ...
  @override
  String get failedToCreateApiKey => 'Échec de la création de la clé API du fournisseur : {error}';
  ...
  @override
  String get failedToCreateKeyWithError => 'Échec de la création de la clé : {error}';
  ...
  @override
  String get failedToDeleteError => 'Échec de la suppression : {error}';

  @override
  String get failedToDeleteFolder => 'Échec de la suppression du dossier';

  @override
  String get failedToDeleteGraph => 'Échec de la suppression du graphe : {error}';
  ...
  @override
  String get failedToInstallApp => 'Échec de l\'installation de {appName}. Veuillez réessayer.';

  @override
  String get failedToLoadContacts => 'Échec du chargement des contacts';

  @override
  String get failedToLoadRepos => 'Échec du chargement des dépôts : {error}';
  ...
  @override
  String get failedToRevokeApiKey => 'Échec de la révocation de la clé API : {error}';
  ...
  @override
  String get failedToSendReply => 'Échec de l\'envoi de la réponse : {error}';

  @override
  String get failedToSetLanguage => 'Échec de la définition de la langue';

  @override
  String get failedToStartAppAuth => 'Échec du démarrage de l\'authentification {appName}';

  @override
  String get failedToStartAuth => 'Échec du démarrage de l\'authentification {appName}';
  ...
  @override
  String get failedToStartUpdate => 'Échec du démarrage de la mise à jour: {error}';
  ...
  @override
  String get failedToUpdateSettings => 'Échec de la mise à jour des paramètres : {error}';
  ...
  String get firmwareUpdateAvailableDescription =>
      'Une nouvelle mise à jour du firmware ({version}) est disponible pour votre appareil Omi. Voulez-vous mettre à jour maintenant ?';
  ...
  @override
  String get generatedBy => 'Généré par {appName}';
  ...
  String get getOmiDeviceDescription =>
      'Créez un clone plus précis avec vos conversations personnelles';
  ...
  @override
  String get heresWhatWeDiscussed => 'Voici ce dont nous venons de discuter : {link}';
  ...
  @override
  String get hints => 'Conseils : {text}';
  ...
  @override
  String get importErrorGeneric => 'Erreur : {error}';

  @override
  String get importErrorOpeningFilePicker =>
      'Erreur lors de l\'ouverture du sélecteur de fichiers : {message}';
  ...
  @override
  String get importedConfig => 'Configuration {providerName} importée';
  ...
  @override
  String get insightsUsedThisMonth => '{used} sur {limit} aperçus obtenus ce mois-ci';
  ...
  String get integrationComingSoon =>
      'L\'intégration avec {appName} arrive bientôt ! Nous travaillons dur pour vous apporter plus d\'options de gestion des tâches.';
  ...
  @override
  String get invalidJson => 'JSON invalide : {error}';
  ...
  @override
  String get isTriggeredBy => 'Est {triggerDescription}.';
  ...
  @override
  String get itemCopiedToClipboard => '{item} copié dans le presse-papiers';

  @override
  String get itemPersona => 'Persona';

  @override
  String get itemsDeletedResult => '{count} action(s) supprimée(s)';

  @override
  String get itemsSelected => '{count} sélectionné(s)';
  ...
  @override
  String get keepItemPublic => 'Garder {item} public';
  ...
  @override
  String get labelCopied => '{label} copié';
  ...
  @override
  String get languageSetTo => 'Langue définie sur {language}';
  ...
  @override
  String get largeTimeGapDetected => 'Grand écart de temps détecté ({gap})';

  @override
  String get largeTimeGapsDetected => 'Grands écarts de temps détectés ({gaps})';
  ...
  @override
  String get loadMoreRemaining => 'Charger plus ({count} restants)';
  ...
  String get makeItemPrivateExplanation =>
      'Si vous rendez {item} privé maintenant, il cessera de fonctionner pour tout le monde et ne sera visible que pour vous';

  @override
  String get makeItemPrivateQuestion => 'Rendre {item} privé ?';

  @override
  String get makeItemPublicExplanation =>
      'Si vous rendez {item} public, il pourra être utilisé par tout le monde';

  @override
  String get makeItemPublicQuestion => 'Rendre {item} public ?';
  ...
  @override
  String get maximumGoalsAllowed => 'Maximum {count} objectifs autorisés';
  ...
  @override
  String get memoriesCount => '{count} souvenirs';

  @override
  String get memoriesUsedThisMonth => '{used} sur {limit} mémoires créées ce mois-ci';
  ...
  String get mergeConversationsMessage =>
      'Cela combinera {count} conversations en une seule. Tout le contenu sera fusionné et régénéré.';

  @override
  String get mergeConversationsSuccessBody => '{count} conversations ont été fusionnées avec succès';
  ...
  @override
  String get microphoneChangedResumingIn => 'Microphone changé. Reprise dans {countdown}s';
  ...
  @override
  String get migratingFromTo => 'Migration de {source} vers {target}';

  @override
  String get migratingItemsProgress => 'Migration de {itemType}... {percentage}%';

  @override
  String get migratingToProtection => 'Migration vers la protection {level}...';
  ...
  @override
  String get minsUsedThisMonth => '{used} sur {limit} min utilisées ce mois-ci';
  ...
  @override
  String get modelNameWithFile => 'Modèle: {model}';
  ...
  @override
  String get modelReadyWithName => 'Modèle prêt ({model})';
  ...
  @override
  String get monthsAgo => 'il y a {count} mois';

  @override
  String get moveConversationsTo => 'Déplacer {count} conversations vers :';

  @override
  String get moveToFolder => 'Déplacer vers le dossier';

  @override
  String get msgCameraAccessError => 'Erreur d\'accès à la caméra : {error}';
  ...
  @override
  String get msgFilePickerError => 'Erreur d\'ouverture du sélecteur de fichiers : {error}';
  ...
  @override
  String get msgSelectFilesError => 'Erreur lors de la sélection de fichiers : {error}';

  @override
  String get msgSelectFilesGenericError => 'Erreur lors de la sélection de fichiers. Veuillez réessayer.';

  @override
  String get msgSelectImagesError => 'Erreur lors de la sélection d\'images : {error}';
  ...
  @override
  String get noConversationsOnDate => 'Aucune conversation le {date}';
  ...
  @override
  String get objectsCount => '{processed} / {total} objets';
  ...
  String get onboardingAccessibilityStatusCheckPrefs =>
      'État de l\'autorisation d\'accessibilité : {status}. Veuillez vérifier les Préférences Système.';
  ...
  String get onboardingBluetoothStatusCheckPrefs =>
      'État de l\'autorisation Bluetooth : {status}. Veuillez vérifier les Préférences Système.';
  ...
  @override
  String get onboardingFailedCheckAccessibility =>
      'Échec de la vérification de l\'autorisation d\'accessibilité : {error}';

  @override
  String get onboardingFailedCheckBluetooth =>
      'Échec de la vérification de l\'autorisation Bluetooth : {error}';

  @override
  String get onboardingFailedCheckMicrophone =>
      'Échec de la vérification de l\'autorisation du microphone : {error}';

  @override
  String get onboardingFailedCheckNotification =>
      'Échec de la vérification de l\'autorisation de notification : {error}';

  @override
  String get onboardingFailedCheckScreenCapture =>
      'Échec de la vérification de l\'autorisation de capture d\'écran : {error}';
  ...
  String get onboardingMicrophoneStatusCheckPrefs =>
      'État de l\'autorisation du microphone : {status}. Veuillez vérifier les Préférences Système.';
  ...
  String get onboardingNotificationStatusCheckPrefs =>
      'État de l\'autorisation de notification : {status}. Veuillez vérifier les Préférences Système.';
  ...
  String get onboardingScreenCaptureStatusCheckPrefs =>
      'État de l\'autorisation de capture d\'écran : {status}. Veuillez vérifier les Préférences Système.';
  ...
  @override
  String get openingApp => 'Ouverture de {appName}...';
  ...
  @override
  String get pdfTitleLabel => 'Titre : {title}';
  ...
  String get personaConnectKnowledgeSource =>
      'Veuillez connecter au moins une source de données (Omi ou Twitter)';

  @override
  String get personaErrorEnablingWithError => 'Erreur lors de l\'activation du persona: {error}';
  ...
  @override
  String get personaFailedToCreateWithError => 'Échec de la création du persona: {error}';
  ...
  String get planEndedOn =>
      'Votre forfait s\'est terminé le {date}.\\nRéabonnez-vous maintenant - vous serez facturé immédiatement pour une nouvelle période de facturation.';

  @override
  String get planRemainsActiveUntil =>
      'Votre forfait restera actif jusqu\'au {date}. Après cela, vous perdrez l\'accès à vos fonctionnalités illimitées. Êtes-vous sûr ?';

  @override
  String get planRenewsOn => 'Votre forfait se renouvelle le {date}.';

  @override
  String get planSetToCancelOn =>
      'Votre forfait est programmé pour être annulé le {date}.\\nRéabonnez-vous maintenant pour conserver vos avantages - pas de frais jusqu\'au {date}.';

  @override
  String get planSwitchingDescriptionWithTitle =>
      'Vous passez de votre Plan Illimité au {title}. Êtes-vous sûr de vouloir continuer ?';
  ...
  String get pleaseAuthenticateWithService =>
      'Veuillez vous authentifier avec {serviceName} dans Paramètres > Intégrations des tâches';
  ...
  @override
  String get premiumMinsLeft => '{count} minutes premium restantes.';
  ...
  @override
  String get preparingModel => 'Préparation de {model}...';
  ...
  @override
  String get privateAppsCount => 'Applications privées ({count})';
  ...
  @override
  String get processingProgress => 'Traitement {current}/{total}';
  ...
  @override
  String get publicAppsCount => 'Applications publiques ({count})';
  ...
  @override
  String get ratingsCount => '{count}+ notes';
  ...
  @override
  String get renewsOn => 'Votre forfait sera renouvelé le {date}.';
  ...
  String get restartDeviceToComplete =>
      'Veuillez redémarrer votre {deviceName} pour terminer la mise à jour.';
  ...
  @override
  String get resumingInCountdown => 'Reprise dans {countdown}s...';
  ...
  String get revokeKeyConfirmation =>
      'Êtes-vous sûr de vouloir révoquer la clé "{keyName}" ? Cette action est irréversible.';

  @override
  String get revokeKeyQuestion => 'Révoquer la clé ?';

  @override
  String get sampleNumber => 'Échantillon {number}';
  ...
  String get sdCardProcessingMessage =>
      'Traitement de {count} enregistrement(s). Les fichiers seront supprimés de la carte SD ensuite.';
  ...
  @override
  String get secondsCount => '{count} secondes';
  ...
  @override
  String get selectedCount => '{count} sélectionné(s)';
  ...
  @override
  String get serviceIntegrationComingSoon => 'Intégration {serviceName} bientôt disponible';
  ...
  @override
  String get setAsDefaultSuccess => '{appName} définie comme application de résumé par défaut';

  @override
  String get setAsDefaultSummarizationApp => '{appName} définie comme application de résumé par défaut';
  ...
  @override
  String get shareStatsInsights => '✨ Fourni {count} aperçus';

  @override
  String get shareStatsListened => '🎧 Écouté pendant {minutes} minutes';

  @override
  String get shareStatsMemories => '📚 Mémorisé {count} souvenirs';
  ...
  @override
  String get shareStatsWords => '🧠 Compris {words} mots';

  @override
  String get shareViaSms => 'Partager par SMS';

  @override
  String get shareWithContactCount => 'Partager avec {count} contact';

  @override
  String get shareWithContactsCount => 'Partager avec {count} contacts';
  ...
  @override
  String get speakerWithId => 'Locuteur {speakerId}';
  ...
  @override
  String get starFilter => '{count} étoile(s)';

  @override
  String get starFilterLabel => '{count} étoile';
  ...
  String get startRecordingToSeeTranscript =>
      'Démarrez l\'enregistrement pour voir la transcription en direct';
  ...
  @override
  String get storedOnDevice => 'Stocké sur {deviceName}';
  ...
  @override
  String get summaryGeneratedFor => 'Résumé généré pour le {date}';

  @override
  String get summaryGeneratedForDate => 'Résumé généré pour {date}';
  ...
  String get tagOtherSegmentsFromSpeaker =>
      'Identifier d\'autres segments de ce locuteur ({selected}/{total})';

  @override
  String get tagSpeaker => 'Identifier le locuteur {speakerId}';
  ...
  @override
  String get timeDaySingular => '{count} jour';

  @override
  String get timeDaysAndHours => '{days} jours {hours} heures';

  @override
  String get timeDaysPlural => '{count} jours';

  @override
  String get timeHourSingular => '{count} heure';

  @override
  String get timeHoursAndMins => '{hours} heures {mins} mins';

  @override
  String get timeHoursPlural => '{count} heures';
  ...
  @override
  String get todayAtTime => 'Aujourd\'hui à {time}';
  ...
  @override
  String get totalMemoriesCount => 'Vous avez {count} mémoires au total';
  ...
  @override
  String get transferFailedMessage => 'Échec du transfert : {error}';
  ...
  @override
  String get triggeredByType => 'déclenché par {triggerType}';
  ...
  @override
  String get updatedDate => 'Mis à jour {date}';
  ...
  @override
  String get usageLimitMessage => '{used} sur {limit} min utilisées';
  ...
  @override
  String get weeksAgo => 'il y a {count} semaines';
  ...
  @override
  String get welcomeBack => 'Bon retour, {name}';
  ...
  @override
  String get wordsUsedThisMonth => '{used} sur {limit} mots utilisés ce mois-ci';
  ...
  @override
  String get wrappedCompletionRate => '{rate}% taux de réalisation';
  ...
  @override
  String get wrappedTopPercentUser => 'Top {percentile}% Utilisateur';
  ...
  @override
  String get yesterdayAtTime => 'Hier à {time}';
