...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get startConversationToSeeInsights =>
      'Ξεκινήστε μια συνομιλία με το Nooto.για να δείτε τις πληροφορίες χρήσης σας εδώ.';
  ...
  @override
  String get shareStatsMessage => 'Μοιράζομαι τα στατιστικά μου στο Nooto! (omi.me - ο πάντα ενεργός βοηθός AI σας)';
  ...
  @override
  String get wrappedShareText => 'Το 2025 μου, αποτυπωμένο από το Nooto ✨ omi.me/wrapped';
