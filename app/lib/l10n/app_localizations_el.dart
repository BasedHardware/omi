...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get deleteConversationMessage => 'Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτή τη συνομιλία; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί.';
  ...
  @override
  String get dailyReflectionDescription => 'Λάβετε μια υπενθύμιση στις 9 μ.μ. για να αναστοχαστείτε την ημέρα σας και να καταγράψετε τις σκέψεις σας.';
  ...
  @override
  String get disconnectTwitterConfirmation => 'Είστε βέβαιοι ότι θέλετε να αποσυνδέσετε τον λογαριασμό σας στο Twitter; Η περσόνα σας δεν θα χρησιμοποιεί πλέον τα δεδομένα του X.';
  ...
  @override
  String get xHandleDescription => 'Θα προεκπαιδεύσουμε τον κλώνο Omi σας\nβάσει της δραστηριότητας του λογαριασμού σας';
