...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get providingSubtitle =>
      'Ενέργειες και σημειώσεις που καταγράφονται αυτόματα.';
  ...
  String get freeMinutesMonth =>
      '1.200 δωρεάν λεπτά/μήνα συμπεριλαμβάνονται. Απεριόριστο με ';
  ...
  String get notificationsDesc =>
      'Ενεργοποιήστε τις ειδοποιήσεις για να ενημερώνεστε';
  ...
  String get actionItemMarkedIncomplete =>
      'Η ενέργεια επισημάνθηκε ως ημιτελής';
  ...
  String get actionItemDescriptionEmpty =>
      'Η περιγραφή της ενέργειας δεν μπορεί να είναι κενή.';
  ...
  String get actionItemsCopiedToClipboard =>
      'Τα στοιχεία ενεργειών αντιγράφηκαν στο πρόχειρο';
  ...
  String get addToClaudeDesktopConfig =>
      'Προσθήκη στο claude_desktop_config.json';
  ...
  String get actionItemDescriptionCannotBeEmpty =>
      'Η περιγραφή του στοιχείου ενέργειας δεν μπορεί να είναι κενή';
  ...
  String get startRecordingToSeeTranscript =>
      'Ξεκινήστε την καταγραφή για να δείτε τη ζωντανή μεταγραφή';
  ...
  String get capturingAudioAndGeneratingTranscript =>
      'Καταγραφή ήχου και δημιουργία μεταγραφής';
  ...
  String get configurePersonaDescription =>
      'Διαμορφώστε την προσωπικότητα AI σας';
  ...
  String get enterHotspotCredentials =>
      'Εισάγετε τα διαπιστευτήρια hotspot του τηλεφώνου σας';
  ...
  String get basicPlanDescription =>
      '1.200 premium λεπτά + απεριόριστα στη συσκευή';
  ...
  String get uploadingVoiceProfile =>
      'Μεταφόρτωση του φωνητικού σας προφίλ....';
  ...
  String get transferStartFailed =>
      'Η εκκίνηση της μεταφοράς απέτυχε. Παρακαλώ δοκιμάστε ξανά.';
  ...
  String get wifiConnectionFailed =>
      'Η σύνδεση WiFi απέτυχε. Παρακαλώ δοκιμάστε ξανά.';
  ...
  String get internetAccessPausedDuringTransfer =>
      'Η πρόσβαση στο διαδίκτυο διακόπτεται κατά τη μεταφορά';
  ...
  String get personaTwitterHandleNotFound =>
      'Ο λογαριασμός Twitter δεν βρέθηκε';

  @override
  String get personaTwitterHandleSuspended =>
      'Ο λογαριασμός Twitter έχει ανασταλεί';

  @override
  String get personaFailedToVerifyTwitter =>
      'Αποτυχία επαλήθευσης λογαριασμού Twitter';
  ...
  String get personaConnectKnowledgeSource =>
      'Συνδέστε τουλάχιστον μία πηγή δεδομένων (Omi ή Twitter)';
  ...
  String get personaFailedToCreateTryLater =>
      'Αποτυχία δημιουργίας persona. Δοκιμάστε ξανά αργότερα.';
  ...
  String get phoneCallsUpsellFeature2 =>
      'Αυτόματες περιλήψεις κλήσεων και ενέργειες';
  ...
  @override
  String get transcriptionDegraded => 'Υποβαθμισμένο';
}
