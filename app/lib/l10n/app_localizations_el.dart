...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get shareStatsMessage =>
      'Μοιράζομαι τα στατιστικά μου στο Nooto! (nooto.togodynamics.com - ο πάντα ενεργός βοηθός AI σας)';
  ...
  @override
  String get connectOmiOmiGlass => 'Σύνδεση Nooto / OmiGlass';
  ...
  @override
  String get learnMoreAtOmiTraining => 'Μάθετε περισσότερα στο nooto.togodynamics.com/training';
  ...
  @override
  String get wrappedShareText => 'Το 2025 μου, αποτυπωμένο από το Nooto ✨ nooto.togodynamics.com/wrapped';
  ...
  @override
  String get pairingTitleOmi => 'Ενεργοποιήστε το Nooto';

  @override
  String get pairingDescOmi => 'Πατήστε παρατεταμένα τη συσκευή μέχρι να δονηθεί για να την ενεργοποιήσετε.';

  @override
  String get pairingTitleOmiDevkit => 'Θέστε το Nooto DevKit σε λειτουργία σύζευξης';
  ...
  @override
  String get pairingTitleOmiGlass => 'Ενεργοποιήστε το Nooto Glass';
  ...
  String get pairingDescAppleWatch =>
      'Εγκαταστήστε και ανοίξτε την εφαρμογή Nooto στο Apple Watch σας, μετά πατήστε Σύνδεση στην εφαρμογή.';
  ...
  String get onboardingWhatIKnowAboutYouDescription =>
      'Αυτός ο χάρτης ενημερώνεται καθώς το Nooto μαθαίνει από τις συνομιλίες σας.';
