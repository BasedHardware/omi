...
class AppLocalizationsEL extends AppLocalizations {
  ...
  @override
  String get aboutMinutesRemaining => 'Απομένουν περίπου {minutes} λεπτά';
  ...
  @override
  String get accessesAndTriggeredBy => '{accessDescription} και είναι {triggerDescription}.';

  @override
  String get accessesDataTypes => 'Πρόσβαση σε {dataTypes}';
  ...
  @override
  String get actionItemDeletedResult => 'Η ενέργεια "{description}" διαγράφηκε';
  ...
  @override
  String get actionItemsSyncedTo =>
      'Οι ενέργειές σας θα συγχρονιστούν με τον λογαριασμό σας {appName}';
  ...
  @override
  String get addAppErrorOpeningFilePicker => 'Σφάλμα κατά το άνοιγμα του επιλογέα αρχείων: {message}';

  @override
  String get addAppErrorSelectingImage => 'Σφάλμα κατά την επιλογή εικόνας: {error}';

  @override
  String get addAppErrorSelectingImageRetry => 'Σφάλμα κατά την επιλογή εικόνας. Δοκιμάστε ξανά.';

  @override
  String get addAppErrorSelectingThumbnail => 'Σφάλμα κατά την επιλογή μικρογραφίας: {error}';
  ...
  @override
  String get addedToService => 'Προστέθηκε στο {serviceName}';

  @override
  String get addingToService => 'Προσθήκη σε {serviceName}...';

  @override
  String get additionalSampleIndex => 'Πρόσθετο δείγμα {index}';
  ...
  @override
  String get aiGenErrorOccurredWithDetails => 'Παρουσιάστηκε σφάλμα: {message}';
  ...
  @override
  String get alreadyExportedTo => 'Ήδη εξαγωγή σε {platform}';
  ...
  @override
  String get appIntegration => 'Ενσωμάτωση {appName}';
  ...
  @override
  String get appSettings => 'Ρυθμίσεις {appName}';
  ...
  @override
  String get appsCount => 'Εφαρμογές ({count})';
  ...
  @override
  String get audioInputSetTo => 'Είσοδος ήχου ορίστηκε σε {deviceName}';
  ...
  String get authAccessMessage =>
      'Θα χρειαστεί να εξουσιοδοτήσετε το Omi να έχει πρόσβαση στα δεδομένα σας στο {appName}. Αυτό θα ανοίξει το πρόγραμμα περιήγησής σας για πιστοποίηση.';
  ...
  String get authorizeOmiForTasks =>
      'Θα χρειαστεί να εξουσιοδοτήσετε το Omi να δημιουργεί εργασίες στον λογαριασμό σας {appName}. Αυτό θα ανοίξει το πρόγραμμα περιήγησής σας για πιστοποίηση.';
  ...
  @override
  String get autoClosingInSeconds => 'Αυτόματο κλείσιμο σε {seconds} δευτερόλεπτα';
  ...
  @override
  String get availableSpace => 'Διαθέσιμος Χώρος: {space}';

  @override
  String get availableSpaceWithValue => 'Διαθέσιμος χώρος: {space}';
  ...
  String get backgroundActivityDesc =>
      'Επιτρέψτε στο Omi να εκτελείται στο παρασκήνιο για καλύτερη σταθερότητα';
  ...
  String get basicPlanDesc =>
      'Το πρόγραμμά σας περιλαμβάνει {limit} δωρεάν λεπτά ανά μήνα. Αναβαθμίστε για απεριόριστη χρήση.';
  ...
  @override
  String get cancelAtPeriodEnd => 'Το πρόγραμμά σας θα ακυρωθεί στις {date}.';
  ...
  @override
  String get captureRecordingError => 'Παρουσιάστηκε σφάλμα κατά την εγγραφή: {error}';

  @override
  String get captureRecordingStoppedDisplayIssue =>
      'Η εγγραφή σταμάτησε: {reason}. Ίσως χρειαστεί να επανασυνδέσετε εξωτερικές οθόνες ή να επανεκκινήσετε την εγγραφή.';
  ...
  @override
  String get charactersCount => '{count} χαρακτήρες';
  ...
  @override
  String get chatWithAppName => 'Συνομιλία με {appName}';
  ...
  String get clearMemoryConfirmation =>
      'Είστε σίγουροι ότι θέλετε να διαγράψετε τη μνήμη του Omi; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί και θα διαγράψει μόνιμα όλες τις {count} μνήμες.';
  ...
  @override
  String get connectTo => 'Σύνδεση με {appName}';

  @override
  String get connectToAppTitle => 'Σύνδεση με {appName}';

  @override
  String get connectToDeviceName => 'Σύνδεση σε {deviceName}';

  @override
  String get connected => 'Συνδεδεμένο';

  @override
  String get connectedAsUser => 'Συνδεδεμένο ως χρήστης: {userId}';
  ...
  @override
  String get connectedToApp => 'Συνδεδεμένο στο {appName}';

  @override
  String get connectingToDeviceName => 'Σύνδεση σε {deviceName}...';
  ...
  @override
  String get contactsSelectedCount => '{count} επιλεγμένα';
  ...
  String get conversationEndAfterMinutes =>
      'Οι συνομιλίες θα τερματίζονται πλέον μετά από {minutes} λεπτό(-ά) σιωπής';
  ...
  @override
  String get conversationPhotosCount => '{count} φωτογραφίες';
  ...
  String get conversationPromptHint =>
      'π.χ., Εξάγετε ενέργειες, αποφάσεις και βασικά συμπεράσματα από τη συνομιλία.';
  ...
  String get conversationSummarizedAfterMinutes =>
      'Η συνομιλία συνοψίζεται μετά από {minutes} λεπτ{suffix} χωρίς ομιλία.';
  ...
  @override
  String get conversationsCreated => '{count} συνομιλίες δημιουργήθηκαν';
  ...
  @override
  String get copiedToClipboard => '{title} αντιγράφηκε στο πρόχειρο';
  ...
  @override
  String get countRemaining => '{count} απομένουν';
  ...
  String get dataProtectedWithSettings =>
      'Τα δεδομένα σας προστατεύονται πλέον με τις νέες ρυθμίσεις {level}.';
  ...
  @override
  String get daysAgo => 'πριν από {count} ημέρες';
  ...
  String get deleteActionItemMessage =>
      'Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτό το στοιχείο ενέργειας;';
  ...
  @override
  String get deleteGraphFailed => 'Αποτυχία διαγραφής γραφήματος: {error}';
  ...
  String get deleteItemConfirmation =>
      'Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτό το {item}; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί.';

  @override
  String get deleteItemQuestion => 'Διαγραφή {item};';

  @override
  String get deleteItemTitle => 'Διαγραφή {item}';
  ...
  String get deletePersonConfirmation =>
      'Είστε βέβαιοι ότι θέλετε να διαγράψετε τον/την {name}; Αυτό θα αφαιρέσει επίσης όλα τα σχετικά δείγματα ομιλίας.';
  ...
  @override
  String get deleteQuoted => 'Διαγραφή "{name}"';
  ...
  @override
  String get deleteSampleConfirmation => 'Είστε βέβαιοι ότι θέλετε να διαγράψετε το δείγμα του {name};';
  ...
  String get deleteSelectedItemsMessage =>
      'Είστε βέβαιοι ότι θέλετε να διαγράψετε {count} επιλεγμένες ενέργειες{s};';
  ...
  @override
  String get deletedLimitlessConversations => 'Διαγράφηκαν {count} συνομιλίες Limitless';
  ...
  String get deviceDisconnectedBody =>
      'Παρακαλώ επανασυνδεθείτε για να συνεχίσετε να χρησιμοποιείτε το {deviceName} σας.';
  ...
  @override
  String get deviceDisconnectedTitle => '{deviceName} αποσυνδέθηκε';
  ...
  String get deviceNoFastTransfer =>
      'Η συσκευή σας δεν υποστηρίζει γρήγορη μεταφορά. Χρησιμοποιήστε Bluetooth.';
  ...
  @override
  String get deviceUsesCodec => '{device} χρησιμοποιεί {reason}. Θα χρησιμοποιηθεί το Omi.';

  @override
  String get devicesFoundNearby =>
      '{count} {count, plural, =1{ΣΥΣΚΕΥΗ} other{ΣΥΣΚΕΥΕΣ}} ΒΡΕΘΗΚΑΝ ΚΟΝΤΑ';
  ...
  String get disconnectAppMessage =>
      'Είστε βέβαιοι ότι θέλετε να αποσυνδεθείτε από το {appName}; Μπορείτε να επανασυνδεθείτε ανά πάσα στιγμή.';

  @override
  String get disconnectAppTitle => 'Αποσύνδεση από {appName};';

  @override
  String get disconnectDevice => 'Αποσύνδεση συσκευής';

  @override
  String get disconnectFromApp => 'Αποσύνδεση από {appName};';

  @override
  String get disconnectFromAppDesc =>
      'Αυτό θα αφαιρέσει την πιστοποίησή σας στο {appName}. Θα χρειαστεί να επανασυνδεθείτε για να το χρησιμοποιήσετε ξανά.';
  ...
  @override
  String get disconnectedFrom => 'Αποσυνδέθηκε από {appName}';
  ...
  @override
  String get downloadError => 'Σφάλμα λήψης: {error}';

  @override
  String get downloadErrorWithMessage => 'Σφάλμα λήψης: {error}';

  @override
  String get downloadModel => 'Λήψη μοντέλου';

  @override
  String get downloadModelWithName => 'Λήψη μοντέλου ({model})';
  ...
  @override
  String get downloadingModelProgress => 'Λήψη {model}: {received} / {total} MB';
  ...
  @override
  String get durationSeconds => 'Διάρκεια: {seconds} δευτερόλεπτα';
  ...
  @override
  String get enableDeviceWifi => 'Ενεργοποίηση WiFi της {deviceName}';
  ...
  String get enableHotspotMessage =>
      'Παρακαλώ ενεργοποιήστε το hotspot του τηλεφώνου σας και δοκιμάστε ξανά.';
  ...
  @override
  String get endsOnDate => 'Λήγει στις {date}';
  ...
  @override
  String get errorCheckingConnection => 'Σφάλμα ελέγχου σύνδεσης: {error}';

  @override
  String get errorConnectingAppleWatch => 'Σφάλμα σύνδεσης με Apple Watch: {error}';
  ...
  @override
  String get errorInstallingApp => 'Σφάλμα εγκατάστασης του {appName}: {error}';

  @override
  String get errorLabel => 'Σφάλμα: {error}';
  ...
  @override
  String get errorRequestingPermission => 'Σφάλμα αιτήματος άδειας: {error}';

  @override
  String get errorSaving => 'Σφάλμα αποθήκευσης: {error}';

  @override
  String get errorStartingRecording => 'Σφάλμα έναρξης εγγραφής: {error}';

  @override
  String get errorSwitchingAudioDevice => 'Σφάλμα εναλλαγής συσκευής ήχου: {error}';
  ...
  @override
  String get errorWithMessage => 'Σφάλμα: {error}';

  @override
  String get estimatedHours => '~{count} ώρα/ώρες';

  @override
  String get estimatedMinutes => '~{count} λεπτό/λεπτά';

  @override
  String get estimatedSize => 'Εκτιμώμενο Μέγεθος: ~{size} MB';

  @override
  String get estimatedSizeLabel => 'Εκτιμώμενο μέγεθος';

  @override
  String get estimatedSizeWithValue => 'Εκτιμώμενο μέγεθος: ~{size} MB';

  @override
  String get estimatedTimeRemaining => 'Εκτίμηση: απομένει {time}';

  @override
  String get etaLabel => 'Εκτιμώμενος χρόνος: {time}';
  ...
  @override
  String get failedToAddToService => 'Αποτυχία προσθήκης στο {serviceName}';
  ...
  @override
  String get failedToCheckMicrophonePermission => 'Αποτυχία ελέγχου άδειας μικροφώνου: {error}';
  ...
  @override
  String get failedToConnectServiceWithError => 'Αποτυχία σύνδεσης στο {serviceName}: {error}';
  ...
  @override
  String get failedToCreateApiKey => 'Αποτυχία δημιουργίας κλειδιού API παρόχου: {error}';
  ...
  @override
  String get failedToCreateKeyWithError => 'Αποτυχία δημιουργίας κλειδιού: {error}';
  ...
  @override
  String get failedToDeleteError => 'Αποτυχία διαγραφής: {error}';

  @override
  String get failedToDeleteFolder => 'Αποτυχία διαγραφής φακέλου';

  @override
  String get failedToDeleteGraph => 'Αποτυχία διαγραφής γραφήματος: {error}';
  ...
  String get failedToInstallApp =>
      'Αποτυχία εγκατάστασης του {appName}. Παρακαλώ δοκιμάστε ξανά.';

  @override
  String get failedToLoadContacts => 'Αποτυχία φόρτωσης επαφών';

  @override
  String get failedToLoadRepos => 'Αποτυχία φόρτωσης αποθετηρίων: {error}';
  ...
  @override
  String get failedToRevokeApiKey => 'Αποτυχία ανάκλησης κλειδιού API: {error}';
  ...
  @override
  String get failedToSendReply => 'Αποτυχία αποστολής απάντησης: {error}';

  @override
  String get failedToSetLanguage => 'Αποτυχία ορισμού γλώσσας';

  @override
  String get failedToStartAppAuth => 'Αποτυχία έναρξης πιστοποίησης {appName}';

  @override
  String get failedToStartAuth => 'Αποτυχία έναρξης πιστοποίησης {appName}';
  ...
  @override
  String get failedToStartUpdate => 'Αποτυχία έναρξης ενημέρωσης: {error}';
  ...
  @override
  String get failedToUpdateSettings => 'Αποτυχία ενημέρωσης ρυθμίσεων: {error}';
  ...
  String get firmwareUpdateAvailableDescription =>
      'Μια νέα ενημέρωση υλικολογισμικού ({version}) είναι διαθέσιμη για τη συσκευή Omi σας. Θέλετε να ενημερώσετε τώρα;';
  ...
  @override
  String get generatedBy => 'Δημιουργήθηκε από {appName}';
  ...
  String get get9PmReminderToReflect =>
      'Λάβετε υπενθύμιση στις 9 μ.μ. για να αναλογιστείτε την ημέρα σας';
  ...
  String get getOmiDeviceDescription =>
      'Δημιουργήστε έναν πιο ακριβή κλώνο με τις προσωπικές σας συνομιλίες';
  ...
  @override
  String get heresWhatWeDiscussed => 'Εδώ είναι τι συζητήσαμε: {link}';
  ...
  @override
  String get hints => 'Συμβουλές: {text}';
  ...
  @override
  String get importErrorGeneric => 'Σφάλμα: {error}';

  @override
  String get importErrorOpeningFilePicker => 'Σφάλμα κατά το άνοιγμα του επιλογέα αρχείων: {message}';
  ...
  @override
  String get importedConfig => 'Εισήχθη η διαμόρφωση {providerName}';
  ...
  @override
  String get insightsUsedThisMonth => '{used} από {limit} πληροφορίες αποκτήθηκαν αυτόν τον μήνα';
  ...
  String get integrationComingSoon =>
      'Η ενσωμάτωση με το {appName} έρχεται σύντομα! Εργαζόμαστε σκληρά για να σας φέρουμε περισσότερες επιλογές διαχείρισης εργασιών.';
  ...
  @override
  String get invalidJson => 'Μη έγκυρο JSON: {error}';
  ...
  String get invalidWifiCredentials =>
      'Μη έγκυρα διαπιστευτήρια WiFi. Ελέγξτε τις ρυθμίσεις του hotspot.';

  @override
  String get isTriggeredBy => 'Είναι {triggerDescription}.';
  ...
  @override
  String get itemCopiedToClipboard => '{item} αντιγράφηκε στο πρόχειρο';

  @override
  String get itemPersona => 'Περσόνα';

  @override
  String get itemsDeletedResult => '{count} ενέργειες{s} διαγράφηκαν';

  @override
  String get itemsSelected => '{count} επιλεγμένα';
  ...
  @override
  String get keepItemPublic => 'Διατήρηση {item} δημόσιο';
  ...
  @override
  String get labelCopied => '{label} αντιγράφηκε';
  ...
  @override
  String get languageSetTo => 'Η γλώσσα ορίστηκε σε {language}';
  ...
  @override
  String get largeTimeGapDetected => 'Εντοπίστηκε μεγάλο χρονικό κενό ({gap})';

  @override
  String get largeTimeGapsDetected => 'Εντοπίστηκαν μεγάλα χρονικά κενά ({gaps})';
  ...
  @override
  String get loadMoreRemaining => 'Φόρτωση περισσότερων ({count} απομένουν)';
  ...
  String get locationAccessDesc =>
      'Ενεργοποιήστε την τοποθεσία παρασκηνίου για την πλήρη εμπειρία';
  ...
  String get lowBatteryAlertBody =>
      'Η μπαταρία της συσκευής σας είναι χαμηλή. Ώρα για επαναφόρτιση! 🔋';
  ...
  String get makeItemPrivateExplanation =>
      'Αν κάνετε το {item} ιδιωτικό τώρα, θα σταματήσει να λειτουργεί για όλους και θα είναι ορατό μόνο σε εσάς';

  @override
  String get makeItemPrivateQuestion => 'Ιδιωτικοποίηση {item};';

  @override
  String get makeItemPublicExplanation =>
      'Αν κάνετε το {item} δημόσιο, μπορεί να χρησιμοποιηθεί από όλους';

  @override
  String get makeItemPublicQuestion => 'Δημοσιοποίηση {item};';
  ...
  @override
  String get maximumGoalsAllowed => 'Μέγιστος {count} στόχοι επιτρέπονται';
  ...
  @override
  String get memoriesCount => '{count} μνήμες';

  @override
  String get memoriesUsedThisMonth => '{used} από {limit} αναμνήσεις δημιουργήθηκαν αυτόν τον μήνα';
  ...
  String get mergeConversationsMessage =>
      'Αυτό θα συνδυάσει {count} συνομιλίες σε μία. Όλο το περιεχόμενο θα συγχωνευτεί και θα αναδημιουργηθεί.';

  @override
  String get mergeConversationsSuccessBody => '{count} συνομιλίες συγχωνεύθηκαν επιτυχώς';
  ...
  @override
  String get microphoneChangedResumingIn => 'Το μικρόφωνο άλλαξε. Συνέχεια σε {countdown}s';
  ...
  @override
  String get migratingFromTo => 'Μετανάστευση από {source} σε {target}';

  @override
  String get migratingItemsProgress => 'Μεταφορά {itemType}... {percentage}%';

  @override
  String get migratingToProtection => 'Μεταφορά σε προστασία {level}...';
  ...
  @override
  String get minLabel => '{count} λεπτά';

  @override
  String get minsUsedThisMonth => '{used} από {limit} λεπτά χρησιμοποιήθηκαν αυτόν τον μήνα';
  ...
  @override
  String get modelNameWithFile => 'Μοντέλο: {model}';
  ...
  @override
  String get modelReadyWithName => 'Μοντέλο έτοιμο ({model})';
  ...
  @override
  String get monthsAgo => 'πριν από {count} μήνες';

  @override
  String get moveConversationsTo => 'Μετακίνηση {count} συνομιλιών σε:';

  @override
  String get moveToFolder => 'Μετακίνηση σε φάκελο';

  @override
  String get msgCameraAccessError => 'Σφάλμα πρόσβασης στην κάμερα: {error}';
  ...
  @override
  String get msgFilePickerError => 'Σφάλμα ανοίγματος επιλογέα αρχείων: {error}';
  ...
  @override
  String get msgSelectFilesError => 'Σφάλμα επιλογής αρχείων: {error}';

  @override
  String get msgSelectFilesGenericError => 'Σφάλμα επιλογής αρχείων. Παρακαλώ δοκιμάστε ξανά.';

  @override
  String get msgSelectImagesError => 'Σφάλμα επιλογής εικόνων: {error}';
  ...
  @override
  String get nConversations => '{count} συνομιλίες';
  ...
  @override
  String get noConversationsOnDate => 'Δεν υπάρχουν συνομιλίες στις {date}';
  ...
  @override
  String get objectsCount => '{processed} / {total} αντικείμενα';
  ...
  String get onboardingAccessibilityStatusCheckPrefs =>
      'Κατάσταση άδειας προσβασιμότητας: {status}. Παρακαλώ ελέγξτε τις Προτιμήσεις Συστήματος.';
  ...
  String get onboardingBluetoothStatusCheckPrefs =>
      'Κατάσταση άδειας Bluetooth: {status}. Παρακαλώ ελέγξτε τις Προτιμήσεις Συστήματος.';
  ...
  @override
  String get onboardingFailedCheckAccessibility => 'Αποτυχία ελέγχου άδειας προσβασιμότητας: {error}';

  @override
  String get onboardingFailedCheckBluetooth => 'Αποτυχία ελέγχου άδειας Bluetooth: {error}';

  @override
  String get onboardingFailedCheckMicrophone => 'Αποτυχία ελέγχου άδειας μικροφώνου: {error}';

  @override
  String get onboardingFailedCheckNotification => 'Αποτυχία ελέγχου άδειας ειδοποιήσεων: {error}';

  @override
  String get onboardingFailedCheckScreenCapture => 'Αποτυχία ελέγχου άδειας καταγραφής οθόνης: {error}';
  ...
  String get onboardingMicrophoneStatusCheckPrefs =>
      'Κατάσταση άδειας μικροφώνου: {status}. Παρακαλώ ελέγξτε τις Προτιμήσεις Συστήματος.';
  ...
  String get onboardingNotificationStatusCheckPrefs =>
      'Κατάσταση άδειας ειδοποιήσεων: {status}. Παρακαλώ ελέγξτε τις Προτιμήσεις Συστήματος.';
  ...
  String get onboardingScreenCaptureStatusCheckPrefs =>
      'Κατάσταση άδειας καταγραφής οθόνης: {status}. Παρακαλώ ελέγξτε τις Προτιμήσεις Συστήματος.';
  ...
  @override
  String get openingApp => 'Άνοιγμα {appName}...';
  ...
  @override
  String get pdfTitleLabel => 'Τίτλος: {title}';
  ...
  @override
  String get personaErrorEnablingWithError => 'Σφάλμα κατά την ενεργοποίηση persona: {error}';
  ...
  @override
  String get personaFailedToCreateWithError => 'Αποτυχία δημιουργίας persona: {error}';
  ...
  String get planEndedOn =>
      'Το πρόγραμμά σας έληξε στις {date}.\\nΕπανεγγραφείτε τώρα - θα χρεωθείτε αμέσως για μια νέα περίοδο χρέωσης.';

  @override
  String get planRemainsActiveUntil =>
      'Το πρόγραμμά σας θα παραμείνει ενεργό μέχρι {date}. Μετά από αυτό, θα χάσετε την πρόσβαση στις απεριόριστες λειτουργίες. Είστε σίγουροι;';

  @override
  String get planRenewsOn => 'Το πρόγραμμά σας ανανεώνεται στις {date}.';

  @override
  String get planSetToCancelOn =>
      'Το πρόγραμμά σας έχει ρυθμιστεί να ακυρωθεί στις {date}.\\nΕπανεγγραφείτε τώρα για να διατηρήσετε τα οφέλη σας - χωρίς χρέωση μέχρι {date}.';

  @override
  String get planSwitchingDescriptionWithTitle =>
      'Αλλάζετε το Απεριόριστο Πλάνο σας σε {title}. Είστε βέβαιοι ότι θέλετε να προχωρήσετε;';
  ...
  String get pleaseAuthenticateWithService =>
      'Παρακαλώ συνδεθείτε με {serviceName} στις Ρυθμίσεις > Ενσωματώσεις εργασιών';
  ...
  @override
  String get premiumMinsLeft => '{count} premium λεπτά απομένουν.';
  ...
  @override
  String get preparingModel => 'Προετοιμασία {model}...';
  ...
  @override
  String get privateAppsCount => 'Ιδιωτικές εφαρμογές ({count})';
  ...
  @override
  String get processingProgress => 'Επεξεργασία {current}/{total}';
  ...
  @override
  String get publicAppsCount => 'Δημόσιες εφαρμογές ({count})';
  ...
  @override
  String get ratingsCount => '{count}+ αξιολογήσεις';
  ...
  @override
  String get renewsOn => 'Το πρόγραμμά σας ανανεώνεται στις {date}.';
  ...
  String get restartDeviceToComplete =>
      'Κάντε επανεκκίνηση της συσκευής {deviceName} για να ολοκληρωθεί η ενημέρωση.';
  ...
  @override
  String get resumingInCountdown => 'Συνέχεια σε {countdown}s...';
  ...
  String get revokeKeyConfirmation =>
      'Είστε βέβαιοι ότι θέλετε να ανακαλέσετε το κλειδί "{keyName}"; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί.';

  @override
  String get revokeKeyQuestion => 'Ανάκληση κλειδιού;';

  @override
  String get sampleNumber => 'Δείγμα {number}';
  ...
  String get sdCardProcessingMessage =>
      'Επεξεργασία {count} εγγραφής/εγγραφών. Τα αρχεία θα αφαιρεθούν από την κάρτα SD μετά.';
  ...
  @override
  String get secondsCount => '{count} δευτερόλεπτα';
  ...
  @override
  String get segmentsCount => '{count} τμήματα';

  @override
  String get segmentsPlural => '{count} τμήματα';

  @override
  String get segmentsSingular => '{count} τμήμα';
  ...
  @override
  String get selectedCount => '{count} επιλεγμένα';
  ...
  @override
  String get serviceIntegrationComingSoon => 'Ενσωμάτωση {serviceName} σύντομα';
  ...
  @override
  String get setAsDefaultSuccess => 'Το {appName} ορίστηκε ως προεπιλεγμένη εφαρμογή σύνοψης';

  @override
  String get setAsDefaultSummarizationApp => 'Η {appName} ορίστηκε ως προεπιλεγμένη εφαρμογή περίληψης';
  ...
  @override
  String get shareStatsInsights => '✨ Παρείχε {count} πληροφορίες';

  @override
  String get shareStatsListened => '🎧 Άκουσε για {minutes} λεπτά';

  @override
  String get shareStatsMemories => '📚 Απομνημόνευσε {count} αναμνήσεις';
  ...
  @override
  String get shareStatsWords => '🧠 Κατανόησε {words} λέξεις';

  @override
  String get shareViaSms => 'Κοινοποίηση μέσω SMS';

  @override
  String get shareWithContactCount => 'Κοινοποίηση σε {count} επαφή';

  @override
  String get shareWithContactsCount => 'Κοινοποίηση σε {count} επαφές';
  ...
  @override
  String get speakerWithId => 'Ομιλητής {speakerId}';
  ...
  @override
  String get starFilter => '{count} Αστέρι';

  @override
  String get starFilterLabel => '{count} αστέρι';
  ...
  @override
  String get storedOnDevice => 'Αποθηκευμένο σε {deviceName}';
  ...
  @override
  String get summaryGeneratedFor => 'Η σύνοψη δημιουργήθηκε για {date}';

  @override
  String get summaryGeneratedForDate => 'Δημιουργήθηκε σύνοψη για {date}';
  ...
  String get tagOtherSegmentsFromSpeaker =>
      'Επισήμανση άλλων τμημάτων από αυτόν τον ομιλητή ({selected}/{total})';

  @override
  String get tagSpeaker => 'Επισήμανση ομιλητή {speakerId}';
  ...
  @override
  String get timeCompactHours => '{count}ω';

  @override
  String get timeCompactHoursAndMins => '{hours}ω {mins}λ';

  @override
  String get timeCompactMins => '{count}λ';

  @override
  String get timeCompactMinsAndSecs => '{mins}λ {secs}δ';

  @override
  String get timeCompactSecs => '{count}δ';

  @override
  String get timeDaySingular => '{count} ημέρα';

  @override
  String get timeDaysAndHours => '{days} ημέρες {hours} ώρες';

  @override
  String get timeDaysPlural => '{count} ημέρες';

  @override
  String get timeHourSingular => '{count} ώρα';

  @override
  String get timeHoursAndMins => '{hours} ώρες {mins} λεπτά';

  @override
  String get timeHoursPlural => '{count} ώρες';

  @override
  String get timeMinSingular => '{count} λεπτό';

  @override
  String get timeMinsAndSecs => '{mins} λεπτά {secs} δευτ';

  @override
  String get timeMinsPlural => '{count} λεπτά';

  @override
  String get timePM => 'ΜΜ';

  @override
  String get timeSecsPlural => '{count} δευτ';

  @override
  String get timeSecsSingular => '{count} δευτ';
  ...
  @override
  String get todayAtTime => 'Σήμερα στις {time}';
  ...
  @override
  String get totalMemoriesCount => 'Έχετε {count} συνολικές αναμνήσεις';
  ...
  @override
  String get transferFailedMessage => 'Η μεταφορά απέτυχε: {error}';
  ...
  @override
  String get triggeredByType => 'ενεργοποιείται από {triggerType}';
  ...
  @override
  String get updatedDate => 'Ενημερώθηκε {date}';
  ...
  @override
  String get usageLimitMessage => '{used} από {limit} λεπτά χρησιμοποιήθηκαν';
  ...
  @override
  String get weeksAgo => 'πριν από {count} εβδομάδες';
  ...
  @override
  String get welcomeBack => 'Καλώς ήρθες πάλι, {name}';
  ...
  String get wifiEnableFailed =>
      'Η ενεργοποίηση WiFi στη συσκευή απέτυχε. Παρακαλώ δοκιμάστε ξανά.';
  ...
  @override
  String get wordsUsedThisMonth => '{used} από {limit} λέξεις χρησιμοποιήθηκαν αυτόν τον μήνα';
  ...
  @override
  String get wrappedCompletionRate => '{rate}% ποσοστό ολοκλήρωσης';
  ...
  @override
  String get wrappedTopPercentUser => 'Κορυφαίο {percentile}% χρήστη';
  ...
  @override
  String get yesterdayAtTime => 'Χθες στις {time}';
