...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Sharing my Nooto stats! (nooto.togodynamics.com - your always-on AI assistant)'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Learn more at nooto.togodynamics.com/training'**
  ...
  ///
  /// In en, this message translates to:
  /// **'My 2025, remembered by Nooto ✨ nooto.togodynamics.com/wrapped'**
  ...
  ///
  /// In en, this message translates to:
  /// **'This map updates as Nooto learns from your conversations.'**
