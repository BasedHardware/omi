...
class AppLocalizationsHi extends AppLocalizations {
  ...
  String get offlineModeDescription =>
      'अभी ऑडियो रिकॉर्ड करें और बाद में ट्रांसक्राइब करने के लिए उसे अपने फ़ोन पर सहेजें। इस मोड में लाइव ट्रांसक्रिप्शन नहीं होता — रिकॉर्डिंग आपके फ़ोन पर ही सहेजी जाती हैं, जिन्हें आप बाद में अपलोड करके बातचीत बना सकते हैं।';

  @override
  String get offlineModeNote =>
      'फ़िलहाल यह सुविधा Omi डिवाइस के साथ काम करती है। जब तक आप ऑडियो अपलोड न करें, तब तक वह आपके फ़ोन पर ही रहता है।';

  @override
  String get offlineModeStorageFull =>
      'आपके फ़ोन में जगह कम है, इसलिए ऑफ़लाइन रिकॉर्डिंग रोक दी गई है। जगह खाली करें या अपनी रिकॉर्डिंग अपलोड करें, फिर यह अपने आप दोबारा शुरू हो जाएगी।';
}
