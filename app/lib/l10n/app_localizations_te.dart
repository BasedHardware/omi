...
class AppLocalizationsTe extends AppLocalizations {
  ...
  String get reportMessageConfirm =>
      'మీరు ఈ సందేశాన్ని నివేదించాలనుకుంటున్నారని మీరు ఖచ్చితమైనారా?';
  ...
  String get clearChatConfirm =>
      'మీరు చ్యాట్‌ను సరిచేయాలనుకుంటున్నారని మీరు ఖచ్చితమైనారా? ఈ చర్య రద్దు చేయబడదు.';
  ...
  String get allDataErased =>
      'మీ అన్ని జ్ఞాపకాలు మరియు సంభాషణలు శాశ్వతంగా తొలగించబడుతుంది.';

  @override
  String get appsDisconnected =>
      'మీ అనువర్తనాలు మరియు ఇంటిగ్రేషన్‌లు వెంటనే డిస్‌కనెక్ట్ చేయబడుతుంది.';
  ...
  String get providingSubtitle =>
      'చర్య అంశాలు మరియు స్వయంచాలకంగా సంగ్రహించిన నోట్‌లు.';
  ...
  String get backgroundActivityDesc =>
      'Omi ను మెరుగైన స్థిరత్వ కోసం నేపథ్యంలో నడవనివ్వండి';
  ...
  String get locationAccessDesc =>
      'పూర్ణ అనుభవం కోసం నేపథ్య స్థానాన్ని ప్రారంభించండి';
  ...
  String get notificationsDesc =>
      'సమాచారం పొందడానికి నోటిఫికేషన్‌లను ప్రారంభించండి';
  ...
  String get actionItemMarkedIncomplete =>
      'చర్య చర్య అసంపూర్ణంగా గుర్తించబడింది';
  ...
  String get deleteActionItemMessage =>
      'మీరు ఈ చర్య చర్యను తొలగించాలని నిర్ణయం చేసారా?';
  ...
  String get clearMemoryMessage =>
      'మీరు Omi యొక్క జ్ఞాపకాన్ని సరిచేయాలని నిర్ణయం చేసారా? ఈ చర్య చేయబడదు.';
  ...
  String get actionItemsCopiedToClipboard =>
      'కార్యాచరణ అంశాలు క్లిప్‌బోర్డ్‌కు కాపీ చేయబడ్డాయి';
  ...
  String get addToClaudeDesktopConfig =>
      'claude_desktop_config.json కు జోడించండి';
  ...
  String get autoCreateWhenNameDetected =>
      'పేరు కనుగొనబడినప్పుడు స్వయంచాలకంగా సృష్టించండి';
  ...
  String get actionItemDescriptionCannotBeEmpty =>
      'కార్యాచరణ అంశం వివరణ ఖాళీగా ఉండకూడదు';
  ...
  String get actionItemUpdatedSuccessfully =>
      'కార్యాచరణ అంశం విజయవంతంగా అపડేట్ చేయబడింది';

  @override
  String get actionItemCreatedSuccessfully =>
      'కార్యాచరణ అంశం విజయవంతంగా సృష్టించబడింది';

  @override
  String get actionItemDeletedSuccessfully =>
      'కార్యాచరణ అంశం విజయవంతంగా తొలగించబడింది';
  ...
  String get enterActionItemDescription =>
      'కార్యాచరణ అంశం వివరణ ప్రవేశించండి...';
  ...
  String get confirmReportMessage =>
      'ఈ సందేశాన్ని నివేదించాలని మీరు నిశ్చితమైనారా?';
  ...
  String get confirmClearChat =>
      'చాట్ క్లియర్ చేయాలని మీరు నిశ్చితమైనారా? ఈ చర్యను రద్దు చేయలేము.';
  ...
  String get deleteMemoryConfirmation =>
      'ఈ స్మృతిని తొలగించాలని మీరు నిశ్చితమైనారా? ఈ చర్యను రద్దు చేయలేము.';
  ...
  String get startRecordingToSeeTranscript =>
      'లైవ్ ట్రాన్‌స్‌క్రిప్ట్ చూడటానికి రికార్డింగ్ ప్రారంభించండి';
  ...
  String get signOutConfirmation =>
      'సైన్ అవుట్ చేయాలనుకుంటున్నారని మీరు నిశ్చితమైనారా?';
  ...
  String get unlockOmiInfiniteMemory =>
      'Omi యొక్క అనంత జ్ఞాపకం అన్‌లాక్ చేయండి';
  ...
  String get checkConnectionTryAgain =>
      'కనెక్షన్ తనిఖీ చేసి మళ్ళీ ప్రయత్నించండి';
  ...
  String get configureDailySummaryDigest =>
      'మీ నిత్య చర్య సమితులను సంగ్రహం చేయండి';
  ...
  String get checkingFirmwareVersion =>
      'ఫర్మ్‌వేర్ సంస్కరణను తనిఖీ చేస్తోంది...';
  ...
  String get deleteRecordingConfirmation =>
      'మీరు ఈ రికార్డింగ్‌ను శాశ్వతంగా తొలగించాలనుకుంటున్నారా? ఇది చేయలేము.';
  ...
  String get phoneCallsUpsellFeature2 =>
      'స్వయంచాలక కాల్ సారాంశాలు మరియు కార్య అంశాలు';
  ...
  String get transcriptionConnecting =>
      'ట్రాన్‌స్క్రిప్షన్ కనెక్ట్ చేస్తోంది...';
  ...
  String get deleteFlowConfirmSubtitle =>
      'మీరు ఖాతాను తొలగించిన తర్వాత, దాన్ని పునరుద్ధరించే మార్గం లేదు.';
  ...
  String get deleteOnDeviceModelConfirm =>
      'ఈ మోడల్‌ను తొలగించాలని మీరు ఖచ్చితంగా అనుకుంటున్నారా?';
  ...
  String get planSheetChooseYourPlan =>
      'అపరిమిత Omi అన్‌లాక్ చేయడానికి మీ ప్లాన్‌ను ఎంచుకోండి.';
