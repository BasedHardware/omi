...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get conversationPromptPlaceholder =>
      'あなたは素晴らしいアプリです。会話のトランスクリプトと要約が提供されます...';
  ...
  String get screenRecordingDescription =>
      'Omiは、ブラウザベースの会議からシステムオーディオをキャプチャするために画面録画権限が必要です。';
  ...
  String get clickTheButtonToCaptureAudio =>
      'ボタンをクリックして、ライブ文字起こし、AI インサイト、自動保存のためにオーディオをキャプチャします。';
  ...
  String get externalAppAccessDescription =>
      '以下のインストール済みアプリは外部連携があり、会話やメモリーなどのデータにアクセスできます。';
  ...
  String get premiumMinutesInfo =>
      '月間1,200分のプレミアム利用可能。オンデバイスタブでは無制限の無料文字起こしが可能です。';
  ...
  String get fastTransferMethodDescription =>
      'Omiデバイスへの直接WiFi接続を作成します。転送中、電話は通常のWiFiから一時的に切断されます。';
  ...
  String get personaConnectKnowledgeSource =>
      '少なくとも1つのデータソース（OmiまたはTwitter）を接続してください';
  ...
  String get omisStorageDesc =>
      'Omiがスマートフォンに接続されていない時、内蔵メモリにオーディオをローカル保存します。録音を失うことはありません。';
  ...
  @override
  String get transcriptionDegraded => '低下';
}
