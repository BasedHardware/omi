...
class AppLocalizationsJA extends AppLocalizations {
  ...
  @override
  String get aboutMinutesRemaining => '残り約{minutes}分';
  ...
  @override
  String get accessesAndTriggeredBy => '{accessDescription}、{triggerDescription}。';

  @override
  String get accessesDataTypes => '{dataTypes}にアクセス';
  ...
  String get accessibilityDescription =>
      'Omiは、ブラウザでZoom、Meet、またはTeamsの会議に参加したことを検出するためにアクセシビリティ権限が必要です。';
  ...
  @override
  String get actionItemDeletedResult => 'アクションアイテム「{description}」を削除しました';
  ...
  @override
  String get actionItemsSyncedTo => 'アクションアイテムは{appName}アカウントに同期されます';
  ...
  @override
  String get addAppErrorOpeningFilePicker => 'ファイル選択エラー: {message}';

  @override
  String get addAppErrorSelectingImage => '画像選択エラー: {error}';

  @override
  String get addAppErrorSelectingImageRetry => '画像選択エラー。もう一度お試しください。';

  @override
  String get addAppErrorSelectingThumbnail => 'サムネイル選択エラー: {error}';
  ...
  @override
  String get addedToService => '{serviceName}に追加しました';

  @override
  String get addingToService => '{serviceName}に追加中...';

  @override
  String get additionalSampleIndex => '追加サンプル {index}';
  ...
  @override
  String get aiGenErrorOccurredWithDetails => 'エラーが発生しました: {message}';
  ...
  @override
  String get alreadyExportedTo => '{platform}にエクスポート済み';
  ...
  String get apiKeysDescription =>
      'APIキーは、アプリがOMIサーバーと通信する際の認証に使用されます。アプリケーションがメモリを作成し、他のOMIサービスに安全にアクセスできるようにします。';
  ...
  @override
  String get appIntegration => '{appName}連携';
  ...
  @override
  String get appSettings => '{appName}設定';
  ...
  @override
  String get appsCount => 'アプリ ({count})';
  ...
  @override
  String get audioInputSetTo => 'オーディオ入力を{deviceName}に設定';

  @override
  String get audioProcessedLocally => '音声はローカルで処理されます。オフラインで動作し、よりプライベートですが、バッテリー消費が増えます。';

  @override
  String get authAccessMessage => 'Omiが{appName}のデータにアクセスすることを許可する必要があります。ブラウザで認証が開きます。';
  ...
  @override
  String get authorizeOmiForTasks => 'Omiが{appName}アカウントでタスクを作成することを許可する必要があります。ブラウザで認証が開きます。';
  ...
  @override
  String get autoClosingInSeconds => '{seconds}秒後に自動的に閉じます';
  ...
  @override
  String get availableSpace => '利用可能な容量: {space}';

  @override
  String get availableSpaceWithValue => '利用可能な容量: {space}';
  ...
  @override
  String get basicPlanDesc => 'プランには月{limit}分の無料枠が含まれています。無制限にするにはアップグレードしてください。';
  ...
  @override
  String get cancelAtPeriodEnd => 'プランは{date}にキャンセルされます。';
  ...
  @override
  String get captureRecordingError => '録音中にエラーが発生しました: {error}';

  @override
  String get captureRecordingStoppedDisplayIssue => '録画が停止しました: {reason}。外部ディスプレイを再接続するか、録画を再開する必要があるかもしれません。';
  ...
  @override
  String get charactersCount => '{count}文字';
  ...
  @override
  String get chatWithAppName => '{appName}とチャット';
  ...
  @override
  String get clearMemoryConfirmation => 'Omiのメモリをクリアしてもよろしいですか？この操作は元に戻せず、すべての{count}個のメモリが完全に削除されます。';
  ...
  String get commitmentText =>
      '私たちは収集したデータをOmiをより良い製品にするためだけに使用することを約束します。あなたのプライバシーと信頼は私たちにとって最も重要です。';
  ...
  @override
  String get connectTo => '{appName}に接続';

  @override
  String get connectToAppTitle => '{appName}に接続';

  @override
  String get connectToDeviceName => '{deviceName}に接続';

  @override
  String get connected => '接続済み';

  @override
  String get connectedAsUser => 'ユーザーとして接続: {userId}';
  ...
  @override
  String get connectedToApp => '{appName}に接続済み';

  @override
  String get connectingToDeviceName => '{deviceName}に接続中';
  ...
  @override
  String get contactsSelectedCount => '{count}件選択中';
  ...
  @override
  String get conversationEndAfterMinutes => '{minutes}分の無音後に会話が終了します';
  ...
  @override
  String get conversationPhotosCount => '{count}枚の写真';
  ...
  @override
  String get conversationSummarizedAfterMinutes => '会話は{minutes}分{suffix}の無音後に要約されます。';
  ...
  @override
  String get conversationsCreated => '{count}件の会話を作成しました';
  ...
  @override
  String get copiedToClipboard => '{title}をクリップボードにコピーしました';
  ...
  @override
  String get countRemaining => '{count} 残り';
  ...
  String get dataAccessNoticeDescription =>
      'このアプリはあなたのデータにアクセスします。Omi AIは、このアプリによるデータの使用、変更、削除について責任を負いません';

  @override
  String get dataAccessWarning =>
      'このアプリはあなたのデータにアクセスします。Omi AIは、このアプリによってデータがどのように使用、変更、または削除されるかについて責任を負いません';
  ...
  String get dataCollectionMessage =>
      '続行すると、あなたの会話、録音、個人情報は、AI駆動のインサイトを提供し、すべてのアプリ機能を有効にするために、当社のサーバーに安全に保存されます。';
  ...
  @override
  String get dataProtectedWithSettings => 'データは新しい{level}設定で保護されました。';
  ...
  @override
  String get deleteGraphFailed => 'グラフの削除に失敗しました: {error}';

  @override
  String get deleteImportedData => 'インポートしたデータを削除';

  @override
  String get deleteItemConfirmation => 'この{item}を削除してもよろしいですか？この操作は元に戻せません。';

  @override
  String get deleteItemQuestion => '{item}を削除しますか？';

  @override
  String get deleteItemTitle => '{item}を削除';
  ...
  @override
  String get deletePersonConfirmation => '{name}を削除してもよろしいですか？これにより、関連するすべての音声サンプルも削除されます。';
  ...
  @override
  String get deleteQuoted => '「{name}」を削除';
  ...
  @override
  String get deleteSampleConfirmation => '{name}のサンプルを削除してもよろしいですか？';
  ...
  @override
  String get deleteSelectedItemsMessage => '選択した {count} 件のアクションアイテムを削除してもよろしいですか？';
  ...
  @override
  String get deletedLimitlessConversations => '{count}件のLimitless会話を削除しました';
  ...
  @override
  String get deviceDisconnectedBody => '{deviceName}を引き続きご使用いただくには、再接続してください。';
  ...
  @override
  String get deviceDisconnectedTitle => '{deviceName}が切断されました';
  ...
  @override
  String get deviceUsesCodec => '{device}は{reason}を使用しています。Omiが使用されます。';

  @override
  String get devicesFoundNearby => '{count}台のデバイスが近くに見つかりました';
  ...
  @override
  String get disconnectAppMessage => '{appName}との接続を解除してもよろしいですか？いつでも再接続できます。';

  @override
  String get disconnectAppTitle => '{appName}を切断しますか？';

  @override
  String get disconnectDevice => 'デバイスの切断';

  @override
  String get disconnectFromApp => '{appName}から切断しますか？';

  @override
  String get disconnectFromAppDesc => '{appName}の認証が削除されます。再利用するには再接続が必要です。';
  ...
  @override
  String get disconnectedFrom => '{appName}から切断しました';
  ...
  @override
  String get downloadError => 'ダウンロードエラー: {error}';

  @override
  String get downloadErrorWithMessage => 'ダウンロードエラー: {error}';

  @override
  String get downloadModel => 'モデルをダウンロード';

  @override
  String get downloadModelWithName => 'モデルをダウンロード ({model})';
  ...
  @override
  String get downloadingModelProgress => '{model}をダウンロード中: {received} / {total} MB';
  ...
  @override
  String get durationSeconds => '長さ: {seconds} 秒';
  ...
  @override
  String get enableDeviceWifi => '{deviceName}のWiFiを有効化';
  ...
  @override
  String get endsOnDate => '{date}に終了';
  ...
  @override
  String get errorCheckingConnection => '接続確認エラー: {error}';

  @override
  String get errorConnectingAppleWatch => 'Apple Watchへの接続エラー: {error}';
  ...
  @override
  String get errorInstallingApp => '{appName}のインストール中にエラーが発生: {error}';

  @override
  String get errorLabel => 'エラー: {error}';

  @override
  String get errorProcessingConversation => '会話の処理中にエラーが発生しました。後でもう一度お試しください。';

  @override
  String get errorRequestingPermission => '許可のリクエスト中にエラーが発生しました：{error}';

  @override
  String get errorSaving => '保存エラー: {error}';

  @override
  String get errorStartingRecording => '録音の開始中にエラーが発生しました：{error}';

  @override
  String get errorSwitchingAudioDevice => 'オーディオデバイスの切り替えエラー: {error}';
  ...
  @override
  String get errorWithMessage => 'エラー: {error}';

  @override
  String get estimatedHours => '約{count}時間';

  @override
  String get estimatedMinutes => '約{count}分';

  @override
  String get estimatedSize => '推定サイズ: 約{size} MB';

  @override
  String get estimatedSizeLabel => '推定サイズ';

  @override
  String get estimatedSizeWithValue => '推定サイズ: 約{size} MB';

  @override
  String get estimatedTimeRemaining => '推定残り時間: {time}';

  @override
  String get etaLabel => '予想時間: {time}';
  ...
  @override
  String get failedToAddToService => '{serviceName}への追加に失敗しました';
  ...
  @override
  String get failedToCheckMicrophonePermission => 'マイクの許可確認に失敗しました: {error}';
  ...
  @override
  String get failedToConnectServiceWithError => '{serviceName}への接続に失敗しました: {error}';
  ...
  @override
  String get failedToCreateApiKey => 'プロバイダーAPIキーの作成に失敗しました: {error}';
  ...
  @override
  String get failedToCreateKeyWithError => 'キーの作成に失敗しました: {error}';
  ...
  @override
  String get failedToDeleteError => '削除に失敗しました: {error}';

  @override
  String get failedToDeleteFolder => 'フォルダの削除に失敗しました';

  @override
  String get failedToDeleteGraph => 'グラフの削除に失敗しました：{error}';
  ...
  @override
  String get failedToInstallApp => '{appName}のインストールに失敗しました。もう一度お試しください。';

  @override
  String get failedToLoadContacts => '連絡先の読み込みに失敗しました';

  @override
  String get failedToLoadRepos => 'リポジトリの読み込みに失敗しました: {error}';
  ...
  @override
  String get failedToRevokeApiKey => 'APIキーの取り消しに失敗しました: {error}';
  ...
  @override
  String get failedToSendReply => '返信の送信に失敗しました: {error}';

  @override
  String get failedToSetLanguage => '言語の設定に失敗しました';

  @override
  String get failedToStartAppAuth => '{appName}の認証開始に失敗しました';

  @override
  String get failedToStartAuth => '{appName}の認証開始に失敗しました';
  ...
  @override
  String get failedToStartUpdate => '更新の開始に失敗しました: {error}';
  ...
  @override
  String get failedToUpdateSettings => '設定の更新に失敗しました: {error}';
  ...
  String get fastTransferDescription =>
      '高速転送はWiFiを使用して約5倍の速度を実現します。転送中、電話は一時的にOmiデバイスのWiFiネットワークに接続されます。';
  ...
  @override
  String get firmwareUpdateAvailableDescription => 'Omiデバイスの新しいファームウェアアップデート（{version}）が利用可能です。今すぐアップデートしますか？';
  ...
  @override
  String get generatedBy => '{appName}によって生成';
  ...
  @override
  String get heresWhatWeDiscussed => '先ほど話した内容はこちらです: {link}';
  ...
  String get howPeopleWorks =>
      '人物を作成したら、会話のトランスクリプトに移動して対応するセグメントを割り当てることで、Omiがその人の音声も認識できるようになります！';
  ...
  @override
  String get importErrorGeneric => 'エラー: {error}';

  @override
  String get importErrorOpeningFilePicker => 'ファイルピッカーを開く際にエラーが発生しました: {message}';
  ...
  @override
  String get importedConfig => '{providerName}設定をインポートしました';
  ...
  @override
  String get insightsUsedThisMonth => '今月 {limit}個中{used}個のインサイト取得済み';
  ...
  @override
  String get integrationComingSoon => '{appName}との連携は近日公開予定です！より多くのタスク管理オプションを提供するため取り組んでいます。';
  ...
  @override
  String get invalidJson => '無効なJSON: {error}';
  ...
  @override
  String get isTriggeredBy => '{triggerDescription}。';
  ...
  @override
  String get itemCopiedToClipboard => '{item}がクリップボードにコピーされました';

  @override
  String get itemPersona => 'ペルソナ';

  @override
  String get itemsDeletedResult => '{count} 件のアクションアイテムを削除しました';

  @override
  String get itemsSelected => '{count} 件選択中';
  ...
  @override
  String get keepItemPublic => '{item}を公開のままにする';
  ...
  @override
  String get labelCopied => '{label}をコピーしました';
  ...
  @override
  String get languageSetTo => '言語を{language}に設定しました';
  ...
  String get largeModelWarning =>
      'このモデルは大きいため、アプリがクラッシュしたり、モバイルデバイスで非常に遅く動作する可能性があります。\n\n「small」または「base」をお勧めします。';

  @override
  String get largeTimeGapDetected => '大きな時間差が検出されました ({gap})';

  @override
  String get largeTimeGapsDetected => '大きな時間差が検出されました ({gaps})';
  ...
  @override
  String get loadMoreRemaining => 'さらに読み込む（残り{count}件）';
  ...
  @override
  String get makeItemPrivateExplanation => '{item}を非公開にすると、すべての人に対して機能しなくなり、あなただけに表示されます';

  @override
  String get makeItemPrivateQuestion => '{item}を非公開にしますか？';

  @override
  String get makeItemPublicExplanation => '{item}を公開すると、誰でも使用できるようになります';

  @override
  String get makeItemPublicQuestion => '{item}を公開しますか？';
  ...
  @override
  String get maximumGoalsAllowed => '最大{count}個の目標が許可されています';
  ...
  @override
  String get memoriesCount => '{count}個の思い出';

  @override
  String get memoriesUsedThisMonth => '今月 {limit}個中{used}個の記憶作成済み';
  ...
  @override
  String get mergeConversationsMessage => '{count}件の会話が1つにまとめられます。すべてのコンテンツがマージされ、再生成されます。';

  @override
  String get mergeConversationsSuccessBody => '{count}件の会話が正常にマージされました';
  ...
  @override
  String get microphoneChangedResumingIn => 'マイクが変更されました。{countdown}秒後に再開';
  ...
  @override
  String get migratingFromTo => '{source} から {target} に移行中';

  @override
  String get migratingItemsProgress => '{itemType}を移行中... {percentage}%';

  @override
  String get migratingToProtection => '{level}保護に移行中...';
  ...
  @override
  String get minLabel => '{count}分';

  @override
  String get minsUsedThisMonth => '今月 {limit}分中{used}分使用済み';
  ...
  @override
  String get modelNameWithFile => 'モデル: {model}';
  ...
  @override
  String get modelReadyWithName => 'モデル準備完了 ({model})';
  ...
  @override
  String get monthsAgo => '{count}ヶ月前';

  @override
  String get moveConversationsTo => '{count}件の会話を移動:';

  @override
  String get moveToFolder => 'フォルダに移動';

  @override
  String get msgCameraAccessError => 'カメラへのアクセスエラー: {error}';
  ...
  @override
  String get msgFilePickerError => 'ファイルピッカーを開くエラー: {error}';
  ...
  @override
  String get msgSelectFilesError => 'ファイルの選択エラー: {error}';

  @override
  String get msgSelectFilesGenericError => 'ファイルの選択エラー。もう一度お試しください。';

  @override
  String get msgSelectImagesError => '画像の選択エラー: {error}';
  ...
  @override
  String get nConversations => '{count}件の会話';
  ...
  @override
  String get noConversationsOnDate => '{date}の会話はありません';
  ...
  @override
  String get objectsCount => '{processed} / {total} オブジェクト';
  ...
  @override
  String get onboardingAccessibilityStatusCheckPrefs => 'アクセシビリティ権限の状態：{status}。システム環境設定を確認してください。';
  ...
  @override
  String get onboardingBluetoothStatusCheckPrefs => 'Bluetooth権限の状態：{status}。システム環境設定を確認してください。';
  ...
  @override
  String get onboardingFailedCheckAccessibility => 'アクセシビリティ権限の確認に失敗しました：{error}';

  @override
  String get onboardingFailedCheckBluetooth => 'Bluetooth権限の確認に失敗しました：{error}';

  @override
  String get onboardingFailedCheckMicrophone => 'マイク権限の確認に失敗しました：{error}';

  @override
  String get onboardingFailedCheckNotification => '通知権限の確認に失敗しました：{error}';

  @override
  String get onboardingFailedCheckScreenCapture => '画面キャプチャ権限の確認に失敗しました：{error}';
  ...
  @override
  String get onboardingMicrophoneStatusCheckPrefs => 'マイク権限の状態：{status}。システム環境設定を確認してください。';
  ...
  @override
  String get onboardingNotificationStatusCheckPrefs => '通知権限の状態：{status}。システム環境設定を確認してください。';
  ...
  @override
  String get onboardingScreenCaptureStatusCheckPrefs => '画面キャプチャ権限の状態：{status}。システム環境設定を確認してください。';
  ...
  @override
  String get openingApp => '{appName}を開いています...';
  ...
  @override
  String get pdfTitleLabel => 'タイトル: {title}';
  ...
  @override
  String get personaErrorEnablingWithError => 'ペルソナの有効化エラー: {error}';
  ...
  @override
  String get personaFailedToCreateWithError => 'ペルソナの作成に失敗: {error}';
  ...
  @override
  String get planEndedOn => 'プランは{date}に終了しました。\\n今すぐ再登録 - 新しい請求期間の料金が即座に請求されます。';

  @override
  String get planRemainsActiveUntil => 'プランは{date}まで有効です。その後、無制限の機能へのアクセスを失います。よろしいですか？';

  @override
  String get planRenewsOn => 'プランは{date}に更新されます。';

  @override
  String get planSetToCancelOn => 'プランは{date}にキャンセル予定です。\\n特典を維持するために今すぐ再登録 - {date}まで請求はありません。';

  @override
  String get planSwitchingDescriptionWithTitle => '無制限プランを{title}に変更します。続行してもよろしいですか？';
  ...
  @override
  String get pleaseAuthenticateWithService => '設定 > タスク連携で{serviceName}の認証を行ってください';
  ...
  @override
  String get premiumMinsLeft => '残りプレミアム{count}分。';
  ...
  @override
  String get preparingModel => '{model}を準備中...';
  ...
  String get privacyIntroText =>
      'Omiでは、お客様のプライバシーを非常に重要視しています。収集するデータとその使用方法について透明性を保ちたいと考えています。以下が知っておくべきことです：';
  ...
  @override
  String get privateAppsCount => 'プライベートアプリ ({count})';
  ...
  @override
  String get processingProgress => '処理中 {current}/{total}';
  ...
  @override
  String get publicAppsCount => '公開アプリ ({count})';
  ...
  @override
  String get ratingsCount => '{count}+の評価';
  ...
  @override
  String get renewsOn => 'プランは{date}に更新されます。';
  ...
  @override
  String get restartDeviceToComplete => 'アップデートを完了するには、{deviceName}を再起動してください。';
  ...
  @override
  String get resumingInCountdown => '{countdown}秒後に再開...';
  ...
  @override
  String get revokeKeyConfirmation => 'キー「{keyName}」を取り消してもよろしいですか？この操作は元に戻せません。';

  @override
  String get revokeKeyQuestion => 'キーを取り消しますか？';

  @override
  String get sampleNumber => 'サンプル {number}';
  ...
  @override
  String get sdCardProcessingMessage => '{count}件の録音を処理中です。処理後、ファイルはSDカードから削除されます。';
  ...
  @override
  String get secondsCount => '{count}秒';
  ...
  @override
  String get segmentsCount => '{count}セグメント';

  @override
  String get segmentsPlural => '{count}セグメント';

  @override
  String get segmentsSingular => '{count}セグメント';
  ...
  @override
  String get serviceIntegrationComingSoon => '{serviceName}連携は近日公開予定';
  ...
  @override
  String get setAsDefaultSuccess => '{appName}がデフォルトの要約アプリとして設定されました';

  @override
  String get setAsDefaultSummarizationApp => '{appName}をデフォルトの要約アプリとして設定しました';
  ...
  @override
  String get shareStatsInsights => '✨ {count}個のインサイトを提供しました';

  @override
  String get shareStatsListened => '🎧 {minutes}分間リスニングしました';

  @override
  String get shareStatsMemories => '📚 {count}個の記憶を保存しました';

  @override
  String get shareStatsMessage => 'Omiの統計をシェア！(omi.me - 常時ONのAIアシスタント)';

  @override
  String get shareStatsWords => '🧠 {words}語を理解しました';

  @override
  String get shareViaSms => 'SMSで共有';

  @override
  String get shareWithContactCount => '{count}件の連絡先と共有';

  @override
  String get shareWithContactsCount => '{count}件の連絡先と共有';
  ...
  @override
  String get speakerWithId => '話者{speakerId}';
  ...
  @override
  String get starFilter => '{count}つ星';

  @override
  String get starFilterLabel => '{count}つ星';
  ...
  @override
  String get storedOnDevice => '{deviceName}に保存';
  ...
  @override
  String get summaryGeneratedFor => '{date}のサマリーを生成しました';

  @override
  String get summaryGeneratedForDate => '{date}の要約を生成しました';
  ...
  @override
  String get tagOtherSegmentsFromSpeaker => 'この話者の他のセグメントにタグ付け ({selected}/{total})';

  @override
  String get tagSpeaker => '話者 {speakerId} にタグ付け';
  ...
  String get thankYouText =>
      'Omiの大切なユーザーであることに感謝します。ご質問やご不明な点がございましたら、team@basedhardware.comまでお気軽にお問い合わせください。';
  ...
  @override
  String get timeCompactHours => '{count}時';

  @override
  String get timeCompactHoursAndMins => '{hours}時{mins}分';

  @override
  String get timeCompactMins => '{count}分';

  @override
  String get timeCompactMinsAndSecs => '{mins}分{secs}秒';

  @override
  String get timeCompactSecs => '{count}秒';

  @override
  String get timeDaySingular => '{count}日';

  @override
  String get timeDaysAndHours => '{days}日{hours}時間';

  @override
  String get timeDaysPlural => '{count}日';

  @override
  String get timeHourSingular => '{count}時間';

  @override
  String get timeHoursAndMins => '{hours}時間{mins}分';

  @override
  String get timeHoursPlural => '{count}時間';

  @override
  String get timeMinSingular => '{count}分';

  @override
  String get timeMinsAndSecs => '{mins}分{secs}秒';

  @override
  String get timeMinsPlural => '{count}分';

  @override
  String get timePM => '午後';

  @override
  String get timeSecsPlural => '{count}秒';

  @override
  String get timeSecsSingular => '{count}秒';
  ...
  @override
  String get todayAtTime => '今日 {time}';
  ...
  @override
  String get totalMemoriesCount => '合計 {count} 件のメモリがあります';
  ...
  @override
  String get transferFailedMessage => '転送に失敗しました: {error}';
  ...
  @override
  String get triggeredByType => '{triggerType}でトリガー';
  ...
  @override
  String get updatedDate => '{date}に更新';
  ...
  @override
  String get usageLimitMessage => '{limit}分中{used}分使用済み';
  ...
  @override
  String get welcomeBack => 'おかえりなさい、{name}';
  ...
  String get wifiSyncUsesHotspot =>
      'WiFi同期はスマートフォンをホットスポットとして使用します。設定 > インターネット共有で名前とパスワードを確認してください。';
  ...
  @override
  String get wordsUsedThisMonth => '今月 {limit}語中{used}語使用済み';
  ...
  @override
  String get wrappedCompletionRate => '{rate}%の完了率';
  ...
  @override
  String get wrappedTopPercentUser => '上位{percentile}%ユーザー';
  ...
  @override
  String get yesterdayAtTime => '昨日 {time}';
