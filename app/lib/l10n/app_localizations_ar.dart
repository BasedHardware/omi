...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get enableE2ee => 'تفعيل E2EE';
  ...
  String get saveKeyMessage =>
      'احفظ هذا المفتاح في مكان آمن. ستحتاجه لاستعادة ذكرياتك المشفرة إذا غيّرت جهازك. بدون هذا المفتاح، لا يمكن استعادة البيانات المشفرة.';

  @override
  String get savedMyKey => 'لقد حفظت مفتاحي';

  @override
  String get showRecoveryKey => 'عرض مفتاح الاسترداد';

  @override
  String get e2eeKeyWarning => '⚠️ إذا فقدت مفتاح الاسترداد، لا يمكن استعادة بياناتك.';

  @override
  String get e2eeBackupReminder => 'تأكد من عمل نسخة احتياطية لمفتاحك بعد التفعيل.';

  @override
  String e2eeFailedToEnable(String error) {
    return 'فشل تفعيل E2EE: $error';
  }
  ...
  @override
  String get e2eeMemoriesDescription => 'مشفرة على جهازك قبل الوصول إلى الخادم. أنت فقط من يمكنه قراءتها.';

  @override
  String get e2eeOtherDataDescription =>
      'مشفرة في حالة السكون على الخادم. يعالج الخادم الصوت للنسخ لكن البيانات المخزنة مشفرة.';

  @override
  String get e2eeCardSubtitle => 'حماية قصوى — الذكريات مشفرة على الجهاز، جميع البيانات الأخرى مشفرة في حالة السكون';

  @override
  String get e2eeUnableToDecrypt => 'مشفر — تعذر فك التشفير. تحقق من مفتاح الاسترداد.';

  @override
  String get pairWithWeb => 'الاقتران مع الويب';

  @override
  String get scanQrOnWeb => 'امسح رمز QR هذا على omi.me لفتح بياناتك المشفرة';
  ...
  @override
  String get onlyTrustedDevice => '⚠️ امسح فقط على جهاز موثوق';

  @override
  String get e2eeEnableDialogIntro => 'يوفر التشفير من طرف إلى طرف أعلى مستوى من حماية البيانات:\n\n';

  @override
  String get e2eeMemoriesLabel => '🔒 الذكريات: ';

  @override
  String get e2eeOtherDataLabel => '🔐 المحادثات والدردشة والبيانات الأخرى: ';

  @override
  String get switchToSecureEncryption => 'التبديل إلى التشفير الآمن؟';

  @override
  String get switchToSecureEncryptionBody =>
      'سيؤدي هذا إلى إعادة تشفير بياناتك بمفاتيح يديرها الخادم. لن يتم استخدام مفتاح التشفير من طرف إلى طرف الخاص بك بعد الآن.\n\nستظل بياناتك مشفرة أثناء التخزين، لكن الخادم سيدير المفاتيح.';
  ...
  String get thirdPartyAppsWarning =>
      'لن تتمكن تطبيقات وتكاملات الجهات الخارجية من الوصول إلى بياناتك المشفرة إلا إذا زودتها بمفتاحك.';

  @override
  String get preparingMigration => 'جارٍ تحضير الترحيل...';

  @override
  String get e2eeKeyRecoveryTitle => 'مطلوب مفتاح الاسترداد';

  @override
  String get e2eeKeyRecoveryBody =>
      'مفتاح تشفير E2EE الخاص بك مفقود. الصق مفتاح الاسترداد لاستعادة الوصول إلى بياناتك المشفرة.';

  @override
  String get e2eeKeyRecoveryHint => 'الصق مفتاح الاسترداد';

  @override
  String get e2eeKeyRecoveryButton => 'استرداد';

  @override
  String get e2eeKeyRecoverySuccess => 'تم استرداد المفتاح بنجاح';

  @override
  String get e2eeKeyRecoveryWrongKey => 'مفتاح غير صحيح — لا يطابق المفتاح المستخدم لتشفير بياناتك';

  @override
  String get e2eeKeyRecoveryLostKey => 'لقد فقدت مفتاح الاسترداد الخاص بي';

  @override
  String get e2eeKeyRecoveryLostKeyBody =>
      'بدون مفتاح الاسترداد، ستحتاج إلى تعطيل E2EE من جهاز آخر سجلت الدخول عليه، أو التواصل مع الدعم لإعادة ضبط التشفير.';
