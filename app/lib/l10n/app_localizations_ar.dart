...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get transcriptionUnavailableSavingOnDevice =>
      'النسخ غير متوفر · يتم الحفظ على الجهاز';
  ...
  String get renameDeviceDescription =>
      'يُحفظ الاسم على جهاز Omi نفسه، لذا يظهر على أي هاتف تقرنه به.';
  ...
  String get deviceRenameFailed =>
      'تعذّر حفظ الاسم على جهاز Omi. تأكد من أنه متصل وحاول مرة أخرى.';
