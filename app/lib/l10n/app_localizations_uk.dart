...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get consentDataMessage => 'Продовжуючи, всі дані, якими ви ділитесь з цим додатком (включаючи ваші розмови, записи та особисту інформацію), будуть надійно зберігатися на наших серверах, щоб надавати вам аналітику на основі ШІ та увімкнути всі функції додатку.';
  ...
  @override
  String get disconnectTwitterConfirmation => 'Ви впевнені, що хочете від\'єднати свій обліковий запис Twitter? Ваша персона більше не матиме доступу до ваших даних Twitter.';
  ...
  @override
  String get xHandleDescription => 'Ми попередньо навчимо вашого клона Omi\nна основі активності вашого облікового запису';
