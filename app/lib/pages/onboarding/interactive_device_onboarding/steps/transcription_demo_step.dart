...
class _TranscriptionDemoStepState extends State<TranscriptionDemoStep> with SingleTickerProviderStateMixin {
  ...
  Widget _buildSuccessCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: OmiColors.success.withValues(alpha: 0.12),
        borderRadius: BorderRadius.circular(20),
      ),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.check_circle, color: OmiColors.success, size: 24),
          const SizedBox(width: 12),
          Text(
            context.l10n.deviceOnboardingGoodJob,
            style: TextStyle(color: OmiColors.success, fontSize: 20, fontWeight: FontWeight.w600),
          ),
        ],
      ),
    );
  ...
  Widget _buildTranscriptCard(DeviceOnboardingProvider provider) {
    ...
    return Container(
      ...
      decoration:
          BoxDecoration(color: OmiColors.textPrimary.withValues(alpha: 0.08), borderRadius: BorderRadius.circular(20)),
      child: Text(
        text,
