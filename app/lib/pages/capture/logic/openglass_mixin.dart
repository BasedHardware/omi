...
mixin OpenGlassMixin {
  ...
  Future<void> refreshOpenGlassCamera(String deviceId) async {
    debugPrint('🔄 Refreshing OpenGlass camera to capture fresh images...');
    ...
    if (connection != null) {
      try {
        ...
        debugPrint('🔄 Sent immediate capture command to OpenGlass');
      } catch (e) {
  ...
  Future<void> openGlassProcessing(
        ...
        if (completedImage.isNotEmpty) {
          ...
          getPhotoDescription(completedImage).then((description) {
            ...
            onPhotosUpdated(photos);
              debugPrint('📝 Updated photo description: ${description.substring(0, min(50, description.length))}...');
    ...
    debugPrint('✅ OpenGlass camera stream initialized');
  }
