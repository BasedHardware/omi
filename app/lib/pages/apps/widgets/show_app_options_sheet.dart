                      ...
                      if (value) {
                        showDialog(
                          ...
                          builder: (c) => getDialog(
                            ...
                            context.l10n.makeItemPublicQuestion(
                              app.isNotPersona() ? context.l10n.itemApp : context.l10n.itemPersona,
                            ),
                            context.l10n.makeItemPublicExplanation(
                              app.isNotPersona()
                                  ? context.l10n.itemApp.toLowerCase()
                                  : context.l10n.itemPersona.toLowerCase(),
                            ),
                        ...
                        showDialog(
                          ...
                          builder: (c) => getDialog(
                            ...
                            context.l10n.makeItemPrivateQuestion(
                              app.isNotPersona() ? context.l10n.itemApp : context.l10n.itemPersona,
                            ),
                            context.l10n.makeItemPrivateExplanation(
                              app.isNotPersona()
                                  ? context.l10n.itemApp.toLowerCase()
                                  : context.l10n.itemPersona.toLowerCase(),
                            ),
                      ...
                      onTap: () {
                        showDialog(
                          ...
                          builder: (c) => getDialog(
                            ...
                            context.l10n.deleteItemQuestion(
                              app.isNotPersona() ? context.l10n.itemApp : context.l10n.itemPersona,
                            ),
                            context.l10n.deleteItemConfirmation(
                              app.isNotPersona() ? context.l10n.itemApp : context.l10n.itemPersona,
                            ),
                            okButtonText: context.l10n.confirm,
                          ),
