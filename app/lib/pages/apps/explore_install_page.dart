                                              ...
                                              child: IconButton(
                                                onPressed: () {
                                                  ...
                                                  final visibleFilters = state.filters.entries.where((entry) {
                                                    if (entry.key == 'Apps') {
                                                      return entry.value != 'My Apps' &&
                                                          entry.value != 'Installed Apps';
                                                    }
                                                    return true;
                                                  }).toList();
                                          ...
                                          child: AnimatedContainer(
                                            ...
                                            child: TextButton.icon(
                                              onPressed: () {
                                                ...
                                                provider.addOrRemoveFilter('My Apps', 'Apps');
                                                provider.applyFilters();
                                                AnalyticsManager().appsTypeFilter('My Apps', !wasSelected);
                                              },
                                              icon: const FaIcon(
                                          ...
                                          child: AnimatedContainer(
                                            ...
                                            child: TextButton.icon(
                                              onPressed: () {
                                                ...
                                                provider.addOrRemoveFilter('Installed Apps', 'Apps');
                                                provider.applyFilters();
                                                AnalyticsManager().appsTypeFilter('Installed Apps', !wasSelected);
                                              },
                                              icon: const FaIcon(
