...
class CloneSuccessScreen extends StatefulWidget {
  ...
  const CloneSuccessScreen({super.key, required this.message, this.routing = PersonaProfileRouting.no_device});
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              const Icon(Icons.verified, color: Color(0xFF0073FF), size: 20),
                            ],
                          ),
                        ],
                      ),
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              ...
                              shape: RoundedRectangleBorder(
                                ...
                                side: BorderSide(color: context.appColors.textPrimary.withOpacity(0.12), width: 4),
                              ),
                            ),
                            child: const Text(
                              'Start chatting!',
