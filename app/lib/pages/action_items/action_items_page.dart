    ...
    return DragTarget<ActionItemWithMetadata>(
      ...
      builder: (context, candidateData, rejectedData) {
        ...
        return AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: Colors.white.withValues(alpha: goal == null ? 0.04 : 0.08),
            borderRadius: BorderRadius.circular(12),
            border: Border.all(
              color: isHovering ? Colors.white.withValues(alpha: 0.5) : Colors.white.withValues(alpha: 0.08),
              width: 1,
            ),
          ),
          child: Center(
            child: Text(
              ...
              maxLines: 3,
              style: TextStyle(
                color: goal == null ? Colors.white.withValues(alpha: 0.2) : Colors.white.withValues(alpha: 0.9),
                fontSize: 12,
