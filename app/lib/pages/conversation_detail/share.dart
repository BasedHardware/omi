...
void _copyTranscript(BuildContext context, ServerConversation memory) {
...
void _copySummary(BuildContext context, ServerConversation memory) {
...
void _exportPDF(ServerConversation memory, bool isTranscript) async {
...
void _exportTranscriptTxt(ServerConversation memory) async {
  final directory = await getApplicationDocumentsDirectory();
...
void _exportSummaryTxt(ServerConversation memory) async {
  final directory = await getApplicationDocumentsDirectory();
...
void _exportSummaryMarkdown(ServerConversation memory) async {
  final directory = await getApplicationDocumentsDirectory();
                      ...
                      children: [
                        _buildListTile(
                          ...
                          onTap: () async {
                            ...
                            bool shared = await setConversationVisibility(memory.id);
                            if (!shared) {
                              ScaffoldMessenger.of(context).showSnackBar(
