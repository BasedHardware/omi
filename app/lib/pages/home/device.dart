  ...
  Widget build(BuildContext context) {
    return Consumer<DeviceProvider>(builder: (context, provider, child) {
      return Scaffold(
        ...
        appBar: AppBar(
          title: Text(provider.connectedDevice != null ? 'Connected Device' : 'Connect Device'),
          backgroundColor: Theme.of(context).colorScheme.primary,
          actions: [
        ...
        body: RefreshIndicator(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                // Current connected device section (if any)
                if (provider.connectedDevice != null) ...[
                ...
                // Only show device discovery if no device is connected
                if (provider.connectedDevice == null) ...[
                  // Use the original FindDevicesPage for device discovery
                  FindDevicesPage(
