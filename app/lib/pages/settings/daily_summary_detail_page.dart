                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [BoxShadow(color: Colors.deepPurple.withValues(alpha: 0.4), blurRadius: 6, spreadRadius: 1)],
                    ),
                  ),
                  // Bottom line (hidden for last item)
                  Expanded(
                    child: Container(width: 2, color: isLast ? Colors.transparent : Colors.deepPurple.withValues(alpha: 0.4)),
                  ),
                ],
              ),
            ),
