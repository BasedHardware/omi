...
class CreateDevApiKeyDialog extends StatefulWidget {
  const CreateDevApiKeyDialog({super.key});

  @override
  State<CreateDevApiKeyDialog> createState() => _CreateDevApiKeyDialogState();
}

class _CreateDevApiKeyDialogState extends State<CreateDevApiKeyDialog> {
      ...
      if (mounted) {
        ...
        if (newKey != null) {
          showDialog(
            ...
            builder: (context) => DevApiKeyCreatedDialog(apiKey: newKey),
          );
        } else {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: const Text('Create New Developer Key'),
      content: Form(
        key: _formKey,
        child: TextFormField(
