...
import 'package:friend_private/pages/apps/app_detail/widgets/info_card_widget.dart';
...
class AppDetailTester extends StatefulWidget {
  final App app;

  const AppDetailTester({super.key, required this.app});

  @override
  State<AppDetailTester> createState() => _AppDetailTesterState();
}

class _AppDetailTesterState extends State<AppDetailTester> {
        ...
        child: Column(
          ...
          children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: const Text('App is under review', style: TextStyle(color: Colors.grey)),
                          ),
                        ],
                      ),
                    ],
            ...
            !hasAuthSteps && hasSetupInstructions
                ...
                : const SizedBox.shrink(),
            widget.app.worksExternally()
                ? Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('External Integration Details:',
                            style: TextStyle(color: Colors.white, fontSize: 18)),
                        const SizedBox(height: 16),
                        Text("Triggers On: ${widget.app.externalIntegration!.triggersOn}"),
                        const SizedBox(height: 8),
                        Text("Webhook Url: ${widget.app.externalIntegration!.webhookUrl}")
                      ],
                    ),
                  )
                : const SizedBox.shrink(),
            InfoCardWidget(
              ...
              showChips: true,
              chips: widget.app.capabilities.toList(),
            ),
