...
void _copySummary(BuildContext context, ServerMemory memory) {
  ...
  ScaffoldMessenger.of(context).showSnackBar(
     SnackBar(content: Text(TranslationService.translate( 'Summary copied to clipboard'))),
  );
}

String header = TranslationService.translate( "GENERATED BY FRIEND, omi.me\n\n");
    ...
    pdf.addPage(
      pw.Page(
        build: (pw.Context context) => pw.Column(
          ...
          children: [
            pw.Text(TranslationService.translate( 'Transcript Export'), style: const pw.TextStyle(fontSize: 20)),
    ...
    pdf.addPage(
      pw.Page(
        build: (pw.Context context) => pw.Column(
          crossAxisAlignment: pw.CrossAxisAlignment.start,
          children: [
            pw.Text(TranslationService.translate( 'Memory Export'), style: const pw.TextStyle(fontSize: 24)),
            pw.SizedBox(height: 12),
            pw.Text(TranslationService.translate( 'Title: ${structured.title}'), style: const pw.TextStyle(fontSize: 18)),
            pw.SizedBox(height: 12),
            pw.Text(TranslationService.translate( 'Overview'), style: const pw.TextStyle(fontSize: 18)),
            pw.Text(structured.overview),
            pw.SizedBox(height: 12),
            pw.Text(TranslationService.translate( 'Action Items'), style: const pw.TextStyle(fontSize: 18)),
            ...structured.actionItems.map((e) => pw.Text('- ${e.description}')),
            pw.SizedBox(height: 12),
            pw.Text(TranslationService.translate( 'Summary'), style: const pw.TextStyle(fontSize: 18)),
            pw.Text(structured.overview),
          ],
        ),
      ),
                ...
                if (currentView == BottomSheetView.share) ...[
                  ...
                  Card(
                    ...
                    child: Column(
                      children: [
                        _buildListTile(
                          context,
                          title: TranslationService.translate( 'Copy URL'),
                          icon: Icons.link,
                          onTap: () async {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                               SnackBar(content: Text(TranslationService.translate( 'URL Copied to Clipboard'))),
                            );
                            Navigator.pop(ctx);
                            HapticFeedback.lightImpact();
                          },
                  ...
                  Card(
                    ...
                    child: Column(
                      children: [
                        _buildListTile(
                          context,
                          title: TranslationService.translate( 'Copy Transcript'),
                          icon: Icons.copy,
                        ...
                        memory.discarded
                            ...
                            : _buildListTile(
                                context,
                                title:TranslationService.translate(  'Copy Summary'),
                  ...
                  Card(
                    ...
                    child: Column(
                      children: [
                        _buildListTile(
                          context,
                          title: TranslationService.translate( 'Export Transcript'),
                        ...
                        memory.discarded
                            ...
                            : _buildListTile(
                                context,
                                title: TranslationService.translate( 'Export Summary'),
                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(TranslationService.translate( 'Export Transcript'), style: Theme.of(context).textTheme.labelLarge),
                      ),
                      IconButton(
                        icon: const Icon(Icons.cancel_outlined),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(TranslationService.translate( 'Export'), style: Theme.of(context).textTheme.bodyLarge),
                    ),
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 8.0),
                        child: Text(TranslationService.translate( 'Export Summary'), style: Theme.of(context).textTheme.labelLarge),
                      ),
                      IconButton(
                        icon: const Icon(Icons.cancel_outlined),
                        onPressed: () => updateView(BottomSheetView.share),
