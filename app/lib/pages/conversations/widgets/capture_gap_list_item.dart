  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Text(
        ...
        style: TextStyle(color: OmiColors.textSecondary, fontSize: 13, fontWeight: FontWeight.w600),
      ),
    );
  }
}
          ...
          child: Row(
            children: [
              Container(
                width: 40,
                height: 40,
                decoration: BoxDecoration(color: OmiColors.surface4, borderRadius: BorderRadius.circular(12)),
