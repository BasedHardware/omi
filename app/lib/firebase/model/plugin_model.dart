...
Future<void> updateCommunityPluginsData() async {
  ...
  List<PluginModel> pluginsTemp = pluginsTempJson.map((json) => PluginModel.fromJson(json)).toList();
  for (int i = 0; i < pluginsTemp.length; i++) {
    pluginsTemp[i].refId = pluginsTemp[i].id;
...
Map<String, dynamic> communityPlugins = {
  "communityPlugins": [
    ...
    },
    {
      ...
      "author": "Hitarth Sharma",
      "description": "Analyzes conversations in real-time to provide feedback on speaking clarity, effectiveness, and overall communication skills.",
      "prompt": "Analyze the given conversation transcript for communication effectiveness. Evaluate factors such as clarity, conciseness, engagement, active listening, and overall impact. Provide specific feedback on strengths and areas for improvement, along with actionable suggestions for enhancing communication skills.",
      ...
      "chat_prompt": "I'm your Better Communicator assistant. I can provide real-time feedback on your communication style and offer suggestions for improvement. Feel free to ask me about specific aspects of your communication or for general tips on effective speaking.",
      "deleted": false
    },
    {
      "id": "speech-coach",
      ...
      "external_integration": {
        "triggers_on": "memory_creation",
        "webhook_url": "https://gpminsuk--speech-coach-wrapper.modal.run/memory",
    ...
    },
    {
      ...
      "prompt": "Based on this transcript, recommend 5 descriptions of interesting research papers.",
    ...
    },
    {
      ...
      "prompt": "Based on this transcript, recommend 5 descriptions of interesting books.",
    ...
    },
    {
      ...
      "external_integration": {
        "triggers_on": "transcript_processed",
        "webhook_url": "https://multion--friend-demo-fastapi-app.modal.run/process_transcript",
        "setup_completed_url": "https://multion--friend-demo-fastapi-app.modal.run/check_setup_completion",
