...
class DeviceProvider extends ChangeNotifier implements IDeviceServiceSubsciption {
  ...
  // Only notify when: first reading, ≥5% change, 15 min elapsed, or crossing 20% threshold.
  ...
  initiateBleBatteryListener() async {
    ...
    _bleBatteryLevelListener = await _getBleBatteryLevelListener(
      ...
      onBatteryLevelChange: (int value) {
        // Always update internal battery level state
        batteryLevel = value;
        ...
        // Throttle UI updates to reduce unnecessary widget rebuilds during transcription.
        // Only notify if: first reading, ≥5% change, 15 min elapsed, or crossing 20% threshold.
