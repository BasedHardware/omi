...
Future<bool> writeToStorage(String deviceId,int numFile,int command,int offset) async => 
    (await getDevice(deviceId))?.writeToStorage(numFile,command,offset) ?? Future.value(false);
