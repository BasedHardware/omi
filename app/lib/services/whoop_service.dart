...
class WhoopService {
  ...
  Future<bool> authenticate() async {
    try {
      ...
      if (authUrl == null) {
        debugPrint('Failed to get Whoop OAuth URL');
        return false;
      }
      ...
      if (await canLaunchUrl(uri)) {
        ...
        debugPrint('Cannot launch Whoop OAuth URL');
        return false;
      }
    } catch (e) {
      debugPrint('Error during Whoop authentication: $e');
      return false;
    }
  }
  ...
  Future<bool> checkConnection() async {
    try {
      ...
      debugPrint('Error checking Whoop connection: $e');
  ...
  Future<bool> disconnect() async {
    try {
      ...
      debugPrint('Error disconnecting Whoop: $e');
      return false;
    }
  }
}
