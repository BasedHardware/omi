...
class OnDeviceWhisperProvider implements ISttProvider {
  ...
  Future<void> _ensureInitialized() async {
    ...
    try {
      ...
      if (filename.contains('tiny')) targetModel = WhisperModel.tiny;
      else if (filename.contains('base')) targetModel = WhisperModel.base;
      else if (filename.contains('small')) targetModel = WhisperModel.small;
