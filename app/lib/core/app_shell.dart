...
class _AppShellState extends State<AppShell> {
  ...
  Future<void> _handleTodoistCallback() async {
    ...
    if (success) {
      AnalyticsManager().taskIntegrationEnabled(appName: 'todoist', success: true);
  ...
  Future<void> _handleAsanaCallback(bool requiresSetup) async {
    ...
    if (success) {
      AnalyticsManager().taskIntegrationEnabled(appName: 'asana', success: true);
  ...
  Future<void> _handleGoogleTasksCallback() async {
    ...
    if (success) {
      AnalyticsManager().taskIntegrationEnabled(appName: 'google_tasks', success: true);
  ...
  Future<void> _handleClickUpCallback(bool requiresSetup) async {
    ...
    if (success) {
      AnalyticsManager().taskIntegrationEnabled(appName: 'clickup', success: true);
