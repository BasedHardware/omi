...
class GeneratedMessageConversationStructured {
  ...
  const GeneratedMessageConversationStructured({required this.emoji, required this.title});
...
class GeneratedMessageConversation {
  ...
  const GeneratedMessageConversation({required this.createdAt, required this.id, required this.structured});
  ...
  factory GeneratedMessageConversation.fromJson(Map<String, dynamic> json) {
    return GeneratedMessageConversation(
      ...
      structured: _required(
        _readFieldValue<GeneratedMessageConversationStructured>(
          _readField(json, const ["structured"]),
          "structured",
  ...
  Map<String, dynamic> toJson() {
    return {'created_at': createdAt.toUtc().toIso8601String(), 'id': id, 'structured': structured.toJson()};
  }
}
  ...
  factory GeneratedFileChat.fromJson(Map<String, dynamic> json) {
    return GeneratedFileChat(
      ...
      openaiFileId: _required(
        _readFieldValue<String>(
          _readField(json, const ["openai_file_id"]),
          "openai_file_id",
          _readString,
          requiredField: true,
          nullable: false,
      ...
      thumbName: _readFieldValue<String>(
        _readField(json, const ["thumb_name"]),
        "thumb_name",
        _readString,
        requiredField: false,
        nullable: true,
      ...
      thumbnail: _readFieldValue<String>(
        _readField(json, const ["thumbnail"]),
        "thumbnail",
        _readString,
        requiredField: false,
        nullable: true,
...
class GeneratedChartDataPoint {
  ...
  const GeneratedChartDataPoint({required this.label, required this.value});
...
class GeneratedChartDataset {
  ...
  const GeneratedChartDataset({this.color, required this.dataPoints, required this.label});

  factory GeneratedChartDataset.fromJson(Map<String, dynamic> json) {
    return GeneratedChartDataset(
      color: _readFieldValue<String>(
      ...
      dataPoints: _required(
        _readFieldValue<List<GeneratedChartDataPoint>>(
          _readField(json, const ["data_points"]),
          "data_points",
  ...
  Map<String, dynamic> toJson() {
    return {'color': color, 'data_points': dataPoints.map((value) => value.toJson()).toList(), 'label': label};
  }
}
...
class GeneratedChartData {
  ...
  factory GeneratedChartData.fromJson(Map<String, dynamic> json) {
    return GeneratedChartData(
      chartType: _required(
        _readFieldValue<String>(
          _readField(json, const ["chart_type"]),
          "chart_type",
          _readString,
          requiredField: true,
          nullable: false,
      ...
      datasets: _required(
        _readFieldValue<List<GeneratedChartDataset>>(
          _readField(json, const ["datasets"]),
          "datasets",
      ...
      xLabel: _readFieldValue<String>(
        _readField(json, const ["x_label"]),
        "x_label",
        _readString,
        requiredField: false,
        nullable: true,
      ),
      yLabel: _readFieldValue<String>(
        _readField(json, const ["y_label"]),
        "y_label",
        _readString,
        requiredField: false,
        nullable: true,
...
class GeneratedMessage {
  ...
  factory GeneratedMessage.fromJson(Map<String, dynamic> json) {
    return GeneratedMessage(
      ...
      chartData: _readFieldValue<Map<String, dynamic>>(
        _readField(json, const ["chart_data"]),
        "chart_data",
        _readMap,
        requiredField: false,
        nullable: true,
      ...
      chatSessionId: _readFieldValue<String>(
        _readField(json, const ["chat_session_id"]),
        "chat_session_id",
        _readString,
        requiredField: false,
        nullable: true,
      ...
      clientMessageId: _readFieldValue<String>(
        _readField(json, const ["client_message_id"]),
        "client_message_id",
        _readString,
        requiredField: false,
        nullable: true,
      ...
      files: _required(
        _readFieldValue<List<GeneratedFileChat>>(
          _readField(json, const ["files"]),
          "files",
          (value) => _readObjectList(value, GeneratedFileChat.fromJson),
          requiredField: false,
          nullable: false,
          defaultValue: const [],
        ),
      ...
      filesId: _required(
        _readFieldValue<List<String>>(
          _readField(json, const ["files_id"]),
          "files_id",
          _readStringList,
          requiredField: false,
          nullable: false,
      ...
      fromExternalIntegration: _required(
        _readFieldValue<bool>(
          _readField(json, const ["from_external_integration"]),
      ...
      journalRevision: _readFieldValue<int>(
        _readField(json, const ["journal_revision"]),
        "journal_revision",
        _readInt,
        requiredField: false,
        nullable: true,
      ...
      langsmithRunId: _readFieldValue<String>(
        _readField(json, const ["langsmith_run_id"]),
        "langsmith_run_id",
        _readString,
        requiredField: false,
        nullable: true,
      ...
      memories: _required(
        _readFieldValue<List<GeneratedMessageConversation>>(
          _readField(json, const ["memories"]),
          "memories",
      ...
      memoriesId: _required(
        _readFieldValue<List<String>>(
          _readField(json, const ["memories_id"]),
          "memories_id",
          _readStringList,
          requiredField: false,
          nullable: false,
      ...
      messageSource: _readFieldValue<String>(
        _readField(json, const ["message_source"]),
        "message_source",
        _readString,
        requiredField: false,
        nullable: true,
      ),
      metadata: _readFieldValue<String>(
        _readField(json, const ["metadata"]),
        "metadata",
        _readString,
        requiredField: false,
        nullable: true,
      ),
      promptCommit: _readFieldValue<String>(
        _readField(json, const ["prompt_commit"]),
        "prompt_commit",
        _readString,
        requiredField: false,
        nullable: true,
      ),
      promptName: _readFieldValue<String>(
        _readField(json, const ["prompt_name"]),
        "prompt_name",
        _readString,
        requiredField: false,
        nullable: true,
      ...
      reportReason: _readFieldValue<String>(
        _readField(json, const ["report_reason"]),
        "report_reason",
        _readString,
        requiredField: false,
        nullable: true,
      ...
      reported: _required(
        _readFieldValue<bool>(
          _readField(json, const ["reported"]),
          "reported",
          _readBool,
          requiredField: false,
          nullable: false,
...
class GeneratedResponseMessage {
  ...
  factory GeneratedResponseMessage.fromJson(Map<String, dynamic> json) {
    return GeneratedResponseMessage(
      ...
      askForNps: _readFieldValue<bool>(
        _readField(json, const ["ask_for_nps"]),
        "ask_for_nps",
        _readBool,
        requiredField: false,
        nullable: true,
...
class GeneratedMessageReportResponse {
  ...
  const GeneratedMessageReportResponse({required this.message});
...
class GeneratedVoiceMessageTranscriptionResponse {
  ...
  factory GeneratedVoiceMessageTranscriptionResponse.fromJson(Map<String, dynamic> json) {
    return GeneratedVoiceMessageTranscriptionResponse(
      ...
      outcome: _readFieldValue<String>(
        _readField(json, const ["outcome"]),
        "outcome",
        _readString,
        requiredField: false,
        nullable: true,
      ),
      sttModel: _readFieldValue<String>(
        _readField(json, const ["stt_model"]),
        "stt_model",
        _readString,
        requiredField: false,
        nullable: true,
      ),
      sttProvider: _readFieldValue<String>(
        _readField(json, const ["stt_provider"]),
        "stt_provider",
        _readString,
        requiredField: false,
        nullable: true,
      ...
      transcript: _required(
        _readFieldValue<String>(
          _readField(json, const ["transcript"]),
          "transcript",
          _readString,
          requiredField: true,
          nullable: false,
