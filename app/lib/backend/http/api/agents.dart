...
Future<void> ensureAgentVm() async {
  try {
    await makeApiCall(url: '${Env.apiBaseUrl}v1/agent/vm-ensure', headers: {}, method: 'POST', body: '');
  } catch (e) {
...
Future<void> sendAgentKeepalive() async {
  try {
    await makeApiCall(url: '${Env.apiBaseUrl}v1/agent/keepalive', headers: {}, method: 'POST', body: '');
  } catch (e) {
