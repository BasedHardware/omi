...
Future<CaptureGroupSeparationResult> separateConversationFromCaptureGroup(String conversationId) async {
  ...
  try {
    final parsed = wire.GeneratedStatusResponse.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
    return parsed.status == 'unchanged' ? CaptureGroupSeparationResult.unchanged : CaptureGroupSeparationResult.separated;
  } catch (_) {
