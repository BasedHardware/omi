...
Future<CaptureGroupSeparationResult> separateConversationFromCaptureGroup(String conversationId) async {
  ...
  try {
    final wire.GeneratedStatusResponse statusResponse = wire.GeneratedStatusResponse.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
    return statusResponse.status == 'unchanged' ? CaptureGroupSeparationResult.unchanged : CaptureGroupSeparationResult.separated;
  } catch (_) {
