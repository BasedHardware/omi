...
import app_links
import flutter_foreground_task // Make sure to import this
...
@objc class AppDelegate: FlutterAppDelegate {
    ...
    override func application(
        ...
        GeneratedPluginRegistrant.register(with: self) // ✅ FIXED
        ...
        SwiftFlutterForegroundTaskPlugin.setPluginRegistrantCallback { registry in
            GeneratedPluginRegistrant.register(with: registry) // ✅ FIXED
        }
...
// This function might not be necessary if it's not being called from anywhere.
// If it is, this is the correct way to write it.
