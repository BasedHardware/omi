...
void main() {
  ...
  group('HomeNavigation', () {
    ...
    testWidgets('untilRouteIsCurrent waits for the sheet over the page to close', (tester) async {
      ...
      showModalBottomSheet<void>(context: homeContext, builder: (_) => const Text('settings'));
      var done = false;
      HomeNavigation.untilRouteIsCurrent(homeContext, pollInterval: const Duration(milliseconds: 50))
          .then((_) => done = true);
      await tester.pumpAndSettle();
