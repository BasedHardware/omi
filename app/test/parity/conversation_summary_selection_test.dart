...
void main() {
  final fixture =
      jsonDecode(File('${_repoRoot().path}/contracts/parity/conversation_summary.json').readAsStringSync())
  ...
  for (final raw in fixture['cases'] as List<dynamic>) {
    ...
    test(testCase['id'] as String, () {
      ...
      final appResults = ((conversationJson['apps_results'] as List<dynamic>?) ?? const [])
          .map((rawResult) {
