...
void main() {
  ...
  test('signed-in startup loads IntegrationProvider (static tripwire)', () {
    ...
    expect(source.contains('context.read<IntegrationProvider>().loadFromBackend();'), isTrue);
    expect(source.contains('context.read<TaskIntegrationProvider>().loadFromBackend();'), isTrue);
  });
}
