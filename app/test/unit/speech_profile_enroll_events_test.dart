...
void main() {
  test('enroll events stay distinct from All Done', () {
    ...
    expect(speechProfileEnrollEventName(SpeechProfileEnrollEvent.uploadSucceeded), 'Speech Profile Upload Succeeded');
    expect(speechProfileEnrollEventName(SpeechProfileEnrollEvent.uploadFailed), 'Speech Profile Upload Failed');
    expect(speechProfileEnrollEventName(SpeechProfileEnrollEvent.embeddingStored), 'Speech Profile Embedding Stored');
