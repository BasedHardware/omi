...
void main() {
  ...
  test('rejects a 201-shaped receipt without persistence or event identity', () {
    ...
    expect(MobileFeedbackReceipt.fromJson({...base, 'persisted': false}, expectedFeedbackId: 'feedback-1'), isNull);
    expect(MobileFeedbackReceipt.fromJson({...base, 'event_id': ''}, expectedFeedbackId: 'feedback-1'), isNull);
    expect(MobileFeedbackReceipt.fromJson({...base, 'feedback_id': 'other'}, expectedFeedbackId: 'feedback-1'), isNull);
    expect(
