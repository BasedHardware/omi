...
void main() {
  ...
  test('hides desktop goal and task chrome fallbacks from the mobile timeline', () {
    final message = ServerMessage.fromJson(
      messageJson(
        text: '',
        contentBlocks: [
          {'type': 'goalLink', 'goalId': 'goal-1', 'summary': 'Make Omi Great Again'},
  ...
  test('keeps meeting-note cards and mixed useful blocks', () {
    ...
    expect(ServerMessage.visibleOnMobile([meeting, mixed, prose]), [meeting, mixed, prose]);
  });
}
