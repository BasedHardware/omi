...
void main() {
  group('Omi4Meta reconstruction contract', () {
    ...
    test('Info.plist carries production MWDAT app credentials', () {
      final plist = _read('ios/Runner/Info.plist');
      ...
      expect(plist, contains('<string>AR|2020435062214461|ab6a58f940d044f1f2ef9b122ad6d07c</string>'),
          reason: 'ClientToken must match the Developer Center configuration.');
    ...
    test('Android DAT stage A registration wiring is present', () {
      ...
      expect(manifest, contains('android:value="AR|2020435062214461|ab6a58f940d044f1f2ef9b122ad6d07c"'));
