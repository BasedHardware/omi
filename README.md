...
11. Add the necessary API keys in the `.env` file:
    ...
    - **Enhanced Diarization (Optional):**
      - Set `ENHANCED_DIARIZATION_ENABLED=true` to enable improved speaker diarization
      - Add `HUGGINGFACE_ACCESS_TOKEN` from [Hugging Face Settings](https://huggingface.co/settings/tokens)
      - Accept terms for Pyannote models at [pyannote/speaker-diarization-3.1](https://huggingface.co/pyannote/speaker-diarization-3.1)
