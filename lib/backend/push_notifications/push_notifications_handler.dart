...
final parametersBuilderMap =
  ...
  'chat': (data) async => ParameterData(
        allParams: {
          'daily': getParameter<bool>(data, 'daily'),
          'test': getParameter<String>(data, 'test'),
        },
      ),
  'homePage': ParameterData.none(),
  'testNew': (data) async => ParameterData(
        allParams: {
          'test': getParameter<String>(data, 'test'),
        },
      ),
  ...
  'PermissionPage': ParameterData.none(),
  'Auth1': ParameterData.none(),
  'micnotice': ParameterData.none(),
  'Onboarding3': ParameterData.none(),
  'explainer': ParameterData.none(),
  'test': ParameterData.none(),
  'testCopy': ParameterData.none(),
  'paymentPage': ParameterData.none(),
  'settingsPageCopy': ParameterData.none(),
};
