...
class _Auth1WidgetState extends State<Auth1Widget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('AUTH1_PAGE_Auth1_ON_INIT_STATE');
      logFirebaseEvent('Auth1_update_page_state');
      setState(() {
        _model.create = false;
      });
    });
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'AUTH1_PAGE_Text_y33sz1xm_ON_TAP');
                                          logFirebaseEvent(
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'AUTH1_PAGE_Text_uea36ssr_ON_TAP');
                                          logFirebaseEvent(
                                              'Text_update_page_state');
                                          setState(() {
                                            _model.create = true;
                                                          ...
                                                          : Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'AUTH1_CONTINUE_WITH_APPLE_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_auth');
                                                                  GoRouter.of(
                                                                          context)
