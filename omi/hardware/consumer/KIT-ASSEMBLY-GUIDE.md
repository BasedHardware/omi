...
See [SWD-FLASHING-GUIDE.md](electrical/SWD-FLASHING-GUIDE.md) for test point locations and detailed wiring.
...
If any test fails, debug now. See [SWD-FLASHING-GUIDE.md](electrical/SWD-FLASHING-GUIDE.md) for troubleshooting via J-Link RTT.
