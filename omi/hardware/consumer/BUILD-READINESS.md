...
| Pick-and-place data | [COMPONENT-PLACEMENT.md](bom/COMPONENT-PLACEMENT.md) | ✅ 3 boards, rotation corrections |
...
| FPC fabrication | [FPC-FAB-NOTES.md](electrical/FPC-FAB-NOTES.md) | ✅ Bend radius, stiffener, quality |
| RF & antenna | [RF-ANTENNA-NOTES.md](electrical/RF-ANTENNA-NOTES.md) | ✅ RF paths, switch control, enclosure strategy |
| Alternate parts | [ALTERNATE-PARTS.md](bom/ALTERNATE-PARTS.md) | ✅ Approved/candidate/rejected tiers |
