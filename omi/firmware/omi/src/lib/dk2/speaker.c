...
static struct bt_uuid_128 speaker_service_uuid =
...
static struct bt_gatt_attr speaker_service_attrs[] = {
    ...
    // Example:
    // BT_GATT_CHARACTERISTIC(&speaker_audio_char_uuid.uuid, BT_GATT_CHRC_WRITE, BT_GATT_PERM_WRITE, NULL,
    // speaker_audio_write_handler, NULL),
};
