...
struct gpio_dt_spec d4_pin = {.port = DEVICE_DT_GET(DT_NODELABEL(gpio0)), .pin=4, .dt_flags = 0}; //3.3
...
__attribute__((unused)) const static int threshold = 10;

__attribute__((unused)) static void reset_count()
{
    inc_count_0 = 0;
    inc_count_1 = 0;
}
