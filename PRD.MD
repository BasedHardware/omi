...
| File | Strings | Description |
|------|---------|-------------|
| `services/notifications/merge_notification_handler.dart` | 2 | Merge notification |
| `services/notifications/daily_reflection_notification.dart` | 2 | Daily reflection notification |
| `services/notifications/action_item_notification_handler.dart` | 1 | Reminder notification |
| `services/devices/device_connection.dart` | 2 | Device disconnect notification |
| `services/devices/models.dart` | 1 | Device error message |

### Priority 4: Desktop App (3 files, ~15 strings)

| File | Strings | Description |
|------|---------|-------------|
| `desktop/pages/onboarding/desktop_onboarding_wrapper.dart` | 5 | Onboarding step titles |
| `desktop/pages/settings/desktop_settings_modal.dart` | 2 | About section |
| `desktop/pages/conversations/widgets/desktop_name_speaker_dialog.dart` | 3 | Speaker dialog buttons |

### Priority 5: Lower Impact (3 files, ~5 strings)

| File | Strings | Description |
|------|---------|-------------|
| `pages/conversation_detail/page.dart` | 1 | Search placeholder |
