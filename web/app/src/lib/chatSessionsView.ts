...
// (`desktop/windows/src/renderer/src/lib/chatSessionsView.ts`), which ports the
// macOS `ChatProvider.computeGroupedSessions()`. Keep the buckets and their
// order identical across clients.
