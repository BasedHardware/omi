...
// (`desktop/windows/src/renderer/src/lib/goalVisuals.ts`), which itself ports the macOS
// implementation. Keep the three in sync: a goal must render the same
// glyph, colour, and percentage on every client.
