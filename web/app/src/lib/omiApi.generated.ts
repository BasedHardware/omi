...
export async function sync_user_time_zone_v1_users_time_zone_put(header: { authorization?: string, X_App_Version?: string }, body: SyncUserTimeZoneRequest, init?: OmiApiClientInit): Promise<FcmTokenResponse> {
  const _base = init?.baseURL ?? "";
