...
function InsightColumn({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'noise-overlay flex-1 rounded-xl p-4',
    ...
    >
      {/* Header */}
      <div className="mb-3 flex items-center gap-2 border-b border-white/[0.04] pb-2">
      ...
      <div className="flex-1 space-y-2 overflow-y-auto">
        {items.map((item, idx) => (
          <div
            key={idx}
            className={cn('rounded-lg p-2.5', bgColor, 'border', borderColor)}
          >
