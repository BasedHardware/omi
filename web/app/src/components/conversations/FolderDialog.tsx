    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* Dialog Container - using flex centering instead of transform to avoid blurriness/off-pixel rendering */}
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            <motion.div
              ...
              className={cn(
                'w-full max-w-md max-h-[90vh] overflow-y-auto p-6 rounded-2xl pointer-events-auto',
