    ...
    <motion.div
      ...
      className={cn(
        ...
        isSelected
          ...
          : 'bg-bg-tertiary border-transparent hover:bg-bg-quaternary hover:border-purple-primary/30 hover:shadow-[0_0_20px_rgba(139,92,246,0.1)]'
      )}
      tabIndex={0}
      role="button"
