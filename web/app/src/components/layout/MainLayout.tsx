              ...
              <div className="min-h-0 flex-1 p-0 sm:p-3">
                ...
                >
                  {/* Deliberately NOT keyed by pathname and NOT animated:
                      ...
                      Supersedes main's `PageSlide pageKey={pathname}`:
                      keying on the pathname is exactly the shell-remount this
                      PR removes — an in-flight recording would not survive a
                      navigation. Page transitions ride the bottom-bar/rail
                      motion instead of re-entering the whole shell. */}
