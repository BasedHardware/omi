...
import { MemoriesPage } from '@/features/memories/ui/MemoriesPage';
...
vi.mock('@/features/memories/useMemories', () => ({
  useMemories: () => ({
    memories: [],
...
vi.mock('@/features/memories/useInsightsDashboard', () => ({
...
vi.mock('@/features/memories/ui/MemoryQuickAdd', () => ({
  MemoryQuickAdd: () => <div data-testid="memory-quick-add" />,
}));

vi.mock('@/features/memories/ui/MemoryList', () => ({
