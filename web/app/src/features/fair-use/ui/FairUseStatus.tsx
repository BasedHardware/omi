...
import { getFairUseStatus } from '@/features/fair-use/api';
import type { FairUseStatus as FairUseStatusType } from '@/features/fair-use/api';
...
export function FairUseStatus() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-4">
      ...
      {isElevated && meta && (
        <div
          className={cn('flex items-center gap-2.5 px-3.5 py-2.5 rounded-xl', meta.bg)}
        >
