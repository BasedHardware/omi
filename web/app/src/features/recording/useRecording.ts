...
import { useRecordingContext, TranscriptSegment, type AudioMode } from '@/features/recording/ui/RecordingContext';
import {
  createAudioCapture,
  isAudioCaptureSupported,
} from '@/lib/audioCapture';
import { createTranscriptionSocket } from '@/lib/transcriptionSocket';
import { processInProgressConversation, finalizeConversationById } from '@/features/conversations';
import { getTranscriptionPreferences } from '@/features/settings';
