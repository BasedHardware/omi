...
import { getAppsGrouped, searchApps, getPopularApps, getAppCategories, getAppCapabilities } from '@/features/connectors/api';
import type {
  App,
  AppCategory,
  AppCapability,
...
import { connectorTabFromParam, type ConnectorTab } from '../model';
