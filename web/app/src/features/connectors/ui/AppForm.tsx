...
import { getAppCategories, getAppCapabilities, getNotificationScopes, getPaymentPlans, createApp, updateApp, uploadAppThumbnail, generateAppDescription, deleteApp } from '@/features/connectors/api';
import type {
  App,
  AppCategory,
  AppCapability,
