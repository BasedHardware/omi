...
/**
 * Goal progress, completion, and labels come from `@/features/goals/goalVisuals`, ported
...
export {
  ...
  progressLabel,
  progressPct,
} from '@/features/goals/goalVisuals';
export { goalEmoji, DEFAULT_GOAL_EMOJI } from '@/features/goals/goalEmoji';
