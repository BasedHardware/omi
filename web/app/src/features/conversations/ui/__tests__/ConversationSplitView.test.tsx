...
import { ConversationSplitView } from '@/features/conversations/ui/ConversationSplitView';
...
vi.mock('@/features/conversations/useConversations', () => ({
  useConversations: () => ({
...
vi.mock('@/features/conversations/useConversation', () => ({
...
vi.mock('@/features/conversations/useRecaps', () => ({
  useRecaps: () => ({
...
vi.mock('@/features/conversations/useSearchConversations', () => ({
...
vi.mock('@/features/conversations/ui/ConversationGallery', () => ({
  ConversationGallery: ({
    groups,
  }: {
...
vi.mock('@/features/conversations/ui/FolderTabs', () => ({
  FOLDER_ALL: 'all',
  FOLDER_STARRED: 'starred',
  FolderTabs: () => null,
  FolderTabsSkeleton: () => null,
}));
vi.mock('@/features/conversations/ui/DateFilter', () => ({ DateFilter: () => null }));
vi.mock('@/features/conversations/ui/MergeActionBar', () => ({
  MergeActionBar: () => null,
}));
vi.mock('@/features/conversations/ui/MergeConfirmationDialog', () => ({
  MergeConfirmationDialog: () => null,
}));
vi.mock('@/features/conversations/ui/DeleteConversationsDialog', () => ({
  DeleteConversationsDialog: () => null,
}));
vi.mock('@/features/conversations/ui/FolderDialog', () => ({
  FolderDialog: () => null,
