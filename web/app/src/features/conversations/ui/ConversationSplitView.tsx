...
import { buildTimelineDayGroups, countTimelineItems, MIN_CONVERSATION_GALLERY_WIDTH, resizeConversationDetailPanel, selectionFromSearchParams, type ConversationSelection } from '../model';

// Detail pane width constraints
const DEFAULT_PANEL_WIDTH = 480;

type Selection = ConversationSelection;
...
export function ConversationSplitView() {
  ...
  const [selection, setSelectionState] = useState<Selection>(
    selectionFromSearchParams(urlConversationId, urlRecapId),
  );
