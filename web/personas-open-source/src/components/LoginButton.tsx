...
export const LoginButton = ({ onLoadingChange }: LoginButtonProps) => {
  ...
  return (
    <button
      className="bg-white hover:bg-gray-200 text-black px-4 py-2 md:px-5 md:py-2.5 rounded-full flex items-center whitespace-nowrap shadow-sm hover:shadow-md transition-all"
    ...
    >
      {isLoading ? (
        ...
        <>
          <svg width="18" height="18" viewBox="0 0 256 262" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" className="mr-2">
