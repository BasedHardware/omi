...
export default function AdminPanel() {
  ...
  const loadApps = async (key: string) => {
    setLoading(true);
    try {
      const unapprovedApps = await getUnapprovedApps(key);
      ...
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-neutral-50 to-neutral-100 p-4">
        <Card className="w-full max-w-md p-8">
          ...
          <p className="mb-6 text-center text-sm text-neutral-500">
            Enter your admin key to access the app review dashboard
          </p>
    ...
    <div className="min-h-screen bg-neutral-50 p-4 md:p-8 pt-24 md:pt-28">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold">App Review Dashboard</h1>
