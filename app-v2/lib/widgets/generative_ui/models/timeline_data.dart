...
class TimelineEventData {
  ...
  factory TimelineEventData.fromParsed({required Map<String, String> attributes, required String innerContent}) {
...
class TimelineDisplayData {
  ...
  const TimelineDisplayData({this.title, required this.events});
