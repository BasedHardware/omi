...
class QuoteData {
  ...
  const QuoteData({required this.speaker, required this.time, required this.recordStatus, required this.quote});

  factory QuoteData.fromParsed({required Map<String, String> attributes, required String innerContent}) {
    return QuoteData(
...
class QuoteBoardDisplayData {
  ...
  const QuoteBoardDisplayData({required this.quotes});
