...
class TranscriptReference {
  ...
  const TranscriptReference({required this.time, required this.speaker, required this.rawText, this.context});

  factory TranscriptReference.fromParsed({required Map<String, String> attributes, required String innerContent}) {
