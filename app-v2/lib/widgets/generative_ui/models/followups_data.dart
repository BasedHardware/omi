...
class FollowupItemData {
  ...
  const FollowupItemData({required this.type, required this.content});

  factory FollowupItemData.fromParsed({required Map<String, String> attributes, required String innerContent}) {
    return FollowupItemData(type: FollowupItemType.fromString(attributes['type']), content: innerContent.trim());
  }
}
...
class FollowupsDisplayData {
  ...
  const FollowupsDisplayData({required this.items});
