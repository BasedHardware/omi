...
- Desktop Windows (auto prerelease on `desktop/windows/**` merge to `main` via `.github/workflows/desktop_windows_release.yml`): setup, signing, and secret names in `desktop/windows/docs/release-pipeline.md`.
